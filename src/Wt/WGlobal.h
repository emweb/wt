...
enum class Key {
  ...
  OemSemicolon = 186,     //!< Configuration-dependent key.
  OemPlus = 187,          //!< Configuration-dependent key.
  OemComma = 188,         //!< Configuration-dependent key.
  OemMinus = 189,         //!< Configuration-dependent key.
  OemPeriod = 190,        //!< Configuration-dependent key.
  OemQuestion = 191,      //!< Configuration-dependent key.
  OemTilde = 192,         //!< Configuration-dependent key. \note Cannot be distinguished from OemCloseBrackets in Firefox!
  OemOpenBrackets = 219,  //!< Configuration-dependent key.
  OemPipe = 220,          //!< Configuration-dependent key.
  OemCloseBrackets = 221, //!< Configuration-dependent key. \note Cannot be distinguished from OemTilde in Firefox!
  OemQuotes = 222,        //!< Configuration-dependent key.
  OemBackslash = 226,     //!< Configuration-dependent key.
  Space = ' ',            //!< Space
  A = 'A',                //!< 'A' key
  B = 'B',                //!< 'B' key
  C = 'C',                //!< 'C' key
