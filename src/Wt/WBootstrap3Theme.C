...
#include "js/Bootstrap3Theme.min.js"
#endif
...
void WBootstrap3Theme::init(WApplication *app) const
{
  ...
  LOAD_JAVASCRIPT(app, "js/Bootstrap3Theme.js", "theme", wtjs3);
}
...
void WBootstrap3Theme::loadValidationStyling(WApplication* app) const
{
...
void WBootstrap3Theme::applyFunctionalStyling(WWidget *widget,
                                              WWidget *child,
...
void WBootstrap3Theme::applyOptionalStyling(WT_MAYBE_UNUSED WWidget *widget,
                                            WWidget *child,
                                            int widgetRole) const
{
  switch (widgetRole) {
