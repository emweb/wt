...
public:
   ...
   *
   * \sa keyValue(), modifiers(), charCode()
   */
  Key key() const;

  /*! \brief Returns a string representing the value of the key.
   *
   * The key value corresponds to the character generated by the key if
   * any, or a string representing the key otherwise (e.g. "Enter" for
   * the Enter key).
   *
