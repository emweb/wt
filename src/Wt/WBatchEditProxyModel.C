					 ...
					 int index, int count)
{
  ...
  for (int i = 0; i < count; ++i) {
    ...
    if (rowItems)
      rowItems->insert(rowItems->begin() + insertIndex + i, 0);
  }
}
