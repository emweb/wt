WT_DECLARE_WT_MEMBER(10,JavaScriptConstructor,"WPaintedWidget",function(J,p){jQuery.data(p,"obj",this);this.canvas=document.getElementById("c"+p.id);this.repaint=function(){};this.widget=p});
