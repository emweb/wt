WT_DECLARE_WT_MEMBER(1,JavaScriptConstructor,"WPaintedWidget",function(z,l){this.canvas=document.getElementById("c"+l.id);this.canvas.getContext("2d");jQuery.data(l,"obj",this);this.jsValues=[];this.repaint=function(){}});
...
a=a[3]}else{e=a[1]+a[3];a=-a[3]}return[b,e,d,a]}}var l=0,m=1,n=2,o=3,p=4,q=5,v=0,r=1,B=2,C=3,D=4,E=5,F=6,A=7,x=8,y=9;return new z}());
