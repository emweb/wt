...
q="9".charCodeAt(0);jQuery.data(c,"lobj",this);var H=this,e=K.WT,y=$(c);this.getValue=j;this.setValue=function(a){m=a;if(g==="")c.value=a;else if(!(t&1)&&!e.hasFocus(c))c.value=this.getValue();else{var b=e.getSelectionRange(c),d=-1;c.value=i;for(var f=0,h=0,I="";f<a.length;f++){I=a.charAt(f);if(b.start===b.end&&b.start===f)d=h;h=x(I,h,true)}if(e.hasFocus(c))if(d!==-1)l(d);else a.length==0&&l(0)}};this.setInputMask=function(a,b,d,f,h){g=a;i=b;s=f;k=h;H.setValue(d)};g!==""&&this.setInputMask(g,i,m,
s,k);this.keyDown=function(a,b){if(!(g===""||c.readOnly)){a=j();switch(b.keyCode){case 39:e.cancelEvent(b,e.CancelDefaultAction);b=e.getSelectionRange(c);b.end-b.start<=1?o(b.start+1):e.setSelectionRange(c,b.end,b.end);break;case 37:e.cancelEvent(b,e.CancelDefaultAction);b=e.getSelectionRange(c);b.end-b.start<=1?z(b.start-1):e.setSelectionRange(c,b.start,b.start);break;case 36:e.cancelEvent(b,e.CancelDefaultAction);o(0);break;case 35:e.cancelEvent(b,e.CancelDefaultAction);e.setSelectionRange(c,g.length,
g.length);break;case 46:e.cancelEvent(b,e.CancelDefaultAction);b=e.getSelectionRange(c);if(b.end-b.start<=1){b=b.start;if(b<g.length&&!u(b)){var d=c.value.substring(0,b),f=c.value.substring(b+1);c.value=d+k+f;e.setSelectionRange(c,b,b)}}else r(b);break;case 8:e.cancelEvent(b,e.CancelDefaultAction);b=e.getSelectionRange(c);if(b.end-b.start<=1){b=b.start-1;if(b>=0){b=z(b);if(!u(b)){d=c.value.substring(0,b);f=c.value.substring(b+1);c.value=d+k+f;l(b)}}}else r(b);break}a!==j()&&n()}};this.keyPressed=
