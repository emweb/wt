...
h;m(0)}}var t="a".charCodeAt(0),K="f".charCodeAt(0),y="z".charCodeAt(0),u="A".charCodeAt(0),J="F".charCodeAt(0),z="Z".charCodeAt(0),H="-".charCodeAt(0),I="+".charCodeAt(0),n="0".charCodeAt(0),A="1".charCodeAt(0),o="9".charCodeAt(0);jQuery.data(c,"lobj",this);var M=this,d=G.WT,N=$(c);this.getValue=function(){if(f==="")return c.value;var a=c.value,b="",e="",g=0,i=0;for(g=0;g<a.length;g++){e=a.charAt(g);if(e!==k&&f.charAt(g)!=="_")i+=1;if(e!==k||f.charAt(g)==="_")b+=e}return i>0?b:""};this.setValue=
function(a){j=a;if(f===""||!(s&1)&&!d.hasFocus(c))c.value=a;else{var b=d.getSelectionRange(c),e=-1;c.value=h;for(var g=0,i=0,E="";g<a.length;g++){E=a.charAt(g);if(b.start===b.end&&b.start===g)e=i;i=v(E,i,true)}if(d.hasFocus(c))if(e!==-1)l(e);else a.length==0&&l(0)}};this.setInputMask=function(a,b,e,g,i){f=a;h=b;q=g;k=i;j=e;this.setValue(j);c.value=this.getValue()};f!==""&&this.setInputMask(f,h,j,q,k);this.keyDown=function(a,b){if(!(f===""||c.readOnly))switch(b.keyCode){case 39:d.cancelEvent(b,d.CancelDefaultAction);
a=d.getSelectionRange(c);a.end-a.start<=1?m(a.start+1):d.setSelectionRange(c,a.end,a.end);break;case 37:d.cancelEvent(b,d.CancelDefaultAction);a=d.getSelectionRange(c);a.end-a.start<=1?w(a.start-1):d.setSelectionRange(c,a.start,a.start);break;case 36:d.cancelEvent(b,d.CancelDefaultAction);m(0);break;case 35:d.cancelEvent(b,d.CancelDefaultAction);d.setSelectionRange(c,f.length,f.length);break;case 46:d.cancelEvent(b,d.CancelDefaultAction);a=d.getSelectionRange(c);if(a.end-a.start<=1){a=a.start;if(a<
f.length&&!r(a)){b=c.value.substring(0,a);var e=c.value.substring(a+1);c.value=b+k+e;d.setSelectionRange(c,a,a)}}else p(a);break;case 8:d.cancelEvent(b,d.CancelDefaultAction);a=d.getSelectionRange(c);if(a.end-a.start<=1){a=a.start-1;if(a>=0){a=w(a);if(!r(a)){b=c.value.substring(0,a);e=c.value.substring(a+1);c.value=b+k+e;l(a)}}}else p(a);break}};this.keyPressed=function(a,b){if(!(f===""||c.readOnly)){a=b.charCode||b.keyCode;if(!(a===0||a===13||a===10)){d.cancelEvent(b,d.CancelDefaultAction);b=d.getSelectionRange(c);
b.start<b.end&&p(b);b=v(String.fromCharCode(a),b.start);m(b)}}};var F=this.getValue();this.focussed=function(){if(!(f===""||c.readOnly||s&1)){F=this.getValue();setTimeout(function(){M.setValue(j)},0)}};this.blurred=function(){if(!(f===""||c.readOnly||s&1)){j=c.value;c.value=this.getValue();c.value!==F&&N.change()}};this.clicked=function(){if(!(f===""||c.readOnly)){var a=d.getSelectionRange(c);a.start===a.end&&l(a.start)}};if(c.addEventListener)c.addEventListener("paste",B,false);else c.attachEvent&&
c.attachEvent("onpaste",B);if(c.addEventListener)c.addEventListener("cut",C,false);else c.attachEvent&&c.attachEvent("oncut",C);if(c.addEventListener)c.addEventListener("input",D,false);else c.attachEvent&&c.attachEvent("oninput",D);c.wtEncodeValue=function(){return j}});
