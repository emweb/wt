...
c,-1,e);else{g.style.height="";g.lh=false}}};this.wtGetPs=function(a,c,f,e){return e};this.adjustScroll=function(a){var c,f,e,u=h.scrollLeft,n=h.scrollTop;c=0;for(f=h.childNodes.length;c<f;++c){e=h.childNodes[c];if(x(e))if(e!=a){if(e.style.display!="none"){y[c]=u;C[c]=n}}else{e.style.display="";if(typeof y[c]!=="undefined"){h.scrollLeft=y[c];h.scrollTop=C[c]}else{h.scrollLeft=0;h.scrollTop=0}}}};this.setCurrent=function(a){var c,f,e;this.adjustScroll(a);c=0;for(f=h.childNodes.length;c<f;++c){e=h.childNodes[c];
if(x(e))if(e!=a){if(e.style.display!="none")e.style.display="none"}else{e.style.display="";if(h.lh){h.lh=false;h.style.height=""}}}}});
WT_DECLARE_WT_MEMBER(2,JavaScriptPrototype,"WStackedWidget.prototype.animateChild",function(E,h,x,d,C,y){doAnimateChild=function(a,c,f,e,u,n){function v(s){var z=["Moz","Webkit"],A=document.createElement("div"),p,w;p=0;for(w=z.length;p<w;++p)if(z[p]+s in A.style)return z[p];return""}function D(){var s,z=k.childNodes.length,A=-1,p=-1;for(s=0;s<z&&(A==-1||p==-1);++s){var w=k.childNodes[s];if(w==c)p=s;else if(w.style.display!=="none"&&!$(w).hasClass("out"))A=s}return{from:A,to:p}}function g(){$(l).removeClass(m+
" out");l.style.display="none";l.style[i+"Duration"]="";l.style[i+"TimingFunction"]="";$(b).removeClass(m+" in");b.style.left="";b.style.width="";b.style.top="";b.style.height="";b.style.position="";b.style[i+"Duration"]="";b.style[i+"TimingFunction"]=""}var o=["ease","linear","ease-in","ease-out","ease-in-out"],j=v("AnimationDuration"),i=j+"Animation";j=j=="Moz"?"animationend":"webkitAnimationEnd";if(n.display!=="none"){var k=c.parentNode,B=k.wtAutoReverse,t=D();if(!(t.from==-1||t.to==-1||t.from==
t.to)){var l=k.childNodes[t.from],b=k.childNodes[t.to],q=k.scrollHeight,r=k.scrollWidth;if($(l).hasClass("in"))$(l).one(j,function(){doAnimateChild(a,c,f,e,u,n)});else{q-=a.px(k,"paddingTop");q-=a.px(k,"paddingBottom");q-=a.px(b,"marginTop");q-=a.px(b,"marginBottom");q-=a.px(b,"borderTopWidth");q-=a.px(b,"borderBottomWidth");q-=a.px(b,"paddingTop");q-=a.px(b,"paddingBottom");r-=a.px(k,"paddingLeft");r-=a.px(k,"paddingRight");r-=a.px(b,"marginLeft");r-=a.px(b,"marginRight");r-=a.px(b,"borderLeftWidth");
r-=a.px(b,"borderRightWidth");r-=a.px(b,"paddingLeft");r-=a.px(b,"paddingRight");b.style.left=l.style.left||a.px(k,"paddingLeft");b.style.top=l.style.top||a.px(k,"paddingTop");b.style.width=r+"px";b.style.height=q+"px";b.style.position="absolute";b.style.display=n.display;B=B&&t.to<t.from;var m="";switch(f&255){case 1:B=!B;case 2:m="slide";break;case 3:m="slideup";break;case 4:m="slidedown";break;case 5:m="pop";break}if(f&256)m+=" fade";if(B)m+=" reverse";l.style[i+"Duration"]=u+"ms";b.style[i+"Duration"]=
u+"ms";l.style[i+"TimingFunction"]=o[[0,1,3,2,4,5][e]];b.style[i+"TimingFunction"]=o[e];$(l).addClass(m+" out");$(b).addClass(m+" in");$(b).one(j,g)}}}};doAnimateChild(E,h,x,d,C,y)});
