...
B[a]}else{h.scrollLeft=0;h.scrollTop=0}}};this.setCurrent=function(c){var a,f,d;this.adjustScroll(c);a=0;for(f=h.childNodes.length;a<f;++a){d=h.childNodes[a];if(w(d))if(d!=c){if(d.style.display!="none")d.style.display="none"}else{d.style.display=d.style.flexFlow?"flex":"";if(h.lh){h.lh=false;h.style.height=""}}}}});
