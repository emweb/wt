...
-fb;if(Math.abs(k.x)>pa)k.x=(k.x>0?1:-1)*pa;d.x=k.x*b}if(k.y===Infinity||k.y===-Infinity)k.y=k.y>0?pa:-pa;if(isFinite(k.y)){k.y/=1+wb*b;e[1]+=k.y*b;if(x(e)>x(n())){k.y+=-f*(x(e)-x(n()))*b;k.y*=0.7}else if(z(e)<z(n())){k.y+=-f*(z(e)-z(n()))*b;k.y*=0.7}if(Math.abs(k.y)<0.001)if(x(e)>x(n()))k.y=0.001;else if(z(e)<z(n()))k.y=-0.001;if(Math.abs(k.y)>pa)k.y=(k.y>0?1:-1)*pa;d.y=k.y*b}if(G)e=F(0);else if(t===-1){e=F(0);for(f=1;f<M();++f)e=Wa(e,F(f))}else e=F(t);aa(d,Ca,t,G);if(G)a=F(0);else if(t===-1){a=
F(0);for(f=1;f<M();++f)a=Wa(a,F(f))}else a=F(t);if(q(e)>q(n())&&q(a)<=q(n())){k.x=0;aa({x:-d.x,y:0},Ca,t,G);ha(za)}if(s(e)<s(n())&&s(a)>=s(n())){k.x=0;aa({x:-d.x,y:0},Ca,t,G);ha(za)}if(x(e)>x(n())&&x(a)<=x(n())){k.y=0;aa({x:0,y:-d.y},Ca,t,G);ha(Aa)}if(z(e)<z(n())&&z(a)>=z(n())){k.y=0;aa({x:0,y:-d.y},Ca,t,G);ha(Aa)}if(Math.abs(k.x)<xb&&Math.abs(k.y)<xb&&Eb(a)){ha();Ba=false;D=null;k.x=0;k.y=0;oa=null;r=[]}else{oa=c;na&&Xa(eb)}}}function Ya(){var a,b,c=yb(i()[0])-1;if(i()[0]==fa())c=y(K().x)-1;if(c>=
y(K().x))c=y(K().x)-1;for(a=0;a<y(K().x);++a)if(c===a)for(b=0;b<y(K().x[a]);++b)K().x[a][b].color[3]=qb().x[b];else for(b=0;b<y(K().x[a]);++b)K().x[a][b].color[3]=0;for(c=0;c<y(K().y);++c){var d=yb(g(c)[3])-1;if(g(c)[3]==T(c))d=y(K().y[c])-1;if(d>=y(K().y[c]))d=y(K().y[c])-1;for(a=0;a<y(K().y[c]);++a)if(d===a)for(b=0;b<y(K().y[c][a]);++b)K().y[c][a][b].color[3]=qb().y[c][b];else for(b=0;b<y(K().y[c][a]);++b)K().y[c][a][b].color[3]=0}}function aa(a,b,c,d){if(N(b))b=0;if(N(c))c=-1;if(N(d))d=false;var e=
ma(C,Q());if(B())a={x:a.y,y:-a.x};if(b&Ca){if(d)i()[4]=i()[4]+a.x;else if(c===-1){i()[4]=i()[4]+a.x;for(b=0;b<M();++b)g(b)[5]=g(b)[5]-a.y}else g(c)[5]=g(c)[5]-a.y;Ha()}else if(b&zb){var f;if(d)f=F(0);else if(c===-1){f=F(0);for(b=1;b<M();++b)f=Wa(f,F(b))}else f=F(c);if(q(f)>q(n())){if(a.x>0)a.x/=1+(q(f)-q(n()))*Za}else if(s(f)<s(n()))if(a.x<0)a.x/=1+(s(n())-s(f))*Za;if(x(f)>x(n())){if(a.y>0)a.y/=1+(x(f)-x(n()))*Za}else if(z(f)<z(n()))if(a.y<0)a.y/=1+(z(n())-z(f))*Za;if(d)i()[4]=i()[4]+a.x;else if(c===
-1){i()[4]=i()[4]+a.x;for(b=0;b<M();++b)g(b)[5]=g(b)[5]-a.y}else g(c)[5]=g(c)[5]-a.y;if(c===-1)C[v]+=a.x;d||(C[u]+=a.y);Ha()}else{if(d)i()[4]=i()[4]+a.x;else if(c===-1){i()[4]=i()[4]+a.x;for(b=0;b<M();++b)g(b)[5]=g(b)[5]-a.y}else g(c)[5]=g(c)[5]-a.y;if(c===-1)C[v]+=a.x;d||(C[u]+=a.y);ha()}a=Ua(e,Q());C[v]=a[v];C[u]=a[u];Z();Ja()}function La(a,b,c,d,e){if(N(d))d=-1;if(N(e))e=false;var f=ma(C,Q());a=B()?[a.y-x(h()),a.x-q(h())]:w(Ia([1,0,0,-1,q(h()),z(h())]),[a.x,a.y]);var j=a[0];a=a[1];var m=Math.pow(1.2,
B()?c:b);b=Math.pow(1.2,B()?b:c);if(i()[0]*m>fa())m=fa()/i()[0];if(i()[0]*m<Qa())m=Qa()/i()[0];if(e){if(m<1||i()[0]!==fa())qa(i(),w([m,0,0,1,j-m*j,0],i()))}else if(d===-1){if(m<1||i()[0]!==fa())qa(i(),w([m,0,0,1,j-m*j,0],i()));for(d=0;d<M();++d){e=b;if(g(d)[3]*b>T(d))e=T(d)/g(d)[3];if(e<1||g(d)[3]!==T(d))qa(g(d),w([1,0,0,e,0,a-e*a],g(d)))}}else{if(g(d)[3]*b>T(d))b=T(d)/g(d)[3];if(b<1||g(d)[3]!=T(d))qa(g(d),w([1,0,0,b,0,a-b*a],g(d)))}ha();f=Ua(f,Q());C[v]=f[v];C[u]=f[u];Ya();Z();Ja()}jQuery.data(J,
"cobj",this);var ia=this,E=wa.WT;ia.config=l;var H=E.gfxUtils,w=H.transform_mult,Ia=H.transform_inverted,ka=H.transform_assign,rb=H.transform_equal,Hb=H.transform_apply,x=H.rect_top,z=H.rect_bottom,q=H.rect_left,s=H.rect_right,Wa=H.rect_intersection,Y=E.chartCommon,Ib=Y.minMaxY,Db=Y.findClosestPoint,Jb=Y.projection,Ab=Y.distanceLessThanRadius,yb=Y.toZoomLevel,Ma=Y.isPointInRect,Kb=Y.findYRange,Na=function(a,b){return Y.matchesXAxis(a,b,h(),l.xAxis,B())},Oa=function(a,b){return Y.matchYAxis(a,b,h(),
l.yAxes,B())},Ka=17,Xa=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(a){window.setTimeout(a,Ka)}}(),gb=false,ub=function(a){if(!gb){gb=true;Xa(function(){a();gb=false})}};if(window.MSPointerEvent||window.PointerEvent){J.style.touchAction="none";A.canvas.style.msTouchAction="none";A.canvas.style.touchAction="none"}var Ca=1,zb=2,za=1,Aa=2,v=0,u=1,Cb=250,tb=500,wb=0.003,Gb=2.0E-4,Za=0.07,Va=3,fb=0.001,pa=1.5,xb=0.02,ta=jQuery.data(J,
"eobj2");if(!ta){ta={};ta.contextmenuListener=function(a){ya(a);X("contextmenu",ta.contextmenuListener)}}jQuery.data(J,"eobj2",ta);var ba={},ua=false;if(window.MSPointerEvent||window.PointerEvent)(function(){function a(){ua=y(e)>0}function b(j){if(bb(j)){ya(j);e.push(j);a();ba.start(J,{touches:e.slice(0)})}}function c(j){if(ua)if(bb(j)){ya(j);var m;for(m=0;m<y(e);++m)if(e[m].pointerId===j.pointerId){e.splice(m,1);break}a();ba.end(J,{touches:e.slice(0),changedTouches:[]})}}function d(j){if(bb(j)){ya(j);
var m;for(m=0;m<y(e);++m)if(e[m].pointerId===j.pointerId){e[m]=j;break}a();ba.moved(J,{touches:e.slice(0)})}}var e=[],f=jQuery.data(J,"eobj");if(f)if(window.PointerEvent){X("pointerdown",f.pointerDown);X("pointerup",f.pointerUp);X("pointerout",f.pointerUp);X("pointermove",f.pointerMove)}else{X("MSPointerDown",f.pointerDown);X("MSPointerUp",f.pointerUp);X("MSPointerOut",f.pointerUp);X("MSPointerMove",f.pointerMove)}jQuery.data(J,"eobj",{pointerDown:b,pointerUp:c,pointerMove:d});if(window.PointerEvent){ga("pointerdown",
b);ga("pointerup",c);ga("pointerout",c);ga("pointermove",d)}else{ga("MSPointerDown",b);ga("MSPointerUp",c);ga("MSPointerOut",c);ga("MSPointerMove",d)}})();var I=jQuery.data(J,"oobj"),C=null,na=true,D=null,G=false,t=-1,r=[],ja=false,ra=false,U=null,hb=null,ib=null,k={x:0,y:0},ca=null,oa=null,p=jQuery.data(J,"tobj");if(!p){p={overTooltip:false};jQuery.data(J,"tobj",p)}var Da=null,Ba=false,Sa=null,cb=[0,0,0,0,0,0];ka(cb,i());var Ta=[];for(H=0;H<M();++H){Ta.push([0,0,0,0,0,0]);ka(Ta[H],g(H))}var qa=function(a,
...
b);wa.emit(A.widget,"seriesSelected",a.x,a.y)}};this.mouseWheel=function(a,b){var c=(b.metaKey<<3)+(b.altKey<<2)+(b.ctrlKey<<1)+b.shiftKey;a=l.wheelActions[c];if(!N(a)){var d=E.widgetCoordinates(A.canvas,b),e=Na(d.x,d.y),f=Oa(d.x,d.y),j=Ma(d,h());if(!(!e&&f===-1&&!j)){var m=E.normalizeWheel(b);if(j&&c===0&&Ga()){c=W();j=-m.spinY;if(da(c)){a=kb(c);a=Hb(a,Pa(c));a=Ib(a,B());a=(a[0]+a[1])/2;E.cancelEvent(b);b=Math.pow(1.2,j);ka(ea(c),w([1,0,0,b,0,a-b*a],ea(c)));Z();return}}if((a===4||a===5||a===6)&&
l.pan){c=i()[4];j=[];for(d=0;d<M();++d)j.push(g(d)[5]);if(a===6)aa({x:-m.pixelX,y:-m.pixelY},0,f,e);else if(a===5)aa({x:0,y:-m.pixelX-m.pixelY},0,f,e);else a===4&&aa({x:-m.pixelX-m.pixelY,y:0},0,f,e);c!==i()[4]&&E.cancelEvent(b);for(d=0;d<M();++d)j[d]!==g(d)[5]&&E.cancelEvent(b)}else if(l.zoom){E.cancelEvent(b);j=-m.spinY;if(j===0)j=-m.spinX;if(a===1)La(d,0,j,f,e);else if(a===0)La(d,j,0,f,e);else if(a===2)La(d,j,j,f,e);else if(a===3)m.pixelX!==0?La(d,j,0,f,e):La(d,0,j,f,e)}}}};var Lb=function(){lb()&&
...
setTimeout(function(){if(!G&&t===-1&&ja&&Ga()&&da(W())){var c=W();if(da(c)){var d=va,e;e=B()?(d.x-D.x)/g(P(W()))[3]:(d.y-D.y)/g(P(W()))[3];ea(c)[5]+=e;D=d;Z()}}else if(ja){d=va;e=Date.now();var f={x:d.x-D.x,y:d.y-D.y};c=e-oa;oa=e;if(Da===1){C[v]+=f.x;C[u]+=f.y;xa()&&na&&Xa(db)}else if(l.pan){k.x=f.x/c;k.y=f.y/c;aa(f,l.rubberBand?zb:0,t,G)}D=d}else if(!G&&t===-1&&ra&&Ga()&&da(W())){f=B()?v:u;e=[va,jb].map(function(S){return B()?[S.x,sa]:[Ea,S.y]});c=Math.abs(r[1][f]-r[0][f]);var j=Math.abs(e[1][f]-
e[0][f]),m=c>0?j/c:1;if(j===c)m=1;c=W();if(da(c)){var sa=w(Ia(la(P(c))),[0,(r[0][f]+r[1][f])/2])[1],Fa=w(Ia(la(P(c))),[0,(e[0][f]+e[1][f])/2])[1];ka(ea(c),w([1,0,0,m,0,-m*sa+Fa],ea(c)));D=d;Z();r=e}}else if(ra&&l.zoom){d=ma(C,Q());var Ea=(r[0][0]+r[1][0])/2;sa=(r[0][1]+r[1][1])/2;e=[va,jb].map(function(S){return U===0?[S.x,sa]:U===Math.PI/2?[Ea,S.y]:w(ib,[S.x,S.y])});f=Math.abs(r[1][0]-r[0][0]);c=Math.abs(e[1][0]-e[0][0]);var O=f>0?c/f:1;if(c===f||U===Math.PI/2)O=1;var ab=(e[0][0]+e[1][0])/2;c=Math.abs(r[1][1]-
r[0][1]);j=Math.abs(e[1][1]-e[0][1]);m=c>0?j/c:1;if(j===c||U===0)m=1;Fa=(e[0][1]+e[1][1])/2;B()&&function(){var S=O;O=m;m=S;S=ab;ab=Fa;Fa=S;S=Ea;Ea=sa;sa=S}();if(i()[0]*O>fa())O=fa()/i()[0];if(i()[0]*O<Qa())O=Qa()/i()[0];f=[];for(c=0;c<M();++c)f.push(m);for(c=0;c<M();++c){if(g(c)[3]*f[c]>T(c))f[c]=T(c)/g(c)[3];if(g(c)[3]*f[c]<pb(c))f[c]=pb(c)/g(c)[3]}if(G){if(O!==1&&(O<1||i()[0]!==fa()))qa(i(),w([O,0,0,1,-O*Ea+ab,0],i()))}else if(t===-1){if(O!==1&&(O<1||i()[0]!==fa()))qa(i(),w([O,0,0,1,-O*Ea+ab,0],
