...
b.substring(7)*1;f.style.width=g+"px";r.adjustColumns();l.emit(d,"columnResized",m,parseInt(g))},c,d,a,-2,-1)}};this.adjustColumns=function(){var c=q.firstChild,a=i.firstChild,b=0,f=0;f=i.lastChild.className.split(" ")[0];var h=e.getCssRule("#"+d.id+" ."+f);if(p)a=a.firstChild;if(!e.isHidden(d)){for(var g=0,m=a.childNodes.length;g<m;++g)if(a.childNodes[g].className){var j=a.childNodes[g].className.split(" ")[0];j=e.getCssRule("#"+d.id+" ."+j);b+=e.pxself(j,"width")+7}if(!p)if(h.style.width)$(d).find(".Wt-headerdiv ."+
f).css("width",h.style.width);else h.style.width=i.offsetWidth-a.offsetWidth-8+"px";f=b+e.pxself(h,"width")+(e.isIE6?10:8);if(p){j=e.getCssRule("#"+d.id+" .Wt-tv-rowc");j.style.width=b+"px";$(d).find(".Wt-tv-rowc").css("width",b+"px").css("width","");d.changed=true;this.autoJavaScript()}else{i.style.width=c.style.width=f+"px";a.style.width=b+"px"}}};var n=null;d.handleDragDrop=function(c,a,b,f,h){if(n){n.className=n.classNameOrig;n=null}if(c!="end"){var g=o(b);if(!g.selected&&g.drop&&g.columnId!=
-1)if(c=="drop")l.emit(d,{name:"itemEvent",eventObject:a,event:b},g.nodeId,g.columnId,"drop",f,h);else{a.className="Wt-valid-drop";n=g.el;n.classNameOrig=n.className;n.className+=" Wt-drop-site"}else a.className=""}};this.autoJavaScript=function(){if(d.parentNode==null){d=k=s=q=i=null;this.autoJavaScript=function(){}}else if(!e.isHidden(d)){var c=$(d),a=c.innerWidth(),b,f=null,h=k.offsetWidth-k.clientWidth;a-=h;if(c.hasClass("column1")){b=c.find(".Wt-headerdiv").get(0).lastChild.className.split(" ")[0];
b=e.getCssRule("#"+d.id+" ."+b);f=e.pxself(b,"width")}if((!e.isIE||a>100)&&(a!=k.tw||f!=k.c0w||d.changed)){var g=!d.changed;k.tw=a;k.c0w=f;b=c.find(".Wt-headerdiv").get(0).lastChild.className.split(" ")[0];b=e.getCssRule("#"+d.id+" ."+b);var m=q.firstChild,j=e.getCssRule("#"+d.id+" .cwidth"),t=j.style.width==i.style.width,u=i.firstChild;j.style.width=a+"px";k.style.width=a+h+"px";i.style.width=m.offsetWidth+"px";if(f!=null){f=a-f-(e.isIE6?10:8);if(f>0){h=Math.min(f,e.pxself(e.getCssRule("#"+d.id+
