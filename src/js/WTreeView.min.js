...
a.childNodes[h].className.split(" ")[0];j=f.getCssRule("#"+d.id+" ."+j);if(j.style.display!="none")b+=f.pxself(j,"width")+7}if(!r)if(g.style.width)$(d).find(".Wt-headerdiv ."+e).css("width",g.style.width);else g.style.width=l.offsetWidth-a.offsetWidth-8+"px";e=b+f.pxself(g,"width")+(f.isIE6?10:8);if(r){j=f.getCssRule("#"+d.id+" .Wt-tv-rowc");j.style.width=b+"px";f.isIE&&setTimeout(function(){$(d).find(".Wt-tv-rowc").css("width",b+"px").css("width","")},0);d.changed=true}else{l.style.width=c.style.width=
e+"px";a.style.width=b+"px"}}},0)}};var n=null;d.handleDragDrop=function(c,a,b,e,g){if(n){n.className=n.classNameOrig;n=null}if(c!="end"){var h=p(b);if(!h.selected&&h.drop&&h.columnId!=-1)if(c=="drop")m.emit(d,{name:"itemEvent",eventObject:a,event:b},h.nodeId,h.columnId,"drop",e,g);else{a.className="Wt-valid-drop";n=h.el;n.classNameOrig=n.className;n.className+=" Wt-drop-site"}else a.className=""}};this.autoJavaScript=function(){if(d.parentNode==null){d=i=s=t=l=null;this.autoJavaScript=function(){}}else if(!f.isHidden(d)){var c=
$(d),a,b=null,e=f.pxself(d,"width");if(e==0)e=d.clientWidth;else if(f.boxSizing(d)){e-=f.px(d,"borderLeftWidth");e-=f.px(d,"borderRightWidth")}var g=i.offsetWidth-i.clientWidth;e-=g;if(c.hasClass("column1")){a=c.find(".Wt-headerdiv").get(0).lastChild.className.split(" ")[0];a=f.getCssRule("#"+d.id+" ."+a);b=f.pxself(a,"width")}if((!f.isIE||e>100)&&(e!=i.tw||b!=i.c0w||d.changed)){var h=!d.changed;i.tw=e;i.c0w=b;a=c.find(".Wt-headerdiv").get(0).lastChild.className.split(" ")[0];a=f.getCssRule("#"+d.id+
" ."+a);var k=t.firstChild,j=f.getCssRule("#"+d.id+" .cwidth"),v=j.style.width==k.offsetWidth+"px",o=l.firstChild;j.style.width=e+"px";i.style.width=e+g+"px";if(!f.isIE)s.style.marginRight=g+"px";if(b!=null){b=e-b-(f.isIE6?10:8);if(b>0){var q=Math.min(b,f.pxself(f.getCssRule("#"+d.id+" .Wt-tv-rowc"),"width"));e-=b-q;l.style.width=e+"px";k.style.width=e+"px";f.getCssRule("#"+d.id+" .Wt-tv-row").style.width=q+"px";f.isIE&&setTimeout(function(){c.find(" .Wt-tv-row").css("width",q+"px").css("width","")},
0)}}else if(v){l.style.width=j.style.width;k.style.width=j.style.width}else l.style.width=k.offsetWidth+"px";if(!r)a.style.width=k.offsetWidth-o.offsetWidth-8+"px";d.changed=false;h&&u.adjustColumns()}}};this.scrollTo=function(c,a,b,e){if(a!=-1){a*=b;c=i.scrollTop;var g=i.clientHeight;if(e==0)if(c+g<a)e=1;else if(a<c)e=2;switch(e){case 1:i.scrollTop=a;break;case 2:i.scrollTop=a-(g-b);break;case 3:i.scrollTop=a-(g-b)/2;break}window.fakeEvent={object:i};i.onscroll(window.fakeEvent);window.fakeEvent=
null}};u.adjustColumns()});
