...
7}if(!s){if(f.isIE&&$(document.body).hasClass("Wt-rtl"))if(h=f.getCssRule("#"+d.id+" .Wt-tv-row"))h.style.width=c+"px";if(e.style.width)$(d).find(".Wt-headerdiv ."+g).css("width",e.style.width);else{g=d.scrollWidth-a.offsetWidth-9-15;if(g>0)e.style.width=g+"px"}}if(e.style.width!="auto"){e=c+f.pxself(e,"width")+(f.isIE6?10:7);if(s){k=f.getCssRule("#"+d.id+" .Wt-tv-rowc");k.style.width=c+"px";u.wtResize();j.layouts2&&j.layouts2.adjust();f.isIE&&setTimeout(function(){$(d).find(".Wt-tv-rowc").css("width",
c+"px").css("width","")},0);d.changed=true}else{p.style.width=b.style.width=e+"px";a.style.width=c+"px"}}}}jQuery.data(d,"obj",this);var w=i.firstChild,p=y.firstChild,u=this,f=j.WT,B=false;this.click=function(b,a){var c=q(a);c.columnId!=-1&&j.emit(d,{name:"itemEvent",eventObject:b,event:a},c.nodeId+":"+c.columnId,"clicked","","")};this.dblClick=function(b,a){var c=q(a);c.columnId!=-1&&j.emit(d,{name:"itemEvent",eventObject:b,event:a},c.nodeId+":"+c.columnId,"dblclicked","","")};this.mouseDown=function(b,
a){f.capture(null);var c=q(a);if(c.columnId!=-1){j.emit(d,{name:"itemEvent",eventObject:b,event:a},c.nodeId+":"+c.columnId,"mousedown","","");d.getAttribute("drag")==="true"&&c.selected&&j._p_.dragStart(d,a)}};this.mouseUp=function(b,a){var c=q(a);c.columnId!=-1&&j.emit(d,{name:"itemEvent",eventObject:b,event:a},c.nodeId+":"+c.columnId,"mouseup","","")};var m;this.touchStart=function(b,a){if(a.touches.length>1){clearTimeout(m);m=setTimeout(function(){z(b,a)},1E3)}else{clearTimeout(m);m=setTimeout(function(){z(b,
a)},50)}};this.touchMove=function(b,a){a.touches.length==1&&m&&clearTimeout(m)};this.touchEnd=function(){m&&clearTimeout(m)};this.rootClick=function(b,a){j.emit(d,{name:"itemEvent",eventObject:b,event:a},"","clicked","","")};this.rootDblClick=function(b,a){j.emit(d,{name:"itemEvent",eventObject:b,event:a},"","dblclicked","","")};this.rootMouseDown=function(b,a){j.emit(d,{name:"itemEvent",eventObject:b,event:a},"","mousedown","","")};this.rootMouseUp=function(b,a){j.emit(d,{name:"itemEvent",eventObject:b,
