...
d.changed=true}else{l.style.width=c.style.width=e+"px";a.style.width=b+"px"}}},0)}};var n=null;d.handleDragDrop=function(c,a,b,e,g){if(n){n.className=n.classNameOrig;n=null}if(c!="end"){var h=p(b);if(!h.selected&&h.drop&&h.columnId!=-1)if(c=="drop")m.emit(d,{name:"itemEvent",eventObject:a,event:b},h.nodeId,h.columnId,"drop",e,g);else{a.className="Wt-valid-drop";n=h.el;n.classNameOrig=n.className;n.className+=" Wt-drop-site"}else a.className=""}};this.autoJavaScript=function(){if(d.parentNode==null){d=
i=s=t=l=null;this.autoJavaScript=function(){}}else if(!f.isHidden(d)){var c=$(d),a,b=null,e=f.pxself(d,"width");if(e==0)e=d.clientWidth;else if(f.boxSizing(d)){e-=f.px(d,"borderLeftWidth");e-=f.px(d,"borderRightWidth")}var g=i.offsetWidth-i.clientWidth;e-=g;if(c.hasClass("column1")){a=c.find(".Wt-headerdiv").get(0).lastChild.className.split(" ")[0];a=f.getCssRule("#"+d.id+" ."+a);b=f.pxself(a,"width")}if((!f.isIE||e>100)&&(e!=i.tw||b!=i.c0w||d.changed)){var h=!d.changed;i.tw=e;i.c0w=b;a=c.find(".Wt-headerdiv").get(0).lastChild.className.split(" ")[0];
a=f.getCssRule("#"+d.id+" ."+a);var k=t.firstChild,j=f.getCssRule("#"+d.id+" .cwidth"),v=j.style.width==k.offsetWidth+"px",o=l.firstChild;j.style.width=e+"px";i.style.width=e+g+"px";if(!f.isIE)s.style.marginRight=g+"px";if(b!=null){b=e-b-(f.isIE6?10:8);if(b>0){var q=Math.min(b,f.pxself(f.getCssRule("#"+d.id+" .Wt-tv-rowc"),"width"));e-=b-q;l.style.width=e+"px";k.style.width=e+"px";f.getCssRule("#"+d.id+" .Wt-tv-row").style.width=q+"px";f.isIE&&setTimeout(function(){c.find(" .Wt-tv-row").css("width",
...
window.fakeEvent=null}};u.adjustColumns()});
