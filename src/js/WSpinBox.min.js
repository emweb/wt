WT_DECLARE_WT_MEMBER(1,"ctor.WSpinBox",function(u,c,k,l,e,f,g,h){function i(){return c.getAttribute("readonly")!==null}function m(){var a=c.value;if(a.substr(0,l.length)==l){a=a.substr(l.length);if(a.length>e.length&&a.substr(a.length-e.length,e.length)==e){a=a.substr(0,a.length-e.length);return Number(a)}}return null}function p(a){if(a>g)a=g;else if(a<f)a=f;c.value=l+a.toFixed(k)+e;n=true}function q(){var a=m();if(a!==null){a+=h;p(a)}}function r(){var a=m();if(a!==null){a-=h;p(a)}}jQuery.data(c,
"obj",this);var d=u.WT,o=$(c),j=null,s,n=false,t=null;this.update=function(a,b,v,w){f=a;g=b;h=v;k=w;t=new (k==0?d.WIntValidator:d.WDoubleValidator)(true,f,g,"Must be a number","Must be a number","The number must be at least "+f,"The number may be at most "+g)};this.mouseOut=function(){o.removeClass("Wt-spinbox-dn").removeClass("Wt-spinbox-up")};this.mouseMove=function(a,b){if(!i())if(j){a=d.pageCoordinates(b).y-j.y;b=s;if(b!==null){b-=a*h;p(b)}}else{a=d.widgetCoordinates(c,b);o.removeClass("Wt-spinbox-dn").removeClass("Wt-spinbox-up");
