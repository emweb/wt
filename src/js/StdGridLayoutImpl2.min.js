...
"none"||f.hasTag(d.w,"TEXTAREA")&&d.w.wtResize)s=false}}}if(s)l=n=-1;else if(l>n)n=l;p[h]=n;x[h]=l;if(l>-1){e+=n;m+=l}}g=0;i=true;n=false;for(h=0;h<j;++h)if(x[h]>-1){if(i){g+=b.margins[1];i=false}else{g+=b.margins[0];if(n)g+=4}n=b.config[h][1]!==0}i||(g+=b.margins[2]);e+=g;m+=g;b.measures=[p,x,e,m,g];R&&k[2]!=b.measures[2]&&R.setChildSize(P,a,b.measures[2]+K[a]);c&&k[3]!=b.measures[3]&&z(c,"min"+b.Size,b.measures[3]+"px")&&S.ancestor&&S.ancestor.setContentsDirty(c);c&&a==0&&c&&f.hasTag(c,"TD")&&z(c,
