WT_DECLARE_WT_MEMBER(1,"WSuggestionPopup",function(t,f,x,C,r,y){function p(a){return $(a).hasClass("Wt-suggest-onedit")||$(a).hasClass("Wt-suggest-dropdown")}function c(){return f.style.display!="none"}function d(){f.style.display="none"}function i(a){e.positionAtWidget(f.id,a.id,e.Vertical)}function m(a){a=e.target(a||window.event);if(a.className!="content"){for(;a&&!e.hasTag(a,"DIV");)a=a.parentNode;a&&o(a)}}function o(a){var b=a.firstChild,k=e.getElement(h),l=b.innerHTML;b=b.getAttribute("sug");
