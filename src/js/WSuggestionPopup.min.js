...
o?e.getElement(o):null)&&J(a)};g.onclick=h;g.onscroll=function(){if(D){clearTimeout(D);var a=e.getElement(f);a&&a.focus()}};this.delayHide=function(a){D=setTimeout(function(){D=null;if(g&&(a==null||f==a.id))m()},300)}});
