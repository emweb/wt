...
if(o>=0)g=setTimeout(i,o)}function z(){m=true;clearTimeout(g)}function r(a){$(a).mouseleave(y).mouseenter(z)}function v(){i()}function w(a){a.keyCode==27&&i()}jQuery.data(c,"obj",this);var A=this,f=n.WT,g=null,m=false,l=null;this.setHidden=function(a){if(g){clearTimeout(g);g=null}m=false;l=null;if(a){c.style.position="";c.style.display="";c.style.left="";c.style.top="";$(document).unbind("click",v);$(document).unbind("keydown",w)}else{setTimeout(function(){$(document).bind("click",v);$(document).bind("keydown",
w)},0);c.style.display="block"}k(c,null)};this.popupAt=function(){A.setHidden(false)};setTimeout(function(){r(c)},0);$(c).mousemove(q)});
