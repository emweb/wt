...
jQuery.data(b,"obj",this);var f=$(b).find(".titlebar").first().get(0),d=g.WT,h,i;if(f){f.onmousedown=function(a){a=a||window.event;d.capture(f);a=d.pageCoordinates(a);h=a.x;i=a.y;f.onmousemove=m};f.onmouseup=function(){f.onmousemove=null;d.capture(null)}}this.centerDialog=function(){if(b.parentNode==null)b=f=null;else if(b.style.display!="none"&&b.style.visibility!="hidden"){var a=d.windowSize(),c=b.offsetWidth,e=b.offsetHeight;if(j)b.style.left=Math.round((a.x-c)/2+(d.isIE6?document.documentElement.scrollLeft:
0))+"px";if(k)b.style.top=Math.round((a.y-e)/2+(d.isIE6?document.documentElement.scrollTop:0))+"px";b.style.height!=""&&l(b,-1,e);b.style.visibility="visible"}};b.wtResize=l;b.wtPosition=this.centerDialog});
