...
null){b=e=null;this.centerDialog=function(){}}else if(b.style.display!="none"){if(!j){var a=c.windowSize(),f=b.clientWidth+2,d=b.clientHeight+2;b.style.left=Math.round((a.x-f)/2+(c.isIE6?document.documentElement.scrollLeft:0))+"px";b.style.top=Math.round((a.y-d)/2+(c.isIE6?document.documentElement.scrollTop:0))+"px";b.style.marginLeft="0px";b.style.marginTop="0px";b.style.width!=null&&b.style.height!=null&&l.wtResize(b,f+2,d+2)}b.style.visibility="visible"}};this.wtResize=function(a,f,d){d-=2;f-=
2;a.style.height=d+"px";a.style.width=f+"px";a=a.lastChild;d-=a.previousSibling.offsetHeight+8;if(d>0){a.style.height=d+"px";g.layoutsAdjust&&g.layoutsAdjust()}}});
