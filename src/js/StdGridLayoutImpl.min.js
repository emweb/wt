...
b.px(a,"borderTopWidth");c+=b.px(a,"borderBottomWidth");c+=b.px(a,"paddingTop");c+=b.px(a,"paddingBottom")}return c};this.getColumn=function(a){var c,d,i,g=b.getElement(r).firstChild.childNodes;d=c=0;for(i=g.length;d<i;d++){var e=g[d];if(b.hasTag(e,"COLGROUP")){d=-1;g=e.childNodes;i=g.length}if(b.hasTag(e,"COL"))if(e.className!="Wt-vrh")if(c==a)return e;else++c}return null};this.adjustCell=function(a,c){var d=c==0;c-=b.pxself(a,"paddingTop");c-=b.pxself(a,"paddingBottom");if(c<=0)c=0;a.style.height=
c+"px";if(!(a.style.verticalAlign||a.childNodes.length==0)){a=a.childNodes[0];if(c<=0)c=0;if(a.className=="Wt-hcenter"){a.style.height=c+"px";a=a.firstChild.firstChild;if(!b.hasTag(a,"TD"))a=a.firstChild;if(a.style.height!=c+"px")a.style.height=c+"px";a=a.firstChild}c-=this.marginV(a);if(c<=0)c=0;if(!b.hasTag(a,"TABLE")){var i,g;if(!d){i=a.parentNode;g=i.offsetWidth-y.marginH(a);if(i.className=="Wt-chwrap"&&g>0){if(!b.isIE){a.style.position="relative";a=a.firstChild}a.style.width=g+"px";a.style.position=
"absolute"}}if(!d&&a.wtResize)a.wtResize(a,g,c);else if(a.style.height!=c+"px"){a.style.height=c+"px";if(a.className=="Wt-wrapdiv")if(b.isIE&&b.hasTag(a.firstChild,"TEXTAREA"))a.firstChild.style.height=c-b.pxself(a,"marginBottom")+"px"}}}};this.adjustRow=function(a,c){var d=[];if(a.style.height!=c+"px")a.style.height=c+"px";a=a.childNodes;var i,g,e,h;i=0;h=-1;for(g=a.length;i<g;++i){e=a[i];e.className!="Wt-vrh"&&++h;if(e.rowSpan!=1){this.adjustCell(e,0,h);d.push({td:e,col:h})}else this.adjustCell(e,
c,h)}return d};this.adjust=function(){var a=b.getElement(r);if(!a)return false;y.initResize&&y.initResize(b,r,o);if(b.isHidden(a))return true;var c=a.firstChild,d=a.parentNode;if(c.style.height!=="")c.style.height="";var i,g=false;if(k){i=b.pxself(d,"height");if(i===0){g=true;i=d.clientHeight}}else i=c.clientHeight;var e=d.clientWidth;if(!(a.dirty||c.w!==e||c.h!==i))return true;c.w=e;c.h=i;a.dirty=null;var h=i;i=c.rows.length;if(k){if(g){h-=b.px(d,"paddingTop");h-=b.px(d,"paddingBottom")}else if(b.boxSizing(d)){h-=
b.px(d,"borderTopWidth");h-=b.px(d,"borderBottomWidth");h-=b.px(d,"paddingTop");h-=b.px(d,"paddingBottom")}h-=b.px(a,"marginTop");h-=b.px(a,"marginBottom");if(d.children&&d.children.length!==1){g=0;for(i=d.children.length;g<i;++g){e=d.children[g];if(e!==a)h-=$(e).outerHeight()}}var q=0;a=0;var l;for(d=g=0;g<i;g++){e=c.rows[g];if(e.className)h-=e.offsetHeight;else{a+=o.minheight[d];if(o.stretch[d]<=0)h-=e.offsetHeight;else q+=o.stretch[d];++d}}h=h>a?h:a}a=[];var s=h,t;for(d=g=0;g<i;g++){e=c.rows[g];
if(!e.className){l=o.stretch[d];if(l==-1||k&&l>0){if(l!==-1){t=o.minheight[d];l=h*l/q;l=s>l?l:s;l=Math.round(t>l?t:l);s-=l}else l=e.offsetHeight;b.addAll(a,this.adjustRow(e,l))}++d}}g=0;for(i=a.length;g<i;++g){e=a[g].td;q=a[g].col;this.adjustCell(e,e.offsetHeight,q)}if(c.style.tableLayout!=="fixed")return true;d=0;s=c.childNodes;var A,x,u;h=0;for(a=s.length;h<a;h++){q=s[h];if(b.hasTag(q,"COLGROUP")){h=-1;s=q.childNodes;a=s.length}if(b.hasTag(q,"COL")){if(b.pctself(q,"width")===0){g=t=0;for(i=c.rows.length;g<
i;g++){e=c.rows[g];l=e.childNodes;x=A=0;for(u=l.length;x<u;x++){e=l[x];if(e.colSpan===1&&A===d&&e.childNodes.length===1){e=e.firstChild;e=e.offsetWidth+y.marginH(e);t=Math.max(t,e);break}A+=e.colSpan;if(A>d)break}}if(t>0&&b.pxself(q,"width")!==t)q.style.width=t+"px"}++d}}return true};this.contains=function(a){var c=b.getElement(r);a=b.getElement(a.getId());return c&&a?b.contains(c,a):false}});
