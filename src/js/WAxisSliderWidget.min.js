...
a/c[2]);p(true)}var M=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(a){window.setTimeout(a,0)}}(),H=false,L=function(a){if(!H){H=true;M(function(){a();H=false})}},o={};jQuery.data(e,"sobj",this);var n=this,h=y.WT;m.canvas.style.msTouchAction="none";var q=false;if(window.MSPointerEvent||window.PointerEvent){e.style.touchAction="none";m.canvas.style.msTouchAction="none";m.canvas.style.touchAction="none"}if(window.MSPointerEvent||
