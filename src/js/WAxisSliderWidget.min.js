WT_DECLARE_WT_MEMBER(1,JavaScriptConstructor,"WAxisSliderWidget",function(y,e,m,f){function C(a){return a.pointerType===2||a.pointerType===3||a.pointerType==="pen"||a.pointerType==="touch"}function I(){M(m.repaint)}function J(){var a=f.transform[4]/f.drawArea[2];return[a,f.transform[0]+a]}function p(a){I();if(a){a=f.transform;var b=a[4]/f.drawArea[2];f.chart.setXRange(f.series,b,a[0]+b)}}function r(){return!f.chart.config.isHorizontal}function D(a,b,c){return r()?a.y>=t(b)&&a.y<=u(b)&&a.x>v(b)-c/
2&&a.x<v(b)+c/2:a.x>=v(b)&&a.x<=w(b)&&a.y>t(b)-c/2&&a.y<t(b)+c/2}function E(a,b,c){return r()?a.y>=t(b)&&a.y<=u(b)&&a.x>w(b)-c/2&&a.x<w(b)+c/2:a.x>=v(b)&&a.x<=w(b)&&a.y>u(b)-c/2&&a.y<u(b)+c/2}function z(a,b){return r()?a.y>=t(b)&&a.y<=u(b)&&a.x>v(b)&&a.x<w(b):a.x>=v(b)&&a.x<=w(b)&&a.y>t(b)&&a.y<u(b)}function F(a){var b=f.transform,c=f.drawArea,d=b[4]/c[2];b=b[0]+d;a=(d*c[2]+a)/c[2];if(!(b<=a))if(!(1/(b-a)>f.chart.config.maxZoom[0])){if(a<0)a=0;if(a>1)a=1;n.changeRange(a,b);p(true);a=J();if(Math.abs(a[1]-
b)>Math.abs(a[0]-d)){n.changeRange(d,b);p(true)}}}function G(a){var b=f.transform,c=f.drawArea,d=b[4]/c[2];b=b[0]+d;a=(b*c[2]+a)/c[2];if(!(a<=d))if(!(1/(a-d)>f.chart.config.maxZoom[0])){if(a<0)a=0;if(a>1)a=1;n.changeRange(d,a);p(true);a=J();if(Math.abs(a[0]-d)>Math.abs(a[1]-b)){n.changeRange(d,b);p(true)}}}function K(a){var b=f.transform,c=f.drawArea,d=b[4]/c[2];b=b[0]+d;d=d*c[2];var g=d+a;if(g<0){a=-d;g=0}g=g/c[2];b=b*c[2];a=b+a;if(a>c[2]){a=c[2]-b;g=d+a;g=g/c[2];a=c[2]}n.changeRange(g,a/c[2]);p(true)}
var N=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(a){window.setTimeout(a,0)}}(),H=false,M=function(a){if(!H){H=true;N(function(){a();H=false})}},o={};jQuery.data(e,"sobj",this);var n=this,h=y.WT;m.canvas.style.msTouchAction="none";var q=false;if(window.MSPointerEvent||window.PointerEvent){e.style.touchAction="none";m.canvas.style.msTouchAction="none";m.canvas.style.touchAction="none"}if(window.MSPointerEvent||window.PointerEvent)(function(){function a(){if(pointers.length>
0&&!q)q=true;else if(pointers.length<=0&&q)q=false}function b(k){if(C(k)){k.preventDefault();pointers.push(k);a();o.start(e,{touches:pointers.slice(0)})}}function c(k){if(q)if(C(k)){k.preventDefault();var l;for(l=0;l<pointers.length;++l)if(pointers[l].pointerId===k.pointerId){pointers.splice(l,1);break}a();o.end(e,{touches:pointers.slice(0),changedTouches:[]})}}function d(k){if(C(k)){k.preventDefault();var l;for(l=0;l<pointers.length;++l)if(pointers[l].pointerId===k.pointerId){pointers[l]=k;break}a();
o.moved(e,{touches:pointers.slice(0)})}}pointers=[];var g=jQuery.data(e,"eobj");if(g)if(window.PointerEvent){e.removeEventListener("pointerdown",g.pointerDown);e.removeEventListener("pointerup",g.pointerUp);e.removeEventListener("pointerout",g.pointerUp);e.removeEventListener("pointermove",g.pointerMove)}else{e.removeEventListener("MSPointerDown",g.pointerDown);e.removeEventListener("MSPointerUp",g.pointerUp);e.removeEventListener("MSPointerOut",g.pointerUp);e.removeEventListener("MSPointerMove",
