WT_DECLARE_WT_MEMBER(1,"WTableView",function(o,i,e,p){function q(a){var b=-1,c=false,d=false,j=null;for(a=f.target(a);a;){var g=$(a);if(g.hasClass("Wt-tv-contents"))break;else if(g.hasClass("Wt-tv-c")){if(a.getAttribute("drop")==="true")d=true;if(g.hasClass("Wt-selected"))c=true;j=a;a=a.parentNode;b=a.className.split(" ")[0].substring(7)*1;break}a=a.parentNode}return{columnId:b,rowIdx:-1,selected:c,drop:d,el:j}}function t(){return f.pxself(e.firstChild,"lineHeight")}function r(a){var b,c,d=a.parentNode.childNodes;
