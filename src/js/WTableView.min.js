WT_DECLARE_WT_MEMBER(1,"WTableView",function(n,h,f,p){function q(a){var b=-1,c=false,d=false,k=null;for(a=a.target||a.srcElement;a;){var g=$(a);if(g.hasClass("Wt-tv-contents"))break;else if(g.hasClass("Wt-tv-c")){if(a.getAttribute("drop")==="true")d=true;if(g.hasClass("Wt-selected"))c=true;k=a;a=a.parentNode;b=a.className.split(" ")[0].substring(7)*1;break}a=a.parentNode}return{columnId:b,rowIdx:-1,selected:c,drop:d,el:k}}function r(a){var b,c,d=a.parentNode.childNodes;b=0;for(c=d.length;b<c;++b)if(d[b]==
...
f=p=null;this.autoJavaScript=function(){}}else if(!i.isHidden(h)){var a=h.offsetWidth-i.px(h,"borderLeftWidth")-i.px(h,"borderRightWidth"),b=f.offsetWidth-f.clientWidth;a-=b;if(a>200&&a!=f.tw){f.tw=a;f.style.width=a+b+"px";p.style.width=a+"px"}}}});
