...
if(c>-1&&c<g&&e>-1&&e<k){a=a.parentNode.childNodes[e];m=$(a.childNodes[c]).find(":input");m.size()>0&&setTimeout(function(){m.focus()},0)}}}}};this.autoJavaScript=function(){if(h.parentNode==null){h=d=q=null;this.autoJavaScript=function(){}}else if(!f.isHidden(h)){if(!f.isIE&&(s!=d.scrollTop||t!=d.scrollLeft)){q.scrollLeft=d.scrollLeft=t;n.scrollTop=d.scrollTop=s}var a=h.offsetWidth-f.px(h,"borderLeftWidth")-f.px(h,"borderRightWidth"),b=d.offsetWidth-d.clientWidth;a-=b;a-=n.clientWidth;if(a>200&&
a!=d.tw){d.tw=a;d.style.width=a+b+"px";q.style.width=a+"px";if(!f.isIE)q.style.marginRight=b+"px"}a=d.offsetHeight-d.clientHeight;if(n.parentNode)if((b=n.parentNode.style)&&b.paddingBottom!==a+"px"){b.paddingBottom=a+"px";p.layouts.adjust(h.children[0].id);p.layouts.adjust()}}}});
