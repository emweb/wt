WT_DECLARE_WT_MEMBER(1,JavaScriptConstructor,"WTableView",function(o,h,d,p,q){function u(a){var b=-1,c=false,e=false,k=null;for(a=f.target(a);a;){var g=$(a);if(g.hasClass("Wt-tv-contents"))break;else if(g.hasClass("Wt-tv-c")){if(a.getAttribute("drop")==="true")e=true;if(g.hasClass("Wt-selected"))c=true;k=a;a=a.parentNode;b=a.className.split(" ")[0].substring(7)*1;break}a=a.parentNode}return{columnId:b,rowIdx:-1,selected:c,drop:e,el:k}}function x(){return f.pxself(d.firstChild,"lineHeight")}function v(a){var b,
c,e=a.parentNode.childNodes;b=0;for(c=e.length;b<c;++b)if(e[b]==a)return b;return-1}function D(a,b){var c=$(document.body).hasClass("Wt-rtl");if(c)b=-b;var e=a.className.split(" ")[0],k=e.substring(7)*1,g=a.parentNode,j=g.parentNode!==p,i=j?q.firstChild:d.firstChild,l=i.firstChild;e=$(i).find("."+e).get(0);var m=a.nextSibling,r=e.nextSibling,w=f.pxself(a,"width")-1+b,y=f.pxself(g,"width")+b+"px";g.style.width=i.style.width=l.style.width=y;if(j)q.style.width=y;a.style.width=w+1+"px";for(e.style.width=
...
this.scrollTo=function(a,b,c){if(b!=-1){a=d.scrollTop;var e=d.clientHeight;if(c==0)if(a+e<b)c=1;else if(b<a)c=2;switch(c){case 1:d.scrollTop=b;break;case 2:d.scrollTop=b-(e-x());break;case 3:d.scrollTop=b-(e-x())/2;break}d.onscroll()}};var n=null;h.handleDragDrop=function(a,b,c,e,k){if(n){n.className=n.classNameOrig;n=null}if(a!="end"){var g=u(c);if(!g.selected&&g.drop)if(a=="drop")o.emit(h,{name:"dropEvent",eventObject:b,event:c},g.rowIdx,g.columnId,e,k);else{b.className="Wt-valid-drop";n=g.el;n.classNameOrig=
n.className;n.className+=" Wt-drop-site"}else b.className=""}};h.onkeydown=function(a){var b=a||window.event;if(b.keyCode==9){f.cancelEvent(b);var c=u(b);if(c.el){a=c.el.parentNode;c=v(c.el);var e=v(a),k=a.parentNode.childNodes.length,g=a.childNodes.length;b=b.shiftKey;for(var j=false,i=c,l;;){for(;b?i>=0:i<g;i=b?i-1:i+1)for(l=i==c&&!j?b?e-1:e+1:b?k-1:0;b?l>=0:l<k;l=b?l-1:l+1){if(i==c&&l==e)return;a=a.parentNode.childNodes[l];var m=$(a.childNodes[i]).find(":input");if(m.size()>0){setTimeout(function(){m.focus()},
0);return}}i=b?g-1:0;j=true}}}else if(b.keyCode>=37&&b.keyCode<=40){j=f.target(b);if(j.nodeName!="select"){c=u(b);if(c.el){a=c.el.parentNode;c=v(c.el);e=v(a);k=a.parentNode.childNodes.length;g=a.childNodes.length;switch(b.keyCode){case 39:if(f.hasTag(j,"INPUT")&&j.type=="text"){i=f.getSelectionRange(j);if(i.start!=j.value.length)return}e++;break;case 38:c--;break;case 37:if(f.hasTag(j,"INPUT")&&j.type=="text"){i=f.getSelectionRange(j);if(i.start!=0)return}e--;break;case 40:c++;break;default:return}f.cancelEvent(b);
if(c>-1&&c<g&&e>-1&&e<k){a=a.parentNode.childNodes[e];m=$(a.childNodes[c]).find(":input");m.size()>0&&setTimeout(function(){m.focus()},0)}}}}};this.autoJavaScript=function(){if(h.parentNode==null){h=d=p=null;this.autoJavaScript=function(){}}else if(!f.isHidden(h)){if(!f.isIE&&(s!=d.scrollTop||t!=d.scrollLeft)){p.scrollLeft=d.scrollLeft=t;q.scrollTop=d.scrollTop=s}var a=h.offsetWidth-f.px(h,"borderLeftWidth")-f.px(h,"borderRightWidth"),b=d.offsetWidth-d.clientWidth;a-=b;a-=q.clientWidth;if(a>200&&
a!=d.tw){d.tw=a;d.style.width=a+b+"px";p.style.width=a+"px";if(!f.isIE)p.style.marginRight=b+"px"}a=d.offsetHeight-d.clientHeight;b=q.parentNode.style;if(b.paddingBottom!==a+"px"){b.paddingBottom=a+"px";o.layouts.adjust(h.children[0].id);o.layouts.adjust()}}}});
