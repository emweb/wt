...
rowIdx:c,selected:e,drop:k,el:h}}function E(){return f.pxself(d.firstChild,"lineHeight")}function x(a){var b,c,e=a.parentNode.childNodes;b=0;for(c=e.length;b<c;++b)if(e[b]==a)return b;return-1}function J(a,b){var c=$(document.body).hasClass("Wt-rtl");if(c)b=-b;var e=a.className.split(" ")[0],k=e.substring(7)*1,h=a.parentNode,i=h.parentNode!==l,j=i?r.firstChild:d.firstChild,m=j.firstChild;e=$(j).find("."+e).get(0);var n=a.nextSibling,o=e.nextSibling,t=f.pxself(a,"width")-1+b,v=f.pxself(h,"width")+
b+"px";h.style.width=j.style.width=m.style.width=v;if(i){r.style.width=v;r.firstChild.style.width=v;d.style.left=v;l.style.left=v}a.style.width=t+1+"px";e.style.width=t+7+"px";for(q.layouts2.adjust(g.childNodes[0].id,[[1,1]]);n;n=n.nextSibling)if(o){if(c)o.style.right=f.pxself(o,"right")+b+"px";else o.style.left=f.pxself(o,"left")+b+"px";o=o.nextSibling}q.emit(g,"columnResized",k,parseInt(t));K.autoJavaScript()}jQuery.data(g,"obj",this);var K=this,f=q.WT,I=$(document.body).hasClass("Wt-rtl"),y=0,
z=0,A=0,B=0,C=false,u=0,p=0,F=0,G=0;l.onscroll=function(){d.scrollLeft=l.scrollLeft;this.onContentsContainerScroll()};this.onContentsContainerScroll=function(){p=l.scrollLeft=d.scrollLeft;u=r.scrollTop=d.scrollTop;if(!(d.scrollTop==0&&f.isAndroid))if(d.clientWidth&&d.clientHeight&&!C&&(d.scrollTop<A||d.scrollTop>B||d.scrollLeft<y||d.scrollLeft>z))q.emit(g,"scrolled",D(d),d.scrollTop,d.clientWidth,d.clientHeight)};d.wtResize=function(a,b,c){if(b-F>(z-y)/2||c-G>(B-A)/2){F=b;G=c;b=a.clientHeight==a.firstChild.clientHeight?
