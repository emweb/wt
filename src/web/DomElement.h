...
enum class Property { InnerHTML, AddedInnerHTML,
                      ...
                      StyleInsetInline,
                      StyleInsetInlineStart, StyleInsetInlineEnd,
                      StyleInsetBlock,
                      StyleInsetBlockStart, StyleInsetBlockEnd,
                      StyleVerticalAlign, StyleTextAlign,
                      StylePadding,
                      StylePaddingTop, StylePaddingRight,
                      StylePaddingBottom, StylePaddingLeft,
                      StylePaddingInline,
                      StylePaddingInlineStart, StylePaddingInlineEnd,
                      StylePaddingBlock,
                      StylePaddingBlockStart, StylePaddingBlockEnd,
                      StyleMargin,
                      StyleMarginTop, StyleMarginRight,
                      StyleMarginBottom, StyleMarginLeft,
                      StyleMarginInline,
                      StyleMarginInlineStart, StyleMarginInlineEnd,
                      StyleMarginBlock,
                      StyleMarginBlockStart, StyleMarginBlockEnd,
                      StyleCursor,
                      StyleBorderTop, StyleBorderRight,
                      StyleBorderBottom, StyleBorderLeft,
                      StyleBorderInline,
                      StyleBorderInlineStart, StyleBorderInlineEnd,
                      StyleBorderBlock,
                      StyleBorderBlockStart, StyleBorderBlockEnd,
                      StyleBorderColorTop, StyleBorderColorRight,
                      StyleBorderColorBottom, StyleBorderColorLeft,
                      StyleBorderInlineColor,
                      StyleBorderInlineStartColor, StyleBorderInlineEndColor,
                      StyleBorderBlockColor,
                      StyleBorderBlockStartColor, StyleBorderBlockEndColor,
                      StyleBorderWidthTop, StyleBorderWidthRight,
                      StyleBorderWidthBottom, StyleBorderWidthLeft,
                      StyleBorderInlineWidth,
                      StyleBorderInlineStartWidth, StyleBorderInlineEndWidth,
                      StyleBorderBlockWidth,
                      StyleBorderBlockStartWidth, StyleBorderBlockEndWidth,
                      StyleColor,
                      StyleOverflowX,
                      StyleOverflowY,
                      StyleOpacity,
