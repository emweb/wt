...
window._$_APP_CLASS_$_Loaded = false;

function _$_APP_CLASS_$_OnLoad() { window._$_APP_CLASS_$_Loaded = true; }

function doScrollCheck() {
  if ( window._$_APP_CLASS_$_Loaded ) {
    return;
  }
  try {
...
if ( document.addEventListener ) {
  ...
  window.addEventListener( "load", _$_APP_CLASS_$_OnLoad, false );
} else if ( document.attachEvent ) {
  document.attachEvent("onreadystatechange", DOMContentLoaded);
  window.attachEvent( "onload", _$_APP_CLASS_$_OnLoad );
  var toplevel = false;
  try {
