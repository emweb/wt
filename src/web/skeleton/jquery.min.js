...
b){return d.each(this,a,b)},ready:function(a){d.bindReady();if(d.isReady)a.call(r,d);else H&&H.push(a);return this},eq:function(a){return a===-1?this.slice(a):this.slice(a,+a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(I.apply(this,arguments),"slice",I.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,e){return a.call(b,e,b)}))},end:function(){return this.prevObject||d(null)},push:V,sort:[].sort,
splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a=arguments[0]||{},b=1,e=arguments.length,g=false,h,k,l,q;if(typeof a==="boolean"){g=a;a=arguments[1]||{};b=2}if(typeof a!=="object"&&!d.isFunction(a))a={};if(e===b){a=this;--b}for(;b<e;b++)if((h=arguments[b])!=null)for(k in h){l=a[k];q=h[k];if(a!==q)if(g&&q&&(d.isPlainObject(q)||d.isArray(q))){l=l&&(d.isPlainObject(l)||d.isArray(l))?l:d.isArray(q)?[]:{};a[k]=d.extend(g,l,q)}else if(q!==v)a[k]=q}return a};d.extend({noConflict:function(a){x.$=
...
false)break}else for(;h<k;){if(b.apply(a[h++],e)===false)break}else if(l)for(g in a){if(b.call(a[g],g,a[g])===false)break}else for(e=a[0];h<k&&b.call(e,h,e)!==false;e=a[++h]);return a},trim:function(a){return(a||"").replace(xa,"")},makeArray:function(a,b){b=b||[];if(a!=null)a.length==null||typeof a==="string"||d.isFunction(a)||typeof a!=="function"&&a.setInterval?V.call(b,a):d.merge(b,a);return b},inArray:function(a,b){if(b.indexOf)return b.indexOf(a);for(var e=0,g=b.length;e<g;e++)if(b[e]===a)return e;
...
!g)return null;g||(g=++za);if(typeof b==="object"){a[B]=g;h=h[g]=d.extend(true,{},b)}else h=h[g]?h[g]:typeof e==="undefined"?Aa:(h[g]={});if(e!==v){a[B]=g;h[b]=e}return typeof b==="string"?h[b]:h}},removeData:function(a,b){if(!(a.nodeName&&d.noData[a.nodeName.toLowerCase()])){a=a==x?da:a;var e=a[B],g=d.cache,h=g[e];if(b){if(h){delete h[b];d.isEmptyObject(h)&&d.removeData(a)}}else{try{delete a[B]}catch(k){a.removeAttribute&&a.removeAttribute(B)}delete g[e]}}}});d.fn.extend({data:function(a,b){if(typeof a===
...
for(var m=[],t,s,u,J,C=true,F=P(f),D=c;(g.exec(""),t=g.exec(D))!==null;){D=t[3];m.push(t[1]);if(t[2]){J=t[3];break}}if(m.length>1&&w.exec(c))if(m.length===2&&o.relative[m[0]])s=ea(m[0]+m[1],f);else for(s=o.relative[m[0]]?[f]:p(m.shift(),f);m.length;){c=m.shift();if(o.relative[c])c+=m.shift();s=ea(c,s)}else{if(!j&&m.length>1&&f.nodeType===9&&!F&&o.match.ID.test(m[0])&&!o.match.ID.test(m[m.length-1])){t=p.find(m.shift(),f,F);f=t.expr?p.filter(t.expr,t.set)[0]:t.set[0]}if(f){t=j?{expr:m.pop(),set:K(j)}:
p.find(m.pop(),m.length===1&&(m[0]==="~"||m[0]==="+")&&f.parentNode?f.parentNode:f,F);s=t.expr?p.filter(t.expr,t.set):t.set;if(m.length>0)u=K(s);else C=false;for(;m.length;){var z=m.pop();t=z;if(o.relative[z])t=m.pop();else z="";if(t==null)t=f;o.relative[z](u,t,F)}}else u=[]}u||(u=s);if(!u)throw"Syntax error, unrecognized expression: "+(z||c);if(k.call(u)==="[object Array]")if(C)if(f&&f.nodeType===1)for(c=0;u[c]!=null;c++){if(u[c]&&(u[c]===true||u[c].nodeType===1&&fa(f,u[c])))i.push(s[c])}else for(c=
0;u[c]!=null;c++)u[c]&&u[c].nodeType===1&&i.push(s[c]);else i.push.apply(i,u);else K(u,i);if(J){p(J,n,i,j);p.uniqueSort(i)}return i};p.uniqueSort=function(c){if(L){l=q;c.sort(L);if(l)for(var f=1;f<c.length;f++)c[f]===c[f-1]&&c.splice(f--,1)}return c};p.matches=function(c,f){return p(c,null,null,f)};p.find=function(c,f,i){var j,n;if(!c)return[];for(var m=0,t=o.order.length;m<t;m++){var s=o.order[m];if(n=o.leftMatch[s].exec(c)){var u=n[1];n.splice(1,1);if(u.substr(u.length-1)!=="\\"){n[1]=(n[1]||"").replace(/\\/g,
"");j=o.find[s](n,f,i);if(j!=null){c=c.replace(o.match[s],"");break}}}}j||(j=f.getElementsByTagName("*"));return{set:j,expr:c}};p.filter=function(c,f,i,j){for(var n=c,m=[],t=f,s,u,J=f&&f[0]&&P(f[0]);c&&f.length;){for(var C in o.filter)if((s=o.match[C].exec(c))!=null){var F=o.filter[C],D,z;u=false;if(t===m)m=[];if(o.preFilter[C])if(s=o.preFilter[C](s,t,i,m,j,J)){if(s===true)continue}else u=D=true;if(s)for(var Q=0;(z=t[Q])!=null;Q++)if(z){D=F(z,s,Q,t);var ga=j^!!D;if(i&&D!=null)if(ga)u=true;else t[Q]=
false;else if(ga){m.push(z);u=true}}if(D!==v){i||(t=m);c=c.replace(o.match[C],"");if(!u)return[];break}}if(c===n)if(u==null)throw"Syntax error, unrecognized expression: "+c;else break;n=c}return t};var o=p.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\((even|odd|[\dn+-]*)\))?/,
POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF-]|\\.)+)(?:\((['"]*)((?:\([^\)]+\)|[^\2\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(c){return c.getAttribute("href")}},relative:{"+":function(c,f){var i=typeof f==="string",j=i&&!/\W/.test(f);i=i&&!j;if(j)f=f.toLowerCase();j=0;for(var n=c.length,m;j<n;j++)if(m=c[j]){for(;(m=m.previousSibling)&&m.nodeType!==1;);c[j]=i||m&&m.nodeName.toLowerCase()===
f?m||false:m===f}i&&p.filter(f,c,true)},">":function(c,f){var i=typeof f==="string";if(i&&!/\W/.test(f)){f=f.toLowerCase();for(var j=0,n=c.length;j<n;j++){var m=c[j];if(m){i=m.parentNode;c[j]=i.nodeName.toLowerCase()===f?i:false}}}else{j=0;for(n=c.length;j<n;j++)if(m=c[j])c[j]=i?m.parentNode:m.parentNode===f;i&&p.filter(f,c,true)}},"":function(c,f,i){var j=h++,n=e;if(typeof f==="string"&&!/\W/.test(f)){var m=f=f.toLowerCase();n=b}n("parentNode",f,j,c,m,i)},"~":function(c,f,i){var j=h++,n=e;if(typeof f===
"string"&&!/\W/.test(f)){var m=f=f.toLowerCase();n=b}n("previousSibling",f,j,c,m,i)}},find:{ID:function(c,f,i){if(typeof f.getElementById!=="undefined"&&!i)return(c=f.getElementById(c[1]))?[c]:[]},NAME:function(c,f){if(typeof f.getElementsByName!=="undefined"){var i=[];f=f.getElementsByName(c[1]);for(var j=0,n=f.length;j<n;j++)f[j].getAttribute("name")===c[1]&&i.push(f[j]);return i.length===0?null:i}},TAG:function(c,f){return f.getElementsByTagName(c[1])}},preFilter:{CLASS:function(c,f,i,j,n,m){c=
" "+c[1].replace(/\\/g,"")+" ";if(m)return c;m=0;for(var t;(t=f[m])!=null;m++)if(t)if(n^(t.className&&(" "+t.className+" ").replace(/[\t\n]/g," ").indexOf(c)>=0))i||j.push(t);else if(i)f[m]=false;return false},ID:function(c){return c[1].replace(/\\/g,"")},TAG:function(c){return c[1].toLowerCase()},CHILD:function(c){if(c[1]==="nth"){var f=/(-?)(\d*)n((?:\+|-)?\d*)/.exec(c[2]==="even"&&"2n"||c[2]==="odd"&&"2n+1"||!/\D/.test(c[2])&&"0n+"+c[2]||c[2]);c[2]=f[1]+(f[2]||1)-0;c[3]=f[3]-0}c[0]=h++;return c},
ATTR:function(c,f,i,j,n,m){f=c[1].replace(/\\/g,"");if(!m&&o.attrMap[f])c[1]=o.attrMap[f];if(c[2]==="~=")c[4]=" "+c[4]+" ";return c},PSEUDO:function(c,f,i,j,n){if(c[1]==="not")if((g.exec(c[3])||"").length>1||/^\w/.test(c[3]))c[3]=p(c[3],null,null,f);else{c=p.filter(c[3],f,i,true^n);i||j.push.apply(j,c);return false}else if(o.match.POS.test(c[0])||o.match.CHILD.test(c[0]))return true;return c},POS:function(c){c.unshift(true);return c}},filters:{enabled:function(c){return c.disabled===false&&c.type!==
"hidden"},disabled:function(c){return c.disabled===true},checked:function(c){return c.checked===true},selected:function(c){return c.selected===true},parent:function(c){return!!c.firstChild},empty:function(c){return!c.firstChild},has:function(c,f,i){return!!p(i[3],c).length},header:function(c){return/h\d/i.test(c.nodeName)},text:function(c){return"text"===c.type},radio:function(c){return"radio"===c.type},checkbox:function(c){return"checkbox"===c.type},file:function(c){return"file"===c.type},password:function(c){return"password"===
c.type},submit:function(c){return"submit"===c.type},image:function(c){return"image"===c.type},reset:function(c){return"reset"===c.type},button:function(c){return"button"===c.type||c.nodeName.toLowerCase()==="button"},input:function(c){return/input|select|textarea|button/i.test(c.nodeName)}},setFilters:{first:function(c,f){return f===0},last:function(c,f,i,j){return f===j.length-1},even:function(c,f){return f%2===0},odd:function(c,f){return f%2===1},lt:function(c,f,i){return f<i[3]-0},gt:function(c,
f,i){return f>i[3]-0},nth:function(c,f,i){return i[3]-0===f},eq:function(c,f,i){return i[3]-0===f}},filter:{PSEUDO:function(c,f,i,j){var n=f[1],m=o.filters[n];if(m)return m(c,i,f,j);else if(n==="contains")return(c.textContent||c.innerText||a([c])||"").indexOf(f[3])>=0;else if(n==="not"){f=f[3];i=0;for(j=f.length;i<j;i++)if(f[i]===c)return false;return true}else throw"Syntax error, unrecognized expression: "+n;},CHILD:function(c,f){var i=f[1],j=c;switch(i){case "only":case "first":for(;j=j.previousSibling;)if(j.nodeType===
...
1||c.nodeName.toLowerCase()===f},CLASS:function(c,f){return(" "+(c.className||c.getAttribute("class"))+" ").indexOf(f)>-1},ATTR:function(c,f){var i=f[1];c=o.attrHandle[i]?o.attrHandle[i](c):c[i]!=null?c[i]:c.getAttribute(i);i=c+"";var j=f[2];f=f[4];return c==null?j==="!=":j==="="?i===f:j==="*="?i.indexOf(f)>=0:j==="~="?(" "+i+" ").indexOf(f)>=0:!f?i&&c!==false:j==="!="?i!==f:j==="^="?i.indexOf(f)===0:j==="$="?i.substr(i.length-f.length)===f:j==="|="?i===f||i.substr(0,f.length+1)===f+"-":false},POS:function(c,
f,i,j){var n=o.setFilters[f[2]];if(n)return n(c,i,f,j)}}},w=o.match.POS;for(var A in o.match){o.match[A]=new RegExp(o.match[A].source+/(?![^\[]*\])(?![^\(]*\))/.source);o.leftMatch[A]=new RegExp(/(^(?:.|\r|\n)*?)/.source+o.match[A].source)}var K=function(c,f){c=Array.prototype.slice.call(c,0);if(f){f.push.apply(f,c);return f}return c};try{Array.prototype.slice.call(r.documentElement.childNodes,0)}catch(Wa){K=function(c,f){f=f||[];if(k.call(c)==="[object Array]")Array.prototype.push.apply(f,c);else if(typeof c.length===
"number")for(var i=0,j=c.length;i<j;i++)f.push(c[i]);else for(i=0;c[i];i++)f.push(c[i]);return f}}var L;if(r.documentElement.compareDocumentPosition)L=function(c,f){if(!c.compareDocumentPosition||!f.compareDocumentPosition){if(c==f)l=true;return c.compareDocumentPosition?-1:1}c=c.compareDocumentPosition(f)&4?-1:c===f?0:1;if(c===0)l=true;return c};else if("sourceIndex"in r.documentElement)L=function(c,f){if(!c.sourceIndex||!f.sourceIndex){if(c==f)l=true;return c.sourceIndex?-1:1}c=c.sourceIndex-f.sourceIndex;
if(c===0)l=true;return c};else if(r.createRange)L=function(c,f){if(!c.ownerDocument||!f.ownerDocument){if(c==f)l=true;return c.ownerDocument?-1:1}var i=c.ownerDocument.createRange(),j=f.ownerDocument.createRange();i.setStart(c,0);i.setEnd(c,0);j.setStart(f,0);j.setEnd(f,0);c=i.compareBoundaryPoints(Range.START_TO_END,j);if(c===0)l=true;return c};(function(){var c=r.createElement("div"),f="script"+(new Date).getTime();c.innerHTML="<a name='"+f+"'/>";var i=r.documentElement;i.insertBefore(c,i.firstChild);
if(r.getElementById(f)){o.find.ID=function(j,n,m){if(typeof n.getElementById!=="undefined"&&!m)return(n=n.getElementById(j[1]))?n.id===j[1]||typeof n.getAttributeNode!=="undefined"&&n.getAttributeNode("id").nodeValue===j[1]?[n]:v:[]};o.filter.ID=function(j,n){var m=typeof j.getAttributeNode!=="undefined"&&j.getAttributeNode("id");return j.nodeType===1&&m&&m.nodeValue===n}}i.removeChild(c);i=c=null})();(function(){var c=r.createElement("div");c.appendChild(r.createComment(""));if(c.getElementsByTagName("*").length>
...
["",""])[1].toLowerCase(),p=y[q]||y._default,o=p[0];k=b.createElement("div");for(k.innerHTML=p[1]+l+p[2];o--;)k=k.lastChild;if(!d.support.tbody){o=La.test(l);q=q==="table"&&!o?k.firstChild&&k.firstChild.childNodes:p[1]==="<table>"&&!o?k.childNodes:[];for(p=q.length-1;p>=0;--p)d.nodeName(q[p],"tbody")&&!q[p].childNodes.length&&q[p].parentNode.removeChild(q[p])}!d.support.leadingWhitespace&&R.test(l)&&k.insertBefore(b.createTextNode(R.exec(l)[0]),k.firstChild);l=d.makeArray(k.childNodes)}if(l.nodeType)h.push(l);
else h=d.merge(h,l)}});if(e)for(a=0;h[a];a++)if(g&&d.nodeName(h[a],"script")&&(!h[a].type||h[a].type.toLowerCase()==="text/javascript"))g.push(h[a].parentNode?h[a].parentNode.removeChild(h[a]):h[a]);else{h[a].nodeType===1&&h.splice.apply(h,[a+1,0].concat(d.makeArray(h[a].getElementsByTagName("script"))));e.appendChild(h[a])}return h}});d.fn.offset="getBoundingClientRect"in r.documentElement?function(a){var b=this[0];if(!b||!b.ownerDocument)return null;if(a)return this.each(function(h){d.offset.setOffset(this,
a,h)});if(b===b.ownerDocument.body)return d.offset.bodyOffset(b);var e=b.getBoundingClientRect(),g=b.ownerDocument;b=g.body;g=g.documentElement;return{top:e.top+(self.pageYOffset||d.support.boxModel&&g.scrollTop||b.scrollTop)-(g.clientTop||b.clientTop||0),left:e.left+(self.pageXOffset||d.support.boxModel&&g.scrollLeft||b.scrollLeft)-(g.clientLeft||b.clientLeft||0)}}:function(a){var b=this[0];if(!b||!b.ownerDocument)return null;if(a)return this.each(function(w){d.offset.setOffset(this,a,w)});if(b===
b.ownerDocument.body)return d.offset.bodyOffset(b);d.offset.initialize();var e=b.offsetParent,g=b,h=b.ownerDocument,k,l=h.documentElement,q=h.body;g=(h=h.defaultView)?h.getComputedStyle(b,null):b.currentStyle;for(var p=b.offsetTop,o=b.offsetLeft;(b=b.parentNode)&&b!==q&&b!==l;){if(d.offset.supportsFixedPosition&&g.position==="fixed")break;k=h?h.getComputedStyle(b,null):b.currentStyle;p-=b.scrollTop;o-=b.scrollLeft;if(b===e){p+=b.offsetTop;o+=b.offsetLeft;if(d.offset.doesNotAddBorder&&!(d.offset.doesAddBorderForTableAndCells&&
