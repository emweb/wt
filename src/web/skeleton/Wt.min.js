...
window.WT_DECLARE_APP_MEMBER=function(M,N,F,K){var P=window.currentApp;if(N==JavaScriptPrototype){M=F.indexOf(".prototype");P[F.substr(0,M)].prototype[F.substr(M+11)]=K}else P[F]=N==JavaScriptFunction?function(){K.apply(P,arguments)}:K};_$_$endif_$_();
