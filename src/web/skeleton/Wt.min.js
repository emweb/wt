...
a){a=s;l(a)}}function p(){var s=window.location.hash,t=null;if(s=="")t=s;else if(s.substr(0,2)=="#/")t=s.substr(2);if(t!==a){a=t;l(a)}}a=j;e=l;window.addEventListener("popstate",g,false);window.addEventListener("hashchange",p,false)},initialize:function(j,l,g){if(g&&g[g.length-1]=="/"){_$_$if_UGLY_INTERNAL_PATHS_$_();b=g+"?_=";_$_$endif_$_();_$_$ifnot_UGLY_INTERNAL_PATHS_$_();b=g.substr(0,g.length-1);_$_$endif_$_()}else b=g?g:window.location.pathname},navigate:function(j,l){a=j;var g=b+j;if(b.length<
...
(u=q)}}}},navigate:function(n,q){if(F){if(v)l(n);else{location.hash=n;if(t){o[history.length]=n;b()}}q&&e()}},getCurrentState:function(){if(!F)return"";return K}}}()});if(window._$_APP_CLASS_$_)try{window._$_APP_CLASS_$_._p_.quit()}catch(e$$24){}
