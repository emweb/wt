...
e}function oa(a){if(T==null)return null;if(!a)a=window.event;if(a){for(var b=a=h.target(a);b&&b!=T;)b=b.parentNode;return b==T?h.isIElt9?a:null:T}else return T}function wa(a){var b=oa(a);if(b&&!W){if(!a)a=window.event;W=true;if(h.isIElt9){h.firedTarget=a.srcElement||b;b.fireEvent("onmousemove",a);h.firedTarget=null}else h.condCall(b,"onmousemove",a);return W=false}else return true}function ja(a){var b=oa(a);h.capture(null);if(b){if(!a)a=window.event;if(h.isIElt9){h.firedTarget=a.srcElement||b;b.fireEvent("onmouseup",
a);h.firedTarget=null}else h.condCall(b,"onmouseup",a);h.cancelEvent(a,h.CancelPropagate);return false}else return true}function pa(a){var b=oa(a);if(b&&!W){if(!a)a=window.event;W=true;if(h.isIElt9){h.firedTarget=a.srcElement||b;b.fireEvent("ontouchmove",a);h.firedTarget=null}else h.condCall(b,"ontouchmove",a);return W=false}else return true}function qa(a){var b=oa(a);h.capture(null);if(b){if(!a)a=window.event;if(h.isIElt9){h.firedTarget=a.srcElement||b;b.fireEvent("ontouchend",a);h.firedTarget=null}else h.condCall(b,
...
pa);a.attachEvent("ontouchend",qa)}}function ya(){if(!ra){ra=true;var a=document.body;xa(a);Ka(a)}}function La(){if(!da){var a,b,e=document.styleSheets;a=0;for(b=e.length;a<b;++a){var g=e[a];if(h.hasTag(e[a].ownerNode,"STYLE")){da=g;break}}if(!da){g=document.createElement("style");document.getElementsByTagName("head")[0].appendChild(g);da=g.sheet}}return da}function Ga(a){return a.replace(/%/g,"%25").replace(/\+/g,"%2b").replace(/ /g,"%20").replace(/&/g,"%26")}var h=this;this.condCall=function(a,
...
new XDomainRequest;if(n){q=false;try{o.open(k,n+"&contentType=x-www-form-urlencoded")}catch(u){o=null}}}else o=null;else n&&o.open(k,n,true)}else if(!g&&window.ActiveXObject){try{o=new ActiveXObject("Msxml2.XMLHTTP")}catch(w){try{o=new ActiveXObject("Microsoft.XMLHTTP")}catch(x){}}n&&o&&o.open(k,n,true)}o&&n&&q&&o.setRequestHeader("Content-type","application/x-www-form-urlencoded");return o}var g=(a.indexOf("://")!=-1||a.indexOf("//")==0)&&P(a)!=window.location.host;return e("POST",a)!=null?new (function(){function k(o,
q,u,w){function x(G){if(!H){clearTimeout(N);if(n){H=true;var ea=t;if(t){t.onreadystatechange=new Function;try{t.onload=t.onreadystatechange}catch(s){}t=null}G?b(0,ea.responseText,q):b(1,null,q)}}}function B(){if(t.readyState==4){var G=t.status==200&&t.getResponseHeader("Content-Type")&&t.getResponseHeader("Content-Type").indexOf("text/javascript")==0;x(G)}}function z(){if(!H)if(n){t.onreadystatechange=new Function;t=null;H=true;b(2,null,q)}}var t=e("POST",n),N=null,H=false;this.abort=function(){if(t!=
null){t.onreadystatechange=new Function;H=true;t.abort();t=null}};_$_CLOSE_CONNECTION_$_&&t.setRequestHeader("Connection","close");if(w>0)N=setTimeout(z,w);t.onreadystatechange=B;try{t.onload=function(){x(true)};t.onerror=function(){x(false)}}catch(M){}t.send(o)}var n=a;this.responseReceived=function(){};this.sendUpdate=function(o,q,u,w){if(!n)return null;return new k(o,q,u,w)};this.cancel=function(){n=null};this.setUrl=function(o){n=o}}):new (function(){function k(q,u,w){function x(){b(1,null,u);
B.parentNode.removeChild(B)}this.userData=u;var B=this.script=document.createElement("script");B.id="script"+w;B.setAttribute("src",n+"&"+q);B.onerror=x;document.getElementsByTagName("head")[0].appendChild(B);this.abort=function(){B.parentNode.removeChild(B)}}var n=a,o=null;this.responseReceived=function(){if(o!=null){var q=o;o.script.parentNode.removeChild(o.script);o=null;b(0,"",q.userData)}};this.sendUpdate=function(q,u,w,x){if(!n)return null;return o=new k(q,u,w,x)};this.cancel=function(){n=null};
this.setUrl=function(q){n=q}})};this.setHtml=function(a,b,e){function g(n,o){var q,u,w;switch(n.nodeType){case 1:q=n.namespaceURI===null?document.createElement(n.nodeName):document.createElementNS(n.namespaceURI,n.nodeName);if(n.attributes&&n.attributes.length>0){u=0;for(w=n.attributes.length;u<w;)q.setAttribute(n.attributes[u].nodeName,n.getAttribute(n.attributes[u++].nodeName))}if(o&&n.childNodes.length>0){u=0;for(w=n.childNodes.length;u<w;){var x=g(n.childNodes[u++],o);x&&q.appendChild(x)}}return q;
case 3:case 4:case 5:return document.createTextNode(n.nodeValue)}return null}if(h.isIE||_$_INNER_HTML_$_&&!e)if(e)a.innerHTML+=b;else{h.saveReparented(a);a.innerHTML=b}else{var k;k=new DOMParser;k=k.parseFromString("<div>"+b+"</div>","application/xhtml+xml").documentElement;if(k.nodeType!=1)k=k.nextSibling;if(!e){h.saveReparented(a);a.innerHTML=""}b=0;for(e=k.childNodes.length;b<e;)a.appendChild(g(k.childNodes[b++],true))}};this.hasTag=function(a,b){return a.nodeType==1&&a.tagName&&a.tagName.toUpperCase()===
...
this.filter=function(a,b,e){a=String.fromCharCode(typeof b.charCode!=="undefined"?b.charCode:b.keyCode);(new RegExp(e)).test(a)||h.cancelEvent(b)};this.widgetPageCoordinates=function(a,b){var e=0,g=0,k;if(!a.parentNode)return{x:0,y:0};if(h.hasTag(a,"AREA"))a=a.parentNode.nextSibling;for(var n=$(document.body).hasClass("Wt-rtl");a&&a!==b;){e+=a.offsetLeft;g+=a.offsetTop;if(h.css(a,"position")=="fixed"){e+=document.body.scrollLeft+document.documentElement.scrollLeft;g+=document.body.scrollTop+document.documentElement.scrollTop;
break}k=a.offsetParent;if(k==null)a=null;else{do{a=a.parentNode;if(h.hasTag(a,"DIV")){if(n&&!h.isGecko){if(a.scrollWidth>a.parentNode.scrollWidth)e-=a.scrollLeft+a.parentNode.scrollWidth-a.scrollWidth}else e-=a.scrollLeft;g-=a.scrollTop}}while(a!=null&&a!=k)}}return{x:e,y:g}};this.widgetCoordinates=function(a,b){b=h.pageCoordinates(b);a=h.widgetPageCoordinates(a);return{x:b.x-a.x,y:b.y-a.y}};this.pageCoordinates=function(a){if(!a)a=window.event;var b=0,e=0,g=a.target||a.srcElement;if(g&&g.ownerDocument!=
document)for(var k=0;k<window.frames.length;k++)if(g.ownerDocument==window.frames[k].document)try{var n=window.frames[k].frameElement.getBoundingClientRect();b=n.left;e=n.top}catch(o){}if(a.touches&&a.touches[0])return h.pageCoordinates(a.touches[0]);else if(!h.isIE&&a.changedTouches&&a.changedTouches[0]){b+=a.changedTouches[0].pageX;e+=a.changedTouches[0].pageY}else if(typeof a.pageX==="number"){b+=a.pageX;e=a.pageY}else if(typeof a.clientX==="number"){b+=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft;
...
b){h.getElement(a).style.display=b};var T=null;this.firedTarget=null;this.target=function(a){try{return h.firedTarget||a.target||a.srcElement}catch(b){return null}};var ra=false;this.capture=function(a){ya();if(!(T&&a)){for(var b=0;b<window.frames.length;b++)try{if(!window.frames[b].document.body.hasMouseHandlers){xa(window.frames[b].document.body);window.frames[b].document.body.hasMouseHandlers=true}}catch(e){}T=a;b=document.body;document.body.addEventListener||(a!=null?b.setCapture():b.releaseCapture());
...
b[k];g.className.indexOf(a)!=-1&&e.push(g)}return e}};var da=null;this.addCss=function(a,b){var e=La();e.insertRule(a+" { "+b+" }",e.cssRules?e.cssRules.length:0)};this.addCssText=function(a){var b=document.getElementById("Wt-inline-css");if(!b){b=document.createElement("style");b.id="Wt-inline-css";document.getElementsByTagName("head")[0].appendChild(b)}if(b.styleSheet){var e=b.previousSibling;if(!e||!h.hasTag(e,"STYLE")||e.styleSheet.cssText.length>32768){e=document.createElement("style");b.parentNode.insertBefore(e,
...
b=document.documentElement.clientHeight}return{x:a,y:b}};this.fitToWindow=function(a,b,e,g,k){var n=["left","right"],o=["top","bottom"];a.style[n[0]]=a.style[n[1]]="auto";a.style[o[0]]=a.style[o[1]]="auto";var q=a.offsetWidth,u=a.offsetHeight,w=h.windowSize(),x=document.body.scrollLeft+document.documentElement.scrollLeft,B=document.body.scrollTop+document.documentElement.scrollTop;if(!$(a).hasClass("Wt-tooltip")){q=h.px(a,"maxWidth")||q;u=h.px(a,"maxHeight")||u}var z=a.offsetParent;if(z){var t=h.widgetPageCoordinates(z);
...
h.px(a,"borderTopWidth");k=0}a.style[n[g]]=b+"px";a.style[o[k]]=e+"px"}};this.positionXY=function(a,b,e){a=h.getElement(a);if(!h.isHidden(a)){a.style.display="block";h.fitToWindow(a,b,e,b,e)}};this.Horizontal=1;this.Vertical=2;this.positionAtWidget=function(a,b,e,g){a=h.getElement(a);var k=h.getElement(b);g||(g=0);if(k&&a){var n=h.widgetPageCoordinates(k),o;a.style.position="absolute";if(h.css(a,"display")=="none")a.style.display="block";if(e===h.Horizontal){e=n.x+k.offsetWidth;b=n.y+g;o=n.x;g=n.y+
k.offsetHeight-g}else{e=n.x;b=n.y+k.offsetHeight;o=n.x+k.offsetWidth;g=n.y}if(!a.wtNoReparent&&!$(a).hasClass("wt-no-reparent")){n=$(".Wt-domRoot").get(0);a.parentNode.removeChild(a);for(k=k.parentNode;k!=n;k=k.parentNode){if(k.wtResize)break;if(h.css(k,"display")!="inline"&&k.clientHeight>100&&(k.scrollHeight>k.clientHeight&&getComputedStyle(k).overflowY!=="visible"||k.scrollWidth>k.clientWidth&&getComputedStyle(k).overflowX!=="visible"))break}n=h.css(k,"position");if(n!="absolute"&&n!="relative")k.style.position=
"relative";k.appendChild(a);$(a).addClass("wt-reparented")}h.fitToWindow(a,e,b,o,g);a.style.visibility=""}};this.hasFocus=function(a){try{return a===document.activeElement}catch(b){return false}};this.progressed=function(a){var b=document,e=b.body,g=this.getElement("Wt-form");a.style.display=g.style.display;g.parentNode.replaceChild(a,g);e.removeEventListener?e.removeEventListener("click",delayClick,true):e.detachEvent("click",delayClick);setTimeout(function(){var k,n;k=0;for(n=delayedClicks.length;k<
n;++k)if(b.createEvent){var o=delayedClicks[k],q=b.createEvent("MouseEvents");q.initMouseEvent("click",o.bubbles,o.cancelable,window,o.detail,o.screenX,o.screenY,o.clientX,o.clientY,o.ctrlKey,o.altKey,o.shiftKey,o.metaKey,o.button,null);(o=h.getElement(o.targetId))&&o.dispatchEvent(q)}else{o=delayedClicks[k];q=b.createEventObject();for(k in o)q[k]=o[k];(o=h.getElement(o.targetId))&&o.fireEvent("onclick",q)}},0)};this.history=window.history&&window.history.pushState?function(){function a(q){n[o.location.pathname+
o.location.search]=q}var b=null,e=null,g=false,k=null,n={},o=window;return{_initialize:function(){},_initTimeout:function(){},register:function(q,u){function w(x){x=x.state;if(x==null)x=n[o.location.pathname+o.location.search];if(x==null){x=o.location.pathname.lastIndexOf(b);if(x!=-1&&x==o.location.pathname.length-b.length){a(b);return}else x=o.location.pathname.substr(e.length)}if(x!=b){b=x;u(b!=""?b:"/")}}b=q;k=u;a(q);o.addEventListener("popstate",w,false)},initialize:function(q,u,w){h.resolveRelativeAnchors();
e=w;if(e.length>=1&&e[e.length-1]=="/"){_$_$if_UGLY_INTERNAL_PATHS_$_();g=true;_$_$endif_$_();_$_$ifnot_UGLY_INTERNAL_PATHS_$_();e=e.substr(0,e.length-1);_$_$endif_$_()}},navigate:function(q,u){h.resolveRelativeAnchors();b=q;var w=Ga(q),x=e;if(w.length!=0)x+=(g?"?_=":"")+w;if(g){function B(t){if(t.length>1)t=t.substr(1);var N=t.split("&"),H,M;t="";H=0;for(M=N.length;H<M;++H)if(N[H].split("=")[0]!="_")t+=(t.length?"&":"?")+N[H];return t}w=B(window.location.search);if(w.length>1){if(w.length>2&&w[0]==
...
d+=I[f].data;var l=f>0?"&e"+f:"&";if(I[f].evAckId<X)d+=l+"evAckId="+I[f].evAckId}Ma=I;I=[];return{feedback:c,result:d}}function ya(d){aa=true;Ia=d;if(Ea){clearInterval(Ea);Ea=null}if(K){clearTimeout(K);K=null}ma.cancel();d=$("#Wt-timers");d.size()>0&&r.setHtml(d.get(0),"",false)}function La(){r.history._initTimeout();Fa==0&&ra(null,"keepAlive",null,false)}function Ga(d){if(!r.isIEMobile)document.title=d}function h(d){if(!Ra){if(d){if(!window._$_APP_CLASS_$_LoadWidgetTree)return;r.history.initialize("Wt-history-field",
"Wt-history-iframe",Sa)}if(!("activeElement"in document)){function c(l){if(l&&l.target)document.activeElement=l.target==document?null:l.target}function f(){document.activeElement=null}document.addEventListener("focus",c,true);document.addEventListener("blur",f,true)}$(document).mousedown(r.mouseDown).mouseup(r.mouseUp);r.history._initialize();S();Ra=true;d&&window._$_APP_CLASS_$_LoadWidgetTree();aa||Ea||(Ea=setInterval(La,_$_KEEP_ALIVE_$_000))}}function za(d){clearTimeout(d);document.body.style.cursor=
"auto";if(ia!=null){try{ia()}catch(c){}ia=null}}function sa(){document.body.style.cursor="wait";ia=hideLoadingIndicator;showLoadingIndicator()}function ka(){var d=Date.now(),c=-1;for(var f in na)if(na.hasOwnProperty(f)){if(d-na[f].time>=_$_INDICATOR_TIMEOUT_$_){ia==null&&sa();return}var l=parseInt(f,10);if(l>c)c=l}Na=c+1;document.body.style.cursor="auto";if(ia!=null){try{ia()}catch(p){}ia=null}}function U(d){Ta=d}function la(){E._p_.autoJavaScript()}function W(d){if(d){d="(function() {"+d+"})();";
window.execScript?window.execScript(d):window.eval(d)}E==window._$_APP_CLASS_$_&&la()}function fa(){y.socket.send("&signal=none&connected="+X);y.state=3}function ga(d,c,f){if(D)D.onStatusChange("connectionStatus",d==0?1:0);if(!aa)if(Ja)setTimeout(function(){ga(d,c,f)},50);else{if(d==0){r.resolveRelativeAnchors();_$_$if_CATCH_ERROR_$_();try{_$_$endif_$_();W(c);_$_$if_CATCH_ERROR_$_()}catch(l){var p=l.description||l.message,m={exception_code:l.code,exception_description:p,exception_js:c};m.stack=l.stack||
l.stacktrace;k(m,"Wt internal error; code: "+l.code+", description: "+p);throw l;}_$_$endif_$_();f&&za(f)}else I=Ma.concat(I);Ma=[];if(K){clearTimeout(K);K=null}F=null;if(d>0)++Fa;else Fa=0;if(!aa){y.state==2&&fa();if(Ta||I.length>0)if(d==1){p=Math.min(12E4,Math.exp(Fa)*500);ba=setTimeout(function(){n()},p)}else ba==null&&n()}}}function Aa(d){ua=d.indexOf("://")!=-1||d[0]=="/"?d:Sa+d;ma&&ma.setUrl(d)}function Ba(){F.abort();K=F=null;aa||n()}function T(d){D=d;D.status={};D.status.connectionStatus=
0;D.status.websocket=false;D.onStatusChange=function(c,f){var l=D.status[c];if(l!=f){D.status[c]=f;D.onChange(c,l,f)}}}function ra(d,c,f,l){if(!Oa){Oa=true;r.checkReleaseCapture(d,f);_$_$if_STRICTLY_SERIALIZED_EVENTS_$_();if(!F){_$_$endif_$_();var p={},m=I.length;p.object=d;p.signal=c;p.event=window.fakeEvent||f;p.feedback=l;p.evAckId=X;I[m]=xa(p,m);a();W();_$_$if_STRICTLY_SERIALIZED_EVENTS_$_()}_$_$endif_$_();Oa=false}}function da(){y.keepAlive&&clearInterval(y.keepAlive);y.keepAlive=setInterval(function(){var d=
y.socket;if(d.readyState==1)d.send("&signal=ping");else{clearInterval(y.keepAlive);y.keepAlive=null}},_$_SERVER_PUSH_TIMEOUT_$_)}function a(){if(aa){if(Ia){if(confirm(Ia))document.location=document.location;Ia=null}}else{_$_$if_WEB_SOCKETS_$_();if(y.state!=4)if(typeof window.WebSocket==="undefined"&&typeof window.MozWebSocket==="undefined")y.state=4;else{var d=y.socket;if(d==null||d.readyState>1)if(d!=null&&y.state==0)y.state=4;else{function c(){if(!aa){++y.reconnectTries;var p=Math.min(12E4,Math.exp(y.reconnectTries)*
...
function(){if(D){D.onStatusChange("websocket",true);D.onStatusChange("connectionStatus",1)}da()}}if(d.readyState==1&&d.state==3){da();n();return}}_$_$endif_$_();if(F!=null&&K!=null){clearTimeout(K);K=null;F.abort();F=null}if(F==null)if(ba==null){ba=setTimeout(function(){n()},r.updateDelay);Ua=(new Date).getTime()}else if(Fa){clearTimeout(ba);ba=null;n()}else if((new Date).getTime()-Ua>r.updateDelay){clearTimeout(ba);ba=null;n()}}}function b(d,c){Pa=c;X=d;ma.responseReceived(d)}function e(){for(var d=
0;d<arguments.length;++d){var c=arguments[d];if(c in na){clearTimeout(na[c].tm);delete na[c]}}ka()}function g(d){Va=d}function k(d,c){F=ma.sendUpdate("request=jserror&err="+encodeURIComponent(JSON.stringify(d)),false,X,-1);_$_$if_SHOW_ERROR_$_();alert(c);_$_$endif_$_()}function n(){function d(){return"_$_PARAMS_$_"}if(E!=window._$_APP_CLASS_$_)ya(null);else if(!F){ba=null;if(!aa){var c,f,l,p=y.socket!==null&&y.socket.readyState===1&&y.state===3;if(I.length>0){c=Ka();f=c.feedback?setTimeout(p?ka:sa,
_$_INDICATOR_TIMEOUT_$_):null;l=false}else{c={result:"&signal=poll"};f=null;l=true}p||(c.result+="&ackId="+X);c.result+="&pageId="+Va;if(Pa){var m="",v=$("#"+Pa).get(0);if(v)for(v=v.parentNode;!r.hasTag(v,"BODY");v=v.parentNode)if(v.id){if(m!="")m+=",";m+=v.id}c.result+="&ackPuzzle="+encodeURIComponent(m)}m=d();if(m.length>0)c.result+="&Wt-params="+encodeURIComponent(m);if(p){F=null;if(!l){if(f){l=Na;na[l]={time:Date.now(),tm:f};++Na;c.result+="&wsRqId="+l}y.socket.send(c.result)}}else{if(F)try{throw new Error("responsePending is true before comm.sendUpdate");
...
function q(d,c){var f={},l=I.length;f.signal="user";f.id=typeof d==="string"?d:d==E?"app":d.id;if(typeof c==="object"){f.name=c.name;f.object=c.eventObject;f.event=c.event}else{f.name=c;f.object=f.event=null}f.args=[];for(var p=2;p<arguments.length;++p){var m=arguments[p];m=m===false?0:m===true?1:m&&m.toDateString?m.toDateString():m;f.args[p-2]=m}f.feedback=true;f.evAckId=X;I[l]=xa(f,l);a()}function u(d,c,f){var l=function(){var m=r.getElement(d);if(m){if(f)m.timer=setTimeout(m.tm,c);else{m.timer=
null;m.tm=null}m.onclick&&m.onclick()}},p=r.getElement(d);p.timer&&clearTimeout(p.timer);p.timer=setTimeout(l,c);p.tm=l}function w(d,c){setTimeout(function(){if(va[d]===true){Ja=false;c()}else va[d]=c},20);Ja=true}function x(d){if(va[d]!==true){if(typeof va[d]!=="undefined"){Ja=false;va[d]()}va[d]=true}}function B(d,c,f){function l(){if(!m&&!v){v=true;var Z=f===undefined?r.isIE?1:2:f;if(Z>1)B(d,c,Z-1);else{Z={"error-description":"Fatal error: failed loading "+d};k(Z,Z["error-description"]);ya(null)}}}
function p(){if(!m&&!v){m=true;x(d)}}var m=false,v=false;if(c!="")try{m=!eval("typeof "+c+" === 'undefined'")}catch(C){m=false}if(m)x(d);else{var V=document.createElement("script");V.setAttribute("src",d);V.onload=p;V.onerror=l;V.onreadystatechange=function(){var Z=V.readyState;if(Z=="loaded")r.isOpera||r.isIE?p():l();else Z=="complete"&&p()};document.getElementsByTagName("head")[0].appendChild(V)}}function z(d,c){this.callback=c;this.work=d.length;this.images=[];if(d.length==0)c(this.images);else for(c=
...
c||window.event)c.returnValue=d;return d}:null}function ea(d){Wa=false;d=d==null?$(".Wt-domRoot").get(0).id:d;for(var c=0;c<Qa.length;++c){var f=Y?Y[d]:null,l=null;if(f)l=f[Qa[c]];f=function(p){return function(m){var v=m||window.event;v=v.target||v.srcElement;if(!v|r.hasTag(v,"DIV")||r.hasTag(v,"BODY")||r.hasTag(v,"HTML"))p&&p(m)}};document["on"+Qa[c]]=l?f(l):null}if(Y)for(c in Y)document.getElementById(c)||delete Y[c]}function s(d,c,f){var l=false;if(!Y){Y={};l=true}Y[c]||(Y[c]={});Y[c][d]=f;l&&
setTimeout(function(){Wa&&ea(null)},0)}function A(){ma.sendUpdate("request=jsupdate&signal=keepAlive&ackId="+X,false,X,-1)}var E=this,r=_$_WT_CLASS_$_,ta=0,O=0,Sa=_$_DEPLOY_PATH_$_,ha=null,Ha={object:null,sourceId:null,mimeType:null,dropOffsetX:null,dragOffsetY:null,dropTarget:null,objectPrevStyle:null,xy:null},Ca,Xa=1E3,Da=[],Ma=[],I=[],ua,aa=false,Ia=_$_QUITTED_STR_$_,Ra=false,F=null,K=null,Ea=null,Fa=0,Ta=false,ba=null,ia=null,Na=0,na={},y={state:0,socket:null,keepAlive:null,reconnectTries:0},
D=null;Aa(_$_SESSION_URL_$_);var ma=r.initAjaxComm(ua,ga),Oa=false,Ua,X=_$_ACK_UPDATE_ID_$_,Pa=null,Va=0,va={},Ja=false;z.prototype.preload=function(d){var c=new Image;this.images.push(c);c.onload=z.prototype.onload;c.onerror=z.prototype.onload;c.onabort=z.prototype.onload;c.imagePreloader=this;c.src=d};z.prototype.onload=function(){var d=this.imagePreloader;--d.work==0&&d.callback(d.images)};z.prototype.cancel=function(){for(var d=this.images,c=0;c<d.length;++c){d[c].onload=function(){};d[c].onerror=
...
0&&this.callback(this.arrayBuffers)};window.onunload=function(){if(!aa){E.emit(E,"Wt-unload");a();n()}};var Wa=true,Y=null,Qa=["keydown","keyup","keypress"];this._p_={ieAlternative:H,loadScript:B,onJsLoad:w,setTitle:Ga,setLocale:M,update:ra,quit:ya,setSessionUrl:Aa,setFormObjects:function(d){Da=d},saveDownPos:P,addTimerEvent:u,load:h,setServerPush:U,touchStart:ca,touchEnded:oa,dragStart:wa,dragDrag:ja,dragEnd:pa,capture:r.capture,enableInternalPaths:N,onHashChange:Q,setHash:J,ImagePreloader:z,ArrayBufferPreloader:t,
