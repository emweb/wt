...
h.offsetHeight-g}else{e=l.x;b=l.y+h.offsetHeight;o=l.x+h.offsetWidth;g=l.y}l=$(".Wt-domRoot").get(0);a.parentNode.removeChild(a);for(h=h.parentNode;h!=l;h=h.parentNode){if(h.wtResize||h.wtReparentBarrier)break;if(k.css(h,"display")!="inline"&&h.clientHeight>100&&(getComputedStyle(h).overflowY==="scroll"||getComputedStyle(h).overflowX==="scroll"||h.scrollHeight>h.clientHeight&&getComputedStyle(h).overflowY==="auto"||h.scrollWidth>h.clientWidth&&getComputedStyle(h).overflowX==="auto"))break}l=k.css(h,
"position");if(l!="absolute"&&l!="relative")h.style.position="relative";h.appendChild(a);$(a).addClass("wt-reparented");k.fitToWindow(a,e,b,o,g);a.style.visibility=""}};this.hasFocus=function(a){try{return a===document.activeElement}catch(b){return false}};this.progressed=function(a){var b=document,e=b.body,g=this.getElement("Wt-form");a.style.display=g.style.display;g.parentNode.replaceChild(a,g);e.removeEventListener?e.removeEventListener("click",delayClick,true):e.detachEvent("click",delayClick);
setTimeout(function(){var h,l;h=0;for(l=delayedClicks.length;h<l;++h)if(b.createEvent){var o=delayedClicks[h],q=b.createEvent("MouseEvents");q.initMouseEvent("click",o.bubbles,o.cancelable,window,o.detail,o.screenX,o.screenY,o.clientX,o.clientY,o.ctrlKey,o.altKey,o.shiftKey,o.metaKey,o.button,null);(o=k.getElement(o.targetId))&&o.dispatchEvent(q)}else{o=delayedClicks[h];q=b.createEventObject();for(h in o)q[h]=o[h];(o=k.getElement(o.targetId))&&o.fireEvent("onclick",q)}},0)};if(window.history&&window.history.pushState){function Sa(a,
