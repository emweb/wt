...
k.offsetHeight-g}else{e=n.x;b=n.y+k.offsetHeight;o=n.x+k.offsetWidth;g=n.y}if(!a.wtNoReparent&&!$(a).hasClass("wt-no-reparent")){n=$(".Wt-domRoot").get(0);a.parentNode.removeChild(a);for(k=k.parentNode;k!=n;k=k.parentNode){if(k.wtResize)break;if(h.css(k,"display")!="inline"&&k.clientHeight>100&&(k.scrollHeight>k.clientHeight||k.scrollWidth>k.clientWidth))break}n=h.css(k,"position");if(n!="absolute"&&n!="relative")k.style.position="relative";k.appendChild(a);$(a).addClass("wt-reparented")}h.fitToWindow(a,
e,b,o,g);a.style.visibility=""}};this.hasFocus=function(a){try{return a===document.activeElement}catch(b){return false}};this.progressed=function(a){var b=document,e=b.body,g=this.getElement("Wt-form");a.style.display=g.style.display;g.parentNode.replaceChild(a,g);e.removeEventListener?e.removeEventListener("click",delayClick,true):e.detachEvent("click",delayClick);setTimeout(function(){var k,n;k=0;for(n=delayedClicks.length;k<n;++k)if(b.createEvent){var o=delayedClicks[k],q=b.createEvent("MouseEvents");
q.initMouseEvent("click",o.bubbles,o.cancelable,window,o.detail,o.screenX,o.screenY,o.clientX,o.clientY,o.ctrlKey,o.altKey,o.shiftKey,o.metaKey,o.button,null);(o=h.getElement(o.targetId))&&o.dispatchEvent(q)}else{o=delayedClicks[k];q=b.createEventObject();for(k in o)q[k]=o[k];(o=h.getElement(o.targetId))&&o.fireEvent("onclick",q)}},0)};this.history=window.history&&window.history.pushState?function(){function a(q){n[o.location.pathname+o.location.search]=q}var b=null,e=null,g=false,k=null,n={},o=window;
return{_initialize:function(){},_initTimeout:function(){},register:function(q,u){function w(x){x=x.state;if(x==null)x=n[o.location.pathname+o.location.search];if(x==null){x=o.location.pathname.lastIndexOf(b);if(x!=-1&&x==o.location.pathname.length-b.length){a(b);return}else x=o.location.pathname.substr(e.length)}if(x!=b){b=x;u(b!=""?b:"/")}}b=q;k=u;a(q);o.addEventListener("popstate",w,false)},initialize:function(q,u,w){h.resolveRelativeAnchors();e=w;if(e.length>=1&&e[e.length-1]=="/"){_$_$if_UGLY_INTERNAL_PATHS_$_();
g=true;_$_$endif_$_();_$_$ifnot_UGLY_INTERNAL_PATHS_$_();e=e.substr(0,e.length-1);_$_$endif_$_()}},navigate:function(q,u){h.resolveRelativeAnchors();b=q;var w=Ga(q),x=e;if(w.length!=0)x+=(g?"?_=":"")+w;if(g){function B(t){if(t.length>1)t=t.substr(1);var N=t.split("&"),H,M;t="";H=0;for(M=N.length;H<M;++H)if(N[H].split("=")[0]!="_")t+=(t.length?"&":"?")+N[H];return t}w=B(window.location.search);if(w.length>1){if(w.length>2&&w[0]=="?"&&w[1]=="&")w=w.substr(1);x+=x.indexOf("?")==-1?"?"+w.substr(1):"&"+
...
k&&b(g)},getCurrentState:function(){return a}}}():function(){function a(){var s,A;A=location.href;s=A.indexOf("#");return s>=0?A.substr(s+1):null}function b(){z.value=M+"|"+G}function e(){var s,A;s=0;for(A=ea.length;s<A;++s)ea[s](unescape(G))}function g(s){if(s){if(!s||G!==s){G=s||M;e()}}else{G=M;e()}}function k(s){var A;s='<html><body><div id="state">'+s+"</div></body></html>";try{A=B.contentWindow.document;A.open();A.write(s);A.close();return true}catch(E){return false}}function n(){var s,A,E,r;
...
r;E=a();r=history.length;if(E!==s){s=E;A=r;g(s);b()}},50)}}function q(){var s;s=z.value.split("|");if(s.length>1){M=s[0];G=s[1]}else M=G="";if(s.length>2)H=s[2].split(",");if(u)n();else{o();t=true;x!=null&&x()}}var u=h.isIElt9,w=false,x=null,B=null,z=null,t=false,N=null,H=[],M,G,ea=[];return{_initialize:function(){z!=null&&q()},_initTimeout:function(){o()},register:function(s,A){if(!t)G=M=escape(s);ea.push(A)},initialize:function(s,A){if(!t){if((navigator.vendor||"")!=="KDE")if(typeof window.opera!==
