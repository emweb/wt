...
window.WT_DECLARE_APP_MEMBER=function(P,Q,I,S){var aa=window.currentApp;if(Q==JavaScriptPrototype){P=I.indexOf(".prototype");aa[I.substr(0,P)].prototype[I.substr(P+11)]=S}else aa[I]=Q==JavaScriptFunction?function(){return S.apply(aa,arguments)}:S};_$_$endif_$_();
if(!window._$_WT_CLASS_$_)window._$_WT_CLASS_$_=new (function(){function P(a){return a.split("/")[2]}function Q(a){return 55296<=a&&a<=56319}function I(a){return 56320<=a&&a<=57343}function S(a,b){var e,g=a.start,k=a.end;for(e=0;e<b.length;++e){if(e>=a.start&&e>=a.end)return{start:g,end:k};if(Q(b.charCodeAt(e))&&e+1<b.length&&I(b.charCodeAt(e+1))){e<a.start&&--g;e<a.end&&--k}}return{start:g,end:k}}function aa(a,b,e){if(a=="auto"||a==null)return e;return(a=(a=b.exec(a))&&a.length==2?a[1]:null)?parseFloat(a):
e}function oa(a){if(T==null)return null;if(!a)a=window.event;if(a){for(var b=a=h.target(a);b&&b!=T;)b=b.parentNode;return b==T?h.isIElt9?a:null:T}else return T}function wa(a){var b=oa(a);if(b&&!V){if(!a)a=window.event;V=true;if(h.isIElt9){h.firedTarget=a.srcElement||b;b.fireEvent("onmousemove",a);h.firedTarget=null}else h.condCall(b,"onmousemove",a);return V=false}else return true}function ia(a){var b=oa(a);h.capture(null);if(b){if(!a)a=window.event;if(h.isIElt9){h.firedTarget=a.srcElement||b;b.fireEvent("onmouseup",
...
"ontouchend",a);h.cancelEvent(a,h.CancelPropagate);return false}else return true}function xa(a){if(a.addEventListener){a.addEventListener("mousemove",wa,true);a.addEventListener("mouseup",ia,true);h.isGecko&&window.addEventListener("mouseout",function(b){!b.relatedTarget&&h.hasTag(b.target,"HTML")&&ia(b)},true)}else{a.attachEvent("onmousemove",wa);a.attachEvent("onmouseup",ia)}}function Ka(a){if(a.addEventListener){a.addEventListener("touchmove",pa,true);a.addEventListener("touchend",qa,true)}else{a.attachEvent("ontouchmove",
pa);a.attachEvent("ontouchend",qa)}}function ya(){if(!ra){ra=true;var a=document.body;xa(a);Ka(a)}}function La(){if(!ba){var a,b,e=document.styleSheets;a=0;for(b=e.length;a<b;++a){var g=e[a];if(h.hasTag(e[a].ownerNode,"STYLE")){ba=g;break}}if(!ba){g=document.createElement("style");document.getElementsByTagName("head")[0].appendChild(g);ba=g.sheet}}return ba}function Ga(a){return a.replace(/%/g,"%25").replace(/\+/g,"%2b").replace(/ /g,"%20").replace(/&/g,"%26")}var h=this;this.condCall=function(a,
...
2};this.drag=function(){++sa};this.arrayRemove=function(a,b,e){e=a.slice((e||b)+1||a.length);a.length=b<0?a.length+b:b;return a.push.apply(a,e)};this.addAll=function(a,b){for(var e=0,g=b.length;e<g;++e)a.push(b[e])};var ja=function(){for(var a,b=3,e=document.createElement("div"),g=e.getElementsByTagName("i");e.innerHTML="<!--[if gt IE "+ ++b+"]><i></i><![endif]--\>",g[0];);return b>4?b:a}(),ca=navigator.userAgent.toLowerCase();this.isIE=ja!==undefined;this.isIE6=ja===6;this.isIE8=ja===8;this.isIElt9=
ja<9;this.isIEMobile=ca.indexOf("msie 4")!=-1||ca.indexOf("msie 5")!=-1;this.isOpera=typeof window.opera!=="undefined";this.isAndroid=ca.indexOf("safari")!=-1&&ca.indexOf("android")!=-1;this.isWebKit=ca.indexOf("applewebkit")!=-1;this.isGecko=ca.indexOf("gecko")!=-1&&!this.isWebKit;this.updateDelay=this.isIE?10:51;if(this.isAndroid){console.error("init console.error");console.info("init console.info");console.log("init console.log");console.warn("init console.warn")}var ka=new Date;this.trace=function(a,
b){if(b)ka=new Date;b=new Date;b=(b.getMinutes()-ka.getMinutes())*6E4+(b.getSeconds()-ka.getSeconds())*1E3+(b.getMilliseconds()-ka.getMilliseconds());window.console&&console.log("["+b+"]: "+a)};this.initAjaxComm=function(a,b){function e(k,n){var o=null,q=true;if(window.XMLHttpRequest){o=new XMLHttpRequest;if(g)if("withCredentials"in o){if(n){o.open(k,n,true);o.withCredentials="true"}}else if(typeof XDomainRequest!="undefined"){o=new XDomainRequest;if(n){q=false;try{o.open(k,n+"&contentType=x-www-form-urlencoded")}catch(u){o=
null}}}else o=null;else n&&o.open(k,n,true)}else if(!g&&window.ActiveXObject){try{o=new ActiveXObject("Msxml2.XMLHTTP")}catch(w){try{o=new ActiveXObject("Microsoft.XMLHTTP")}catch(x){}}n&&o&&o.open(k,n,true)}o&&n&&q&&o.setRequestHeader("Content-type","application/x-www-form-urlencoded");return o}var g=(a.indexOf("://")!=-1||a.indexOf("//")==0)&&P(a)!=window.location.host;return e("POST",a)!=null?new (function(){function k(o,q,u,w){function x(G){if(!H){clearTimeout(N);if(n){H=true;var da=t;if(t){t.onreadystatechange=
new Function;try{t.onload=t.onreadystatechange}catch(s){}t=null}G?b(0,da.responseText,q):b(1,null,q)}}}function B(){if(t.readyState==4){var G=t.status==200&&t.getResponseHeader("Content-Type")&&t.getResponseHeader("Content-Type").indexOf("text/javascript")==0;x(G)}}function z(){if(!H)if(n){t.onreadystatechange=new Function;t=null;H=true;b(2,null,q)}}var t=e("POST",n),N=null,H=false;this.abort=function(){if(t!=null){t.onreadystatechange=new Function;H=true;t.abort();t=null}};_$_CLOSE_CONNECTION_$_&&
t.setRequestHeader("Connection","close");if(w>0)N=setTimeout(z,w);t.onreadystatechange=B;try{t.onload=function(){x(true)};t.onerror=function(){x(false)}}catch(K){}t.send(o)}var n=a;this.responseReceived=function(){};this.sendUpdate=function(o,q,u,w){if(!n)return null;return new k(o,q,u,w)};this.cancel=function(){n=null};this.setUrl=function(o){n=o}}):new (function(){function k(q,u,w){function x(){b(1,null,u);B.parentNode.removeChild(B)}this.userData=u;var B=this.script=document.createElement("script");
...
a.createTextRange();a.collapse(true);a.moveStart("character",b);a.moveEnd("character",e-b);a.select()}};this.isKeyPress=function(a){if(!a)a=window.event;if(a.altKey||a.ctrlKey||a.metaKey)return false;return(typeof a.charCode!=="undefined"?a.charCode:0)>0||h.isIE?true:h.isOpera?a.keyCode==13||a.keyCode==27||a.keyCode>=32&&a.keyCode<125:a.keyCode==13||a.keyCode==27||a.keyCode==32||a.keyCode>46&&a.keyCode<112};var ea=null,fa=null;this.isDblClick=function(a,b){if(a.wtClickTimeout&&Math.abs(a.wtE1.clientX-
b.clientX)<3&&Math.abs(a.wtE1.clientY-b.clientY)<3){clearTimeout(a.wtClickTimeout);a.wtClickTimeout=null;a.wtE1=null;return true}else return false};this.eventRepeat=function(a,b,e){h.stopRepeat();b=b||500;e=e||50;a();ea=setTimeout(function(){ea=null;a();fa=setInterval(a,e)},b)};this.stopRepeat=function(){if(ea){clearTimeout(ea);ea=null}if(fa){clearInterval(fa);fa=null}};var Aa=null,Ba=null;this.css=function(a,b){if(a.style[b])return a.style[b];else{if(a!==Aa){Aa=a;Ba=window.getComputedStyle?window.getComputedStyle(a,
null):a.currentStyle?a.currentStyle:null}return Ba?Ba[b]:null}};this.parsePx=function(a){return aa(a,/^\s*(-?\d+(?:\.\d+)?)\s*px\s*$/i,0)};this.parsePct=function(a,b){return aa(a,/^\s*(-?\d+(?:\.\d+)?)\s*\%\s*$/i,b)};this.px=function(a,b){return h.parsePx(h.css(a,b))};this.pxself=function(a,b){return h.parsePx(a.style[b])};this.pctself=function(a,b){return h.parsePct(a.style[b],0)};this.styleAttribute=function(a){function b(q){for(var u=q.search(/-./);u!=-1;){u=q.charAt(u+1).toUpperCase();q=q.replace(/-./,
...
getCurrentState:function(){return a}}}():function(){function a(){var s,A;A=location.href;s=A.indexOf("#");return s>=0?A.substr(s+1):null}function b(){z.value=K+"|"+G}function e(){var s,A;s=0;for(A=da.length;s<A;++s)da[s](unescape(G))}function g(s){if(s){if(!s||G!==s){G=s||K;e()}}else{G=K;e()}}function k(s){var A;s='<html><body><div id="state">'+s+"</div></body></html>";try{A=B.contentWindow.document;A.open();A.write(s);A.close();return true}catch(E){return false}}function n(){var s,A,E,r;if(!B.contentWindow||
!B.contentWindow.document)setTimeout(n,10);else{s=B.contentWindow.document;E=(A=s.getElementById("state"))?A.innerText:null;r=a();setInterval(function(){var ta,O;s=B.contentWindow.document;ta=(A=s.getElementById("state"))?A.innerText:null;O=a();if(ta!==E){E=ta;g(E);O=E?E:K;if(location.hash!=O&&location.hash.substring(1)!=O)location.hash=O;r=O;b()}else if(O!==r){r=O;k(O)}},50);t=true;x!=null&&x()}}function o(){if(!u){var s=a(),A=history.length;N&&clearInterval(N);N=setInterval(function(){var E,r;E=
a();r=history.length;if(E!==s){s=E;A=r;g(s);b()}},50)}}function q(){var s;s=z.value.split("|");if(s.length>1){K=s[0];G=s[1]}else K=G="";if(s.length>2)H=s[2].split(",");if(u)n();else{o();t=true;x!=null&&x()}}var u=h.isIElt9,w=false,x=null,B=null,z=null,t=false,N=null,H=[],K,G,da=[];return{_initialize:function(){z!=null&&q()},_initTimeout:function(){o()},register:function(s,A){if(!t)G=K=escape(s);da.push(A)},initialize:function(s,A){if(!t){if((navigator.vendor||"")!=="KDE")if(typeof window.opera!==
...
window._$_APP_CLASS_$_=new (function(){function P(d){d=r.pageCoordinates(d);ta=d.x;O=d.y}function Q(){var d=_$_WT_CLASS_$_.history.getCurrentState();if(!(d!=null&&d.length>0&&d.substr(0,1)!="/"))if(ga!=d){ga=d;setTimeout(function(){ra(null,"hash",null,true)},1)}}function I(d,c){if(!(ga==d||!ga&&d=="/")){c||(ga=d);r.history.navigate(d,c)}}function S(){document.body.ondragstart=function(){return false}}function aa(d,c){Ca=setTimeout(function(){wa(d,c)},Xa)}function oa(){Ca&&clearTimeout(Ca)}function wa(d,
...
f.object.onmousemove=ia;f.object.onmouseup=pa;f.object.ontouchmove=ia;f.object.ontouchend=pa;f.offsetX=-4;f.offsetY=-4;f.dropTarget=null;f.mimeType=d.getAttribute("dmt");f.xy=r.pageCoordinates(c);r.cancelEvent(c,r.CancelPropagate);return false}function ia(d){d=d||window.event;if(Ha.object!==null){var c=Ha,f=r.pageCoordinates(d);if(c.object.style.display!==""&&c.xy.x!==f.x&&c.xy.y!==f.y)c.object.style.display="";c.object.style.left=f.x-c.offsetX+"px";c.object.style.top=f.y-c.offsetY+"px";f=c.dropTarget;
...
if(typeof l.touches!=="undefined")f+=qa(c+"touches",l.touches,C);if(typeof l.targetTouches!=="undefined")f+=qa(c+"ttouches",l.targetTouches,C);if(typeof l.changedTouches!=="undefined")f+=qa(c+"ctouches",l.changedTouches,C);if(typeof l.scale!=="undefined"&&typeof l.scale!=="unknown"&&l.scale)f+=c+"scale="+l.scale;if(typeof l.rotation!=="undefined"&&typeof l.rotation!=="unknown"&&l.rotation)f+=c+"rotation="+l.rotation;d.data=f;return d}function Ka(){for(var d="",c=false,f=0;f<M.length;++f){c=c||M[f].feedback;
d+=M[f].data}Ma=M;M=[];return{feedback:c,result:d}}function ya(d){Y=true;Ia=d;if(Ea){clearInterval(Ea);Ea=null}if(J){clearTimeout(J);J=null}la.cancel();d=$("#Wt-timers");d.size()>0&&r.setHtml(d.get(0),"",false)}function La(){r.history._initTimeout();Fa==0&&ra(null,"keepAlive",null,false)}function Ga(d){if(!r.isIEMobile)document.title=d}function h(d){if(!Ra){if(d){if(!window._$_APP_CLASS_$_LoadWidgetTree)return;r.history.initialize("Wt-history-field","Wt-history-iframe",Sa)}if(!("activeElement"in document)){function c(l){if(l&&
l.target)document.activeElement=l.target==document?null:l.target}function f(){document.activeElement=null}document.addEventListener("focus",c,true);document.addEventListener("blur",f,true)}$(document).mousedown(r.mouseDown).mouseup(r.mouseUp);r.history._initialize();S();Ra=true;d&&window._$_APP_CLASS_$_LoadWidgetTree();Y||Ea||(Ea=setInterval(La,_$_KEEP_ALIVE_$_000))}}function za(d){clearTimeout(d);document.body.style.cursor="auto";if(ha!=null){try{ha()}catch(c){}ha=null}}function sa(){document.body.style.cursor=
"wait";ha=hideLoadingIndicator;showLoadingIndicator()}function ja(){var d=Date.now(),c=-1;for(var f in ma)if(ma.hasOwnProperty(f)){if(d-ma[f].time>=_$_INDICATOR_TIMEOUT_$_){ha==null&&sa();return}var l=parseInt(f,10);if(l>c)c=l}Na=c+1;document.body.style.cursor="auto";if(ha!=null){try{ha()}catch(p){}ha=null}}function ca(d){Ta=d}function ka(){E._p_.autoJavaScript()}function V(d){if(d){d="(function() {"+d+"})();";window.execScript?window.execScript(d):window.eval(d)}E==window._$_APP_CLASS_$_&&ka()}function ea(){y.socket.send("&signal=none&connected="+
na);y.state=3}function fa(d,c,f){if(D)D.onStatusChange("connectionStatus",d==0?1:0);if(!Y)if(Ja)setTimeout(function(){fa(d,c,f)},50);else{if(d==0){r.resolveRelativeAnchors();_$_$if_CATCH_ERROR_$_();try{_$_$endif_$_();V(c);_$_$if_CATCH_ERROR_$_()}catch(l){var p=l.description||l.message,m={exception_code:l.code,exception_description:p,exception_js:c};m.stack=l.stack||l.stacktrace;k(m,"Wt internal error; code: "+l.code+", description: "+p);throw l;}_$_$endif_$_();f&&za(f)}else M=Ma.concat(M);Ma=[];if(J){clearTimeout(J);
J=null}F=null;if(d>0)++Fa;else Fa=0;if(!Y){y.state==2&&ea();if(Ta||M.length>0)if(d==1){p=Math.min(12E4,Math.exp(Fa)*500);Z=setTimeout(function(){n()},p)}else Z==null&&n()}}}function Aa(d){ua=d.indexOf("://")!=-1||d[0]=="/"?d:Sa+d;la&&la.setUrl(d)}function Ba(){F.abort();J=F=null;Y||n()}function T(d){D=d;D.status={};D.status.connectionStatus=0;D.status.websocket=false;D.onStatusChange=function(c,f){var l=D.status[c];if(l!=f){D.status[c]=f;D.onChange(c,l,f)}}}function ra(d,c,f,l){if(!Oa){Oa=true;r.checkReleaseCapture(d,
f);_$_$if_STRICTLY_SERIALIZED_EVENTS_$_();if(!F){_$_$endif_$_();var p={},m=M.length;p.object=d;p.signal=c;p.event=window.fakeEvent||f;p.feedback=l;M[m]=xa(p,m);a();V();_$_$if_STRICTLY_SERIALIZED_EVENTS_$_()}_$_$endif_$_();Oa=false}}function ba(){y.keepAlive&&clearInterval(y.keepAlive);y.keepAlive=setInterval(function(){var d=y.socket;if(d.readyState==1)d.send("&signal=ping");else{clearInterval(y.keepAlive);y.keepAlive=null}},_$_SERVER_PUSH_TIMEOUT_$_)}function a(){if(Y){if(Ia){if(confirm(Ia))document.location=
document.location;Ia=null}}else{_$_$if_WEB_SOCKETS_$_();if(y.state!=4)if(typeof window.WebSocket==="undefined"&&typeof window.MozWebSocket==="undefined")y.state=4;else{var d=y.socket;if(d==null||d.readyState>1)if(d!=null&&y.state==0)y.state=4;else{function c(){if(!Y){++y.reconnectTries;var p=Math.min(12E4,Math.exp(y.reconnectTries)*500);setTimeout(function(){a()},p)}}var f;if(ua.indexOf("://")!=-1)f="ws"+ua.substr(4);else{f=ua.substr(ua.indexOf("?"));f="ws"+location.protocol.substr(4)+"//"+location.host+
_$_WS_PATH_$_+f}f+="&request=ws";var l=_$_WS_ID_$_;if(l.length>0)f+="&wsid="+l;y.socket=typeof window.WebSocket!=="undefined"?(d=new WebSocket(f)):(d=new MozWebSocket(f));y.state=1;y.keepAlive&&clearInterval(y.keepAlive);y.keepAlive=null;d.onmessage=function(p){var m=null;if(y.state==1)if(p.data=="connect"){if(F!=null&&J!=null){clearTimeout(J);J=null;F.abort();F=null}if(F)y.state=2;else ea()}else{console.log("WebSocket: was expecting a connect?");console.log(p.data);return}else{if(D){D.onStatusChange("websocket",
true);D.onStatusChange("connectionStatus",1)}y.state=3;m=p.data}y.reconnectTries=0;m!=null&&fa(0,m,null)};d.onerror=function(){D&&D.onStatusChange("websocket",false);if(y.reconnectTries==3&&y.state==0)y.state=4;c()};d.onclose=function(){D&&D.onStatusChange("websocket",false);if(y.reconnectTries==3&&y.state==0)y.state=4;c()};d.onopen=function(){if(D){D.onStatusChange("websocket",true);D.onStatusChange("connectionStatus",1)}ba()}}if(d.readyState==1&&d.state==3){ba();n();return}}_$_$endif_$_();if(F!=
null&&J!=null){clearTimeout(J);J=null;F.abort();F=null}if(F==null)if(Z==null){Z=setTimeout(function(){n()},r.updateDelay);Ua=(new Date).getTime()}else if(Fa){clearTimeout(Z);Z=null;n()}else if((new Date).getTime()-Ua>r.updateDelay){clearTimeout(Z);Z=null;n()}}}function b(d,c){Pa=c;na=d;la.responseReceived(d)}function e(){for(var d=0;d<arguments.length;++d){var c=arguments[d];if(c in ma){clearTimeout(ma[c].tm);delete ma[c]}}ja()}function g(d){Va=d}function k(d,c){F=la.sendUpdate("request=jserror&err="+
encodeURIComponent(JSON.stringify(d)),false,na,-1);_$_$if_SHOW_ERROR_$_();alert(c);_$_$endif_$_()}function n(){function d(){return"_$_PARAMS_$_"}if(E!=window._$_APP_CLASS_$_)ya(null);else if(!F){Z=null;if(!Y){var c,f,l,p=y.socket!==null&&y.socket.readyState===1&&y.state===3;if(M.length>0){c=Ka();f=c.feedback?setTimeout(p?ja:sa,_$_INDICATOR_TIMEOUT_$_):null;l=false}else{c={result:"&signal=poll"};f=null;l=true}p||(c.result+="&ackId="+na);c.result+="&pageId="+Va;if(Pa){var m="",v=$("#"+Pa).get(0);if(v)for(v=
v.parentNode;!r.hasTag(v,"BODY");v=v.parentNode)if(v.id){if(m!="")m+=",";m+=v.id}c.result+="&ackPuzzle="+encodeURIComponent(m)}m=d();if(m.length>0)c.result+="&Wt-params="+encodeURIComponent(m);if(p){F=null;if(!l){if(f){l=Na;ma[l]={time:Date.now(),tm:f};++Na;c.result+="&wsRqId="+l}y.socket.send(c.result)}}else{if(F)try{throw new Error("responsePending is true before comm.sendUpdate");}catch(C){c=C.description||C.message;f={exception_description:c};f.stack=C.stack||C.stacktrace;k(f,"Wt internal error; description: "+
c);throw C;}J=l?setTimeout(Ba,_$_SERVER_PUSH_TIMEOUT_$_):null;F=1;F=la.sendUpdate("request=jsupdate"+c.result,f,na,-1)}}}}function o(d,c,f){if(c==-1)c=d.offsetWidth;if(f==-1)f=d.offsetHeight;if(typeof d.wtWidth==="undefined"||d.wtWidth!=c||typeof d.wtHeight==="undefined"||d.wtHeight!=f){d.wtWidth=c;d.wtHeight=f;c>=0&&f>=0&&q(d,"resized",Math.round(c),Math.round(f))}}function q(d,c){var f={},l=M.length;f.signal="user";f.id=typeof d==="string"?d:d==E?"app":d.id;if(typeof c==="object"){f.name=c.name;
f.object=c.eventObject;f.event=c.event}else{f.name=c;f.object=f.event=null}f.args=[];for(var p=2;p<arguments.length;++p){var m=arguments[p];m=m===false?0:m===true?1:m&&m.toDateString?m.toDateString():m;f.args[p-2]=m}f.feedback=true;M[l]=xa(f,l);a()}function u(d,c,f){var l=function(){var m=r.getElement(d);if(m){if(f)m.timer=setTimeout(m.tm,c);else{m.timer=null;m.tm=null}m.onclick&&m.onclick()}},p=r.getElement(d);p.timer&&clearTimeout(p.timer);p.timer=setTimeout(l,c);p.tm=l}function w(d,c){setTimeout(function(){if(va[d]===
true){Ja=false;c()}else va[d]=c},20);Ja=true}function x(d){if(va[d]!==true){if(typeof va[d]!=="undefined"){Ja=false;va[d]()}va[d]=true}}function B(d,c,f){function l(){if(!m&&!v){v=true;var X=f===undefined?r.isIE?1:2:f;if(X>1)B(d,c,X-1);else{X={"error-description":"Fatal error: failed loading "+d};k(X,X["error-description"]);ya(null)}}}function p(){if(!m&&!v){m=true;x(d)}}var m=false,v=false;if(c!="")try{m=!eval("typeof "+c+" === 'undefined'")}catch(C){m=false}if(m)x(d);else{var U=document.createElement("script");
U.setAttribute("src",d);U.onload=p;U.onerror=l;U.onreadystatechange=function(){var X=U.readyState;if(X=="loaded")r.isOpera||r.isIE?p():l();else X=="complete"&&p()};document.getElementsByTagName("head")[0].appendChild(U)}}function z(d,c){this.callback=c;this.work=d.length;this.images=[];if(d.length==0)c(this.images);else for(c=0;c<d.length;c++)this.preload(d[c])}function t(d,c){this.callback=c;this.work=d.length;this.arrayBuffers=[];if(d.length==0)c(this.arrayBuffers);else for(c=0;c<d.length;c++)this.preload(d[c],
c)}function N(d){ga=d;r.history.register(d,Q)}function H(d){if(d.ieAlternativeExecuted)return"0";E.emit(d.parentNode,"IeAlternative");d.style.width="";d.ieAlternativeExecuted=true;return"0"}function K(d){if(!(r.isIEMobile||d==""))document.documentElement.lang=d}function G(d){window.onbeforeunload=d&&d!=""?function(c){if(c=c||window.event)c.returnValue=d;return d}:null}function da(d){Wa=false;d=d==null?$(".Wt-domRoot").get(0).id:d;for(var c=0;c<Qa.length;++c){var f=W?W[d]:null,l=null;if(f)l=f[Qa[c]];
f=function(p){return function(m){var v=m||window.event;v=v.target||v.srcElement;if(!v|r.hasTag(v,"DIV")||r.hasTag(v,"BODY")||r.hasTag(v,"HTML"))p&&p(m)}};document["on"+Qa[c]]=l?f(l):null}if(W)for(c in W)document.getElementById(c)||delete W[c]}function s(d,c,f){var l=false;if(!W){W={};l=true}W[c]||(W[c]={});W[c][d]=f;l&&setTimeout(function(){Wa&&da(null)},0)}function A(){la.sendUpdate("request=jsupdate&signal=keepAlive&ackId="+na,false,na,-1)}var E=this,r=_$_WT_CLASS_$_,ta=0,O=0,Sa=_$_DEPLOY_PATH_$_,
ga=null,Ha={object:null,sourceId:null,mimeType:null,dropOffsetX:null,dragOffsetY:null,dropTarget:null,objectPrevStyle:null,xy:null},Ca,Xa=1E3,Da=[],Ma=[],M=[],ua,Y=false,Ia=_$_QUITTED_STR_$_,Ra=false,F=null,J=null,Ea=null,Fa=0,Ta=false,Z=null,ha=null,Na=0,ma={},y={state:0,socket:null,keepAlive:null,reconnectTries:0},D=null;Aa(_$_SESSION_URL_$_);var la=r.initAjaxComm(ua,fa),Oa=false,Ua,na=_$_ACK_UPDATE_ID_$_,Pa=null,Va=0,va={},Ja=false;z.prototype.preload=function(d){var c=new Image;this.images.push(c);
c.onload=z.prototype.onload;c.onerror=z.prototype.onload;c.onabort=z.prototype.onload;c.imagePreloader=this;c.src=d};z.prototype.onload=function(){var d=this.imagePreloader;--d.work==0&&d.callback(d.images)};z.prototype.cancel=function(){for(var d=this.images,c=0;c<d.length;++c){d[c].onload=function(){};d[c].onerror=function(){};d[c].onabort=function(){}}this.callback=function(){}};t.prototype.preload=function(d,c){var f=new XMLHttpRequest;f.open("GET",d,true);f.responseType="arraybuffer";f.arrayBuffers=
this.arrayBuffers;f.preloader=this;f.index=c;f.uri=d;f.onload=function(){console.log("XHR load buffer "+this.index+" from uri "+this.uri);this.arrayBuffers[this.index]=this.response;this.preloader.afterLoad()};f.onerror=t.prototype.afterload;f.onabort=t.prototype.afterload;f.send()};t.prototype.afterLoad=function(){--this.work==0&&this.callback(this.arrayBuffers)};window.onunload=function(){if(!Y){E.emit(E,"Wt-unload");a();n()}};var Wa=true,W=null,Qa=["keydown","keyup","keypress"];this._p_={ieAlternative:H,
loadScript:B,onJsLoad:w,setTitle:Ga,setLocale:K,update:ra,quit:ya,setSessionUrl:Aa,setFormObjects:function(d){Da=d},saveDownPos:P,addTimerEvent:u,load:h,setServerPush:ca,touchStart:aa,touchEnded:oa,dragStart:wa,dragDrag:ia,dragEnd:pa,capture:r.capture,enableInternalPaths:N,onHashChange:Q,setHash:I,ImagePreloader:z,ArrayBufferPreloader:t,doAutoJavaScript:ka,autoJavaScript:function(){},response:b,wsRqsDone:e,setPage:g,setCloseMessage:G,setConnectionMonitor:T,updateGlobal:da,bindGlobal:s,refreshCookie:A,
propagateSize:o};this.WT=_$_WT_CLASS_$_;this.emit=q});window._$_APP_CLASS_$_SignalEmit=_$_APP_CLASS_$_.emit;window._$_APP_CLASS_$_OnLoad=function(){_$_APP_CLASS_$_._p_.load()};
