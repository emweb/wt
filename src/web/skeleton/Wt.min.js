...
C=true;u.abort();u=null};_$_CLOSE_CONNECTION_$_&&u.setRequestHeader("Connection","close");if(q>0)D=setTimeout(B,q);u.onreadystatechange=w;try{u.onload=function(){A(true)};u.onerror=function(){A(false)}}catch(p){}u.send(o)}var l=a;this.responseReceived=function(){};this.sendUpdate=function(o,s,t,q){return new k(o,s,t,q)};this.setUrl=function(o){l=o}}):new (function(){function k(s,t,q){function A(){b(1,null,t);w.parentNode.removeChild(w)}this.userData=t;var w=this.script=document.createElement("script");
...
document.createElementNS(l.namespaceURI,l.nodeName);if(l.attributes&&l.attributes.length>0){t=0;for(q=l.attributes.length;t<q;)s.setAttribute(l.attributes[t].nodeName,l.getAttribute(l.attributes[t++].nodeName))}if(o&&l.childNodes.length>0){t=0;for(q=l.childNodes.length;t<q;){var A=i(l.childNodes[t++],o);A&&s.appendChild(A)}}return s;case 3:case 4:case 5:return document.createTextNode(l.nodeValue)}return null}if(g.isIE||_$_INNER_HTML_$_&&!e)if(e)a.innerHTML+=b;else a.innerHTML=b;else{var k;k=new DOMParser;
...
function D(c){window.onbeforeunload=c&&c!=""?function(d){if(d=d||window.event)d.returnValue=c;return c}:null}var C=this,p=_$_WT_CLASS_$_,G=0,H=0,V=_$_DEPLOY_PATH_$_,m=null,r={object:null,sourceId:null,mimeType:null,dropOffsetX:null,dragOffsetY:null,dropTarget:null,objectPrevStyle:null,xy:null},z=[],I=[],E=[],J,R=false,xa=false,ta=false,O=null,W=null,ja=null,ka=0,ua=false,ca=null,ma=null,y={state:0,socket:null,keepAlive:null,reconnectTries:0},oa=false;ea(_$_SESSION_URL_$_);var na=p.initAjaxComm(J,
