...
h.offsetHeight-g}else{e=m.x;b=m.y+h.offsetHeight;o=m.x+h.offsetWidth;g=m.y}m=$(".Wt-domRoot").get(0);a.parentNode.removeChild(a);for(h=h.parentNode;h!=m;h=h.parentNode){if(h.wtReparentBarrier)break;if(k.css(h,"display")!="inline"&&h.clientHeight>100&&(getComputedStyle(h).overflowY==="scroll"||getComputedStyle(h).overflowX==="scroll"||h.scrollHeight>h.clientHeight&&getComputedStyle(h).overflowY==="auto"||h.scrollWidth>h.clientWidth&&getComputedStyle(h).overflowX==="auto"))break}m=k.css(h,"position");
