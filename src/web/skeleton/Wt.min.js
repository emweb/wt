...
end:a.selectionEnd}:{start:-1,end:-1}};this.setUnicodeSelectionRange=function(a,b,e){return k.setSelectionRange(a,b,e,true)};this.setSelectionRange=function(a,b,e,g){var h=$(a).val();if(typeof b!="number")b=-1;if(typeof e!="number")e=-1;if(b<0)b=0;if(e>h.length)e=h.length;if(e<b)e=b;if(b>e)b=e;a.focus();if(g)for(g=0;g<h.length;++g){if(g>=b&&g>=e)break;if(V(h.charCodeAt(g))&&g+1<h.length&&G(h.charCodeAt(g+1))){g<b&&++b;g<e&&++e}}if(typeof a.selectionStart!=="undefined"){a.selectionStart=b;a.selectionEnd=
...
a}else{a=document.createTextNode(a);b.appendChild(a)}};this.getCssRule=function(a,b){a=a.toLowerCase();if(document.styleSheets)for(var e=0;e<document.styleSheets.length;e++){var g=document.styleSheets[e],h=0,l;do{l=null;try{if(g.cssRules)l=g.cssRules[h];else if(g.rules)l=g.rules[h];if(l&&l.selectorText)if(l.selectorText.toLowerCase()==a)if(b=="delete"){g.cssRules?g.deleteRule(h):g.removeRule(h);return true}else return l}catch(o){}++h}while(l)}return false};this.removeCssRule=function(a){return k.getCssRule(a,
...
y:b}};this.fitToWindow=function(a,b,e,g,h){var l=["left","right"],o=["top","bottom"];a.style[l[0]]=a.style[l[1]]="auto";a.style[o[0]]=a.style[o[1]]="auto";var q=a.offsetWidth,u=a.offsetHeight,v=k.windowSize(),z=document.body.scrollLeft+document.documentElement.scrollLeft,x=document.body.scrollTop+document.documentElement.scrollTop;if(!$(a).hasClass("Wt-tooltip")){q=k.px(a,"maxWidth")||q;u=k.px(a,"maxHeight")||u}var B=a.offsetParent;if(B){var t=k.widgetPageCoordinates(B);if(q>v.x){b=z;g=0}else if(b+
q>z+v.x){q=B.scrollLeft;if(B==document.body)q=B.clientWidth-v.x;g=g-t.x+q;b=B.clientWidth-(g+k.px(a,"marginRight"));g=1}else{q=B.scrollLeft;if(B==document.body)q=0;b=b-t.x+q;b-=k.px(a,"marginLeft");g=0}if(u>v.y){e=x;h=0}else if(e+u>x+v.y){if(h>x+v.y)h=x+v.y;u=B.scrollTop;if(B==document.body)u=B.clientHeight-v.y;h=h-t.y+u;e=B.clientHeight-(h+k.px(a,"marginBottom")+k.px(a,"borderBottomWidth"));h=1}else{u=B.scrollTop;if(B==document.body)u=0;e=e-t.y+u;e=e-k.px(a,"marginTop")+k.px(a,"borderTopWidth");
h=0}a.style[l[g]]=b+"px";a.style[o[h]]=e+"px"}};this.positionXY=function(a,b,e){a=k.getElement(a);if(!k.isHidden(a)){a.style.display="block";k.fitToWindow(a,b,e,b,e)}};this.Horizontal=1;this.Vertical=2;this.positionAtWidget=function(a,b,e,g){a=k.getElement(a);var h=k.getElement(b);g||(g=0);if(h&&a){var l=k.widgetPageCoordinates(h),o;a.style.position="absolute";if(k.css(a,"display")=="none")a.style.display="block";if(e===k.Horizontal){e=l.x+h.offsetWidth;b=l.y+g;o=l.x;g=l.y+h.offsetHeight-g}else{e=
l.x;b=l.y+h.offsetHeight;o=l.x+h.offsetWidth;g=l.y}l=$(".Wt-domRoot").get(0);a.parentNode.removeChild(a);for(h=h.parentNode;h!=l;h=h.parentNode){if(h.wtReparentBarrier)break;if(k.css(h,"display")!="inline"&&h.clientHeight>100&&(getComputedStyle(h).overflowY==="scroll"||getComputedStyle(h).overflowX==="scroll"||h.scrollHeight>h.clientHeight&&getComputedStyle(h).overflowY==="auto"||h.scrollWidth>h.clientWidth&&getComputedStyle(h).overflowX==="auto"))break}l=k.css(h,"position");if(l!="absolute"&&l!=
"relative")h.style.position="relative";h.appendChild(a);$(a).addClass("wt-reparented");k.fitToWindow(a,e,b,o,g);a.style.visibility=""}};this.hasFocus=function(a){try{return a===document.activeElement}catch(b){return false}};this.progressed=function(a){var b=document,e=b.body,g=this.getElement("Wt-form");a.style.display=g.style.display;g.parentNode.replaceChild(a,g);e.removeEventListener?e.removeEventListener("click",delayClick,true):e.detachEvent("click",delayClick);setTimeout(function(){var h,l;
h=0;for(l=delayedClicks.length;h<l;++h)if(b.createEvent){var o=delayedClicks[h],q=b.createEvent("MouseEvents");q.initMouseEvent("click",o.bubbles,o.cancelable,window,o.detail,o.screenX,o.screenY,o.clientX,o.clientY,o.ctrlKey,o.altKey,o.shiftKey,o.metaKey,o.button,null);(o=k.getElement(o.targetId))&&o.dispatchEvent(q)}else{o=delayedClicks[h];q=b.createEventObject();for(h in o)q[h]=o[h];(o=k.getElement(o.targetId))&&o.fireEvent("onclick",q)}},0)};if(window.history&&window.history.pushState){function Sa(a,
...
b=q;h=u;a(q);o.addEventListener("popstate",v,false)},initialize:function(q,u,v){k.resolveRelativeAnchors();e=v;if(e.length>=1&&e[e.length-1]=="/"){_$_$if_UGLY_INTERNAL_PATHS_$_();g=true;_$_$endif_$_();_$_$ifnot_UGLY_INTERNAL_PATHS_$_();e=e.substr(0,e.length-1);_$_$endif_$_()}},navigate:function(q,u){k.resolveRelativeAnchors();b=q;var v=Ka(q),z=e;if(v.length!=0)z+=(g?"?_=":"")+v;if(g){function x(t){if(t.length>1)t=t.substr(1);var F=t.split("&"),J,S;t="";J=0;for(S=F.length;J<S;++J)if(F[J].split("=")[0]!=
...
Ka(r);if(t){r=r;if(u)h(r);else if(r.length>0)location.hash=r;A&&e()}},getCurrentState:function(){if(!t)return"";return unescape(I)}}}()});if(window._$_APP_CLASS_$_&&window._$_APP_CLASS_$_._p_)try{window._$_APP_CLASS_$_._p_.quit(null)}catch(e$$35){}
...
wsRqsDone:g,setPage:h,setCloseMessage:na,setConnectionMonitor:Sa,updateGlobal:r,bindGlobal:A,refreshCookie:T,propagateSize:q};this.WT=_$_WT_CLASS_$_;this.emit=u});window._$_APP_CLASS_$_SignalEmit=_$_APP_CLASS_$_.emit;window._$_APP_CLASS_$_OnLoad=function(){_$_APP_CLASS_$_._p_.load()};
