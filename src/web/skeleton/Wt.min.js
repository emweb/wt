...
{position:e.object.style.position,display:e.object.style.display,left:e.object.style.left,top:e.object.style.top,className:e.object.className};e.object.parentNode.removeChild(e.object);e.object.style.position="absolute";e.object.className="";document.body.appendChild(e.object);h.capture(null);h.capture(e.object);e.object.onmousemove=V;e.object.onmouseup=Q;e.offsetX=-4;e.offsetY=-4;e.dropTarget=null;e.mimeType=c.getAttribute("dmt");e.xy=h.pageCoordinates(d);h.cancelEvent(d);return false}function V(c){if(E.object!=
...
p);if(i.length!=0){d.dropTarget.setAttribute("dos",d.dropTarget.className);d.dropTarget.className=d.dropTarget.className+" "+i}}else d.object.styleClass="";if(e!=null){e.handleDragDrop&&e.handleDragDrop("end",d.object,c,"",m);i=e.getAttribute("dos");if(i!=null)e.className=i}}if(d.dropTarget)if(d.dropTarget.handleDragDrop)d.dropTarget.handleDragDrop("drag",d.object,c,"",m);else d.object.className="Wt-valid-drop";return false}return true}function Q(c){h.capture(null);var d=E;if(d.object){if(d.dropTarget){var e=
