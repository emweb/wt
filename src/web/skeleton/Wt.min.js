/*
 ...
 version: 2.5.2
*/
_$_$if_DYNAMIC_JS_$_();window.JavaScriptFunction=1;window.JavaScriptConstructor=2;window.JavaScriptObject=3;window.JavaScriptPrototype=4;window.WT_DECLARE_WT_MEMBER=function(U,V,F,N){if(V==JavaScriptPrototype){U=F.indexOf(".prototype");_$_WT_CLASS_$_[F.substr(0,U)].prototype[F.substr(U+11)]=N}else _$_WT_CLASS_$_[F]=V==JavaScriptFunction?function(){return N.apply(_$_WT_CLASS_$_,arguments)}:N};window.WT_DECLARE_WT_MEMBER_BIG=window.WT_DECLARE_WT_MEMBER;
window.WT_DECLARE_APP_MEMBER=function(U,V,F,N){var ga=window.currentApp;if(V==JavaScriptPrototype){U=F.indexOf(".prototype");ga[F.substr(0,U)].prototype[F.substr(U+11)]=N}else ga[F]=V==JavaScriptFunction?function(){return N.apply(ga,arguments)}:N};_$_$endif_$_();_$_$ifnot_DYNAMIC_JS_$_();window.JavaScriptConstructor=2;window.WT_DECLARE_WT_MEMBER_BIG=function(U,V,F,N){return N};_$_$endif_$_();
...
null){t.onreadystatechange=new Function;I=true;t.abort();t=null}};_$_CLOSE_CONNECTION_$_&&t.setRequestHeader("Connection","close");if(v>0)E=setTimeout(B,v);t.onreadystatechange=x;try{t.onload=function(){z(true)};t.onerror=function(){z(false)}}catch(Q){}t.send(o)}var m=a;this.responseReceived=function(){};this.sendUpdate=function(o,r,u,v){if(!m)return null;return new h(o,r,u,v)};this.cancel=function(){m=null};this.setUrl=function(o){m=o}}):new (function(){function h(r,u,v){function z(){b(1,null,u);
...
end:a.selectionEnd}:{start:-1,end:-1}};this.setUnicodeSelectionRange=function(a,b,e){return k.setSelectionRange(a,b,e,true)};this.setSelectionRange=function(a,b,e,g){var h=$(a).val();if(typeof b!="number")b=-1;if(typeof e!="number")e=-1;if(b<0)b=0;if(e>h.length)e=h.length;if(e<b)e=b;if(b>e)b=e;a.focus();if(g)for(g=0;g<h.length;++g){if(g>=b&&g>=e)break;if(V(h.charCodeAt(g))&&g+1<h.length&&F(h.charCodeAt(g+1))){g<b&&++b;g<e&&++e}}if(typeof a.selectionStart!=="undefined"){a.selectionStart=b;a.selectionEnd=
...
""};var O=null;this.firedTarget=null;this.target=function(a){try{return k.firedTarget||a.target||a.srcElement}catch(b){return null}};var Da=false;this.capture=function(a){Ca();if(!(O&&a)){for(var b=0;b<window.frames.length;b++)try{if(!window.frames[b].document.body.hasMouseHandlers){Ba(window.frames[b].document.body);window.frames[b].document.body.hasMouseHandlers=true}}catch(e){}O=a;b=document.body;document.body.addEventListener||(a!=null?b.setCapture():b.releaseCapture());if(a!=null){$(b).addClass("unselectable");
b.setAttribute("unselectable","on");b.onselectstart="return false;"}else{$(b).removeClass("unselectable");b.setAttribute("unselectable","off");b.onselectstart=""}}};this.checkReleaseCapture=function(a,b){if(b&&O&&a==O&&(b.type=="mouseup"||b.type=="touchend"))this.capture(null)};this.getElementsByClassName=function(a,b){if(document.getElementsByClassName)return b.getElementsByClassName(a);else{b=b.getElementsByTagName("*");for(var e=[],g,h=0,m=b.length;h<m;h++){g=b[h];g.className.indexOf(a)!=-1&&e.push(g)}return e}};
var la=null;this.addCss=function(a,b){var e=Sa();e.insertRule(a+" { "+b+" }",e.cssRules?e.cssRules.length:0)};this.addCssText=function(a){var b=document.getElementById("Wt-inline-css");if(!b){b=document.createElement("style");b.id="Wt-inline-css";document.getElementsByTagName("head")[0].appendChild(b)}if(b.styleSheet){var e=b.previousSibling;if(!e||!k.hasTag(e,"STYLE")||e.styleSheet.cssText.length>32768){e=document.createElement("style");b.parentNode.insertBefore(e,b);e.styleSheet.cssText=a}else e.styleSheet.cssText+=
a}else{a=document.createTextNode(a);b.appendChild(a)}};this.getCssRule=function(a,b){a=a.toLowerCase();if(document.styleSheets)for(var e=0;e<document.styleSheets.length;e++){var g=document.styleSheets[e],h=0,m;do{m=null;try{if(g.cssRules)m=g.cssRules[h];else if(g.rules)m=g.rules[h];if(m&&m.selectorText)if(m.selectorText.toLowerCase()==a)if(b=="delete"){g.cssRules?g.deleteRule(h):g.removeRule(h);return true}else return m}catch(o){}++h}while(m)}return false};this.removeCssRule=function(a){return k.getCssRule(a,
...
y:b}};this.fitToWindow=function(a,b,e,g,h){var m=["left","right"],o=["top","bottom"];a.style[m[0]]=a.style[m[1]]="auto";a.style[o[0]]=a.style[o[1]]="auto";var r=a.offsetWidth,u=a.offsetHeight,v=k.windowSize(),z=document.body.scrollLeft+document.documentElement.scrollLeft,x=document.body.scrollTop+document.documentElement.scrollTop;if(!$(a).hasClass("Wt-tooltip")){r=k.px(a,"maxWidth")||r;u=k.px(a,"maxHeight")||u}var B=a.offsetParent;if(B){var t=k.widgetPageCoordinates(B);if(r>v.x){b=z;g=0}else if(b+
r>z+v.x){r=B.scrollLeft;if(B==document.body)r=B.clientWidth-v.x;g=g-t.x+r;b=B.clientWidth-(g+k.px(a,"marginRight"));g=1}else{r=B.scrollLeft;if(B==document.body)r=0;b=b-t.x+r;b-=k.px(a,"marginLeft");g=0}if(u>v.y){e=x;h=0}else if(e+u>x+v.y){if(h>x+v.y)h=x+v.y;u=B.scrollTop;if(B==document.body)u=B.clientHeight-v.y;h=h-t.y+u;e=B.clientHeight-(h+k.px(a,"marginBottom")+k.px(a,"borderBottomWidth"));h=1}else{u=B.scrollTop;if(B==document.body)u=0;e=e-t.y+u;e=e-k.px(a,"marginTop")+k.px(a,"borderTopWidth");
h=0}a.style[m[g]]=b+"px";a.style[o[h]]=e+"px"}};this.positionXY=function(a,b,e){a=k.getElement(a);if(!k.isHidden(a)){a.style.display="block";k.fitToWindow(a,b,e,b,e)}};this.Horizontal=1;this.Vertical=2;this.positionAtWidget=function(a,b,e,g){a=k.getElement(a);var h=k.getElement(b);g||(g=0);if(h&&a){var m=k.widgetPageCoordinates(h),o;a.style.position="absolute";if(k.css(a,"display")=="none")a.style.display="block";if(e===k.Horizontal){e=m.x+h.offsetWidth;b=m.y+g;o=m.x;g=m.y+h.offsetHeight-g}else{e=
m.x;b=m.y+h.offsetHeight;o=m.x+h.offsetWidth;g=m.y}m=$(".Wt-domRoot").get(0);a.parentNode.removeChild(a);for(h=h.parentNode;h!=m;h=h.parentNode){if(h.wtReparentBarrier)break;if(k.css(h,"display")!="inline"&&h.clientHeight>100&&(getComputedStyle(h).overflowY==="scroll"||getComputedStyle(h).overflowX==="scroll"||h.scrollHeight>h.clientHeight&&getComputedStyle(h).overflowY==="auto"||h.scrollWidth>h.clientWidth&&getComputedStyle(h).overflowX==="auto"))break}m=k.css(h,"position");if(m!="absolute"&&m!=
"relative")h.style.position="relative";h.appendChild(a);$(a).addClass("wt-reparented");k.fitToWindow(a,e,b,o,g);a.style.visibility=""}};this.hasFocus=function(a){try{return a===document.activeElement}catch(b){return false}};this.progressed=function(a){var b=document,e=b.body,g=this.getElement("Wt-form");a.style.display=g.style.display;g.parentNode.replaceChild(a,g);e.removeEventListener?e.removeEventListener("click",delayClick,true):e.detachEvent("click",delayClick);setTimeout(function(){var h,m;
h=0;for(m=delayedClicks.length;h<m;++h)if(b.createEvent){var o=delayedClicks[h],r=b.createEvent("MouseEvents");r.initMouseEvent("click",o.bubbles,o.cancelable,window,o.detail,o.screenX,o.screenY,o.clientX,o.clientY,o.ctrlKey,o.altKey,o.shiftKey,o.metaKey,o.button,null);(o=k.getElement(o.targetId))&&o.dispatchEvent(r)}else{o=delayedClicks[h];r=b.createEventObject();for(h in o)r[h]=o[h];(o=k.getElement(o.targetId))&&o.fireEvent("onclick",r)}},0)};if(window.history&&window.history.pushState){function Ta(a,
...
b=r;h=u;a(r);o.addEventListener("popstate",v,false)},initialize:function(r,u,v){k.resolveRelativeAnchors();e=v;if(e.length>=1&&e[e.length-1]=="/"){_$_$if_UGLY_INTERNAL_PATHS_$_();g=true;_$_$endif_$_();_$_$ifnot_UGLY_INTERNAL_PATHS_$_();e=e.substr(0,e.length-1);_$_$endif_$_()}},navigate:function(r,u){k.resolveRelativeAnchors();b=r;var v=La(r),z=e;if(v.length!=0)z+=(g?"?_=":"")+v;if(g){function x(t){if(t.length>1)t=t.substr(1);var E=t.split("&"),I,Q;t="";I=0;for(Q=E.length;I<Q;++I)if(E[I].split("=")[0]!=
...
A){s=La(s);if(t){s=s;if(u)h(s);else if(s.length>0)location.hash=s;A&&e()}},getCurrentState:function(){if(!t)return"";return unescape(H)}}}()});if(window._$_APP_CLASS_$_&&window._$_APP_CLASS_$_._p_)try{window._$_APP_CLASS_$_._p_.quit(null)}catch(e$$35){}
window._$_APP_CLASS_$_=new (function(){function U(c){c=q.pageCoordinates(c);Xa=c.x;Ya=c.y}function V(){var c=_$_WT_CLASS_$_.history.getCurrentState();if(!(c!=null&&c.length>0&&c.substr(0,1)!="/"))if(ha!=c){ha=c;setTimeout(function(){xa(null,"hash",null,true)},1)}}function F(c,d){if(!(ha==c||!ha&&c=="/")){d||(ha=c);q.history.navigate(c,d)}}function N(c,d){Ga=setTimeout(function(){ka(c,d)},eb)}function ga(){Ga&&clearTimeout(Ga)}function ka(c,d){if(d.touches)if("vibrate"in navigator){navigator.vibrate=
...
P,c);document.addEventListener("keydown",P,c);document.addEventListener("keyup",P,c);document.addEventListener("touchstart",P,c);document.addEventListener("touchend",P,c);document.addEventListener("pointerdown",P,c);document.addEventListener("pointerup",P,c)}}}function va(c){if(!Za){if(c){if(!window._$_APP_CLASS_$_LoadWidgetTree)return;q.history.initialize("Wt-history-field","Wt-history-iframe",$a)}if(!("activeElement"in document)){function d(l){if(l&&l.target)document.activeElement=l.target==document?
null:l.target}function f(){document.activeElement=null}document.addEventListener("focus",d,true);document.addEventListener("blur",f,true)}$(document).mousedown(q.mouseDown).mouseup(q.mouseUp);q.history._initialize();Ea();Za=true;c&&window._$_APP_CLASS_$_LoadWidgetTree();da||Ia||(Ia=setInterval(Sa,_$_KEEP_ALIVE_$_000))}}function W(c){clearTimeout(c);document.body.style.cursor="auto";if(ja!=null){try{ja()}catch(d){}ja=null}}function ma(){document.body.style.cursor="wait";ja=hideLoadingIndicator;showLoadingIndicator()}
function X(){var c=Date.now(),d=-1;for(var f in ea)if(ea.hasOwnProperty(f)){if(c-ea[f].time>=_$_INDICATOR_TIMEOUT_$_){ja==null&&ma();return}var l=parseInt(f,10);if(l>d)d=l}Pa=d+1;document.body.style.cursor="auto";if(ja!=null){try{ja()}catch(p){}ja=null}}function oa(c){Qa=c}function pa(){T._p_.autoJavaScript()}function Fa(c){if(c){c="(function() {"+c+"})();";window.execScript?window.execScript(c):window.eval(c)}T==window._$_APP_CLASS_$_&&pa()}function wa(){Pa=0;ea={};y.socket.send("&signal=none&connected="+
Z);y.state=3}function O(c,d,f){if(C)C.onStatusChange("connectionStatus",c==0?1:0);if(!da)if(ra)setTimeout(function(){O(c,d,f)},50);else{if(c==0){q.resolveRelativeAnchors();_$_$if_CATCH_ERROR_$_();try{_$_$endif_$_();Fa(d);_$_$if_CATCH_ERROR_$_()}catch(l){var p=l.description||l.message,n={exception_code:l.code,exception_description:p,exception_js:d};n.stack=l.stack||l.stacktrace;m(n,"Wt internal error; code: "+l.code+", description: "+p);throw l;}_$_$endif_$_();f&&W(f)}else J=Ma.concat(J);Ma=[];if(M){clearTimeout(M);
...
true;q.checkReleaseCapture(c,f);_$_$if_STRICTLY_SERIALIZED_EVENTS_$_();if(!D){_$_$endif_$_();var p={},n=J.length;p.object=c;p.signal=d;p.event=window.fakeEvent||f;p.feedback=l;p.evAckId=Z;J[n]=Ba(p,n);b();Fa();_$_$if_STRICTLY_SERIALIZED_EVENTS_$_()}_$_$endif_$_();Ua=false}}function a(){y.keepAlive&&clearInterval(y.keepAlive);y.keepAlive=setInterval(function(){var c=y.socket;if(c.readyState==1)c.send("&signal=ping");else{clearInterval(y.keepAlive);y.keepAlive=null}},_$_SERVER_PUSH_TIMEOUT_$_)}function b(){if(da){if(Na){if(confirm(Na))document.location=
document.location;Na=null}}else{_$_$if_WEB_SOCKETS_$_();if(y.state!=4)if(typeof window.WebSocket==="undefined"&&typeof window.MozWebSocket==="undefined")y.state=4;else{var c=y.socket;if(c==null||c.readyState>1)if(c!=null&&y.state==0)y.state=4;else{function d(){if(!da){++y.reconnectTries;var p=Math.min(12E4,Math.exp(y.reconnectTries)*500);setTimeout(function(){b()},p)}}var f;if(za.indexOf("://")!=-1)f="ws"+za.substr(4);else{f=za.substr(za.indexOf("?"));f="ws"+location.protocol.substr(4)+"//"+location.host+
_$_WS_PATH_$_+f}f+="&request=ws";var l=_$_WS_ID_$_;if(l.length>0)f+="&wsid="+l;y.socket=typeof window.WebSocket!=="undefined"?(c=new WebSocket(f)):(c=new MozWebSocket(f));y.state=1;y.keepAlive&&clearInterval(y.keepAlive);y.keepAlive=null;c.onmessage=function(p){var n=null;if(y.state==1)if(p.data=="connect"){if(D!=null&&M!=null){clearTimeout(M);M=null;D.abort();D=null}if(D||!$.isEmptyObject(ea))y.state=2;else wa()}else{console.log("WebSocket: was expecting a connect?");console.log(p.data);return}else{if(C){C.onStatusChange("websocket",
true);C.onStatusChange("connectionStatus",1)}y.state=3;n=p.data}y.reconnectTries=0;n!=null&&O(0,n,null)};c.onerror=function(){C&&C.onStatusChange("websocket",false);if(y.reconnectTries==3&&y.state==0)y.state=4;d()};c.onclose=function(){C&&C.onStatusChange("websocket",false);if(y.reconnectTries==3&&y.state==0)y.state=4;d()};c.onopen=function(){if(C){C.onStatusChange("websocket",true);C.onStatusChange("connectionStatus",1)}a()}}if(c.readyState==1&&c.state==3){a();o();return}}_$_$endif_$_();if(D!=null&&
...
encodeURIComponent(JSON.stringify(c)),false,Z,-1);_$_$if_SHOW_ERROR_$_();alert(d);_$_$endif_$_()}function o(){function c(){return"_$_PARAMS_$_"}if(T!=window._$_APP_CLASS_$_)Ca(null);else if(!D){fa=null;if(!da){var d,f,l,p=y.socket!==null&&y.socket.readyState===1&&y.state===3;if(J.length>0){d=Ra();f=d.feedback?setTimeout(p?X:ma,_$_INDICATOR_TIMEOUT_$_):null;l=false}else{d={result:"&signal=poll"};f=null;l=true}p||(d.result+="&ackId="+Z);d.result+="&pageId="+bb;if(Va){var n="",w=$("#"+Va).get(0);if(w)for(w=
...
Z,false,Z,-1)}function ba(c,d,f){if(db)f();else{Ka.push(f);Ka.length===1&&google.load("maps",c,{other_params:"key="+d,callback:function(){db=true;for(var l=0;l<Ka.length;++l)Ka[l]();Ka=[]}})}}var T=this,q=_$_WT_CLASS_$_,Xa=0,Ya=0,$a=_$_DEPLOY_PATH_$_,ha=null,Ha={object:null,sourceId:null,mimeType:null,dropOffsetX:null,dragOffsetY:null,dropTarget:null,objectPrevStyle:null,xy:null},Ga,eb=1E3,ya=[],Ma=[],J=[],za,da=false,Na=_$_QUITTED_STR_$_,Za=false,D=null,M=null,Ia=null,Oa=_$_IDLE_TIMEOUT_$_,ia=null,
Ja=0,Qa=false,fa=null,ja=null,Pa=0,ea={},y={state:0,socket:null,keepAlive:null,reconnectTries:0},C=null;Da(_$_SESSION_URL_$_);var qa=q.initAjaxComm(za,O),Ua=false,ab,Z=_$_ACK_UPDATE_ID_$_,Va=null,bb=0,Aa={},ra=false;t.prototype.preload=function(c){var d=new Image;this.images.push(d);d.onload=t.prototype.onload;d.onerror=t.prototype.onload;d.onabort=t.prototype.onload;d.imagePreloader=this;d.src=c};t.prototype.onload=function(){var c=this.imagePreloader;--c.work==0&&c.callback(c.images)};t.prototype.cancel=
...
dragStart:ka,dragDrag:sa,dragEnd:ta,capture:q.capture,enableInternalPaths:I,onHashChange:V,setHash:F,ImagePreloader:t,ArrayBufferPreloader:E,doAutoJavaScript:pa,autoJavaScript:function(){},response:e,wsRqsDone:g,setPage:h,setCloseMessage:na,setConnectionMonitor:Ta,updateGlobal:s,bindGlobal:A,refreshCookie:S,propagateSize:r,loadGoogleMaps:ba};this.WT=_$_WT_CLASS_$_;this.emit=u});window._$_APP_CLASS_$_SignalEmit=_$_APP_CLASS_$_.emit;window._$_APP_CLASS_$_OnLoad=function(){_$_APP_CLASS_$_._p_.load()};
