...
2};this.drag=function(){++sa};this.arrayRemove=function(a,b,e){e=a.slice((e||b)+1||a.length);a.length=b<0?a.length+b:b;return a.push.apply(a,e)};this.addAll=function(a,b){for(var e=0,g=b.length;e<g;++e)a.push(b[e])};var ka=function(){for(var a,b=3,e=document.createElement("div"),g=e.getElementsByTagName("i");e.innerHTML="<!--[if gt IE "+ ++b+"]><i></i><![endif]--\>",g[0];);return b>4?b:a}(),W=navigator.userAgent.toLowerCase();this.isIE=ka!==undefined;this.isIE6=ka===6;this.isIE8=ka===8;this.isIElt9=
ka<9;this.isIEMobile=W.indexOf("msie 4")!=-1||W.indexOf("msie 5")!=-1;this.isOpera=typeof window.opera!=="undefined";this.isAndroid=W.indexOf("safari")!=-1&&W.indexOf("android")!=-1;this.isWebKit=W.indexOf("applewebkit")!=-1;this.isGecko=W.indexOf("gecko")!=-1&&!this.isWebKit;this.isIOS=W.indexOf("ipod")!=-1||W.indexOf("ipad")!=-1;this.updateDelay=this.isIE?10:51;if(this.isAndroid){console.error("init console.error");console.info("init console.info");console.log("init console.log");console.warn("init console.warn")}var la=
new Date;this.trace=function(a,b){if(b)la=new Date;b=new Date;b=(b.getMinutes()-la.getMinutes())*6E4+(b.getSeconds()-la.getSeconds())*1E3+(b.getMilliseconds()-la.getMilliseconds());window.console&&console.log("["+b+"]: "+a)};this.initAjaxComm=function(a,b){function e(k,n){var o=null,q=true;if(window.XMLHttpRequest){o=new XMLHttpRequest;if(g)if("withCredentials"in o){if(n){o.open(k,n,true);o.withCredentials="true"}}else if(typeof XDomainRequest!="undefined"){o=new XDomainRequest;if(n){q=false;try{o.open(k,
n+"&contentType=x-www-form-urlencoded")}catch(u){o=null}}}else o=null;else n&&o.open(k,n,true)}else if(!g&&window.ActiveXObject){try{o=new ActiveXObject("Msxml2.XMLHTTP")}catch(w){try{o=new ActiveXObject("Microsoft.XMLHTTP")}catch(x){}}n&&o&&o.open(k,n,true)}o&&n&&q&&o.setRequestHeader("Content-type","application/x-www-form-urlencoded");return o}var g=(a.indexOf("://")!=-1||a.indexOf("//")==0)&&P(a)!=window.location.host;return e("POST",a)!=null?new (function(){function k(o,q,u,w){function x(G){if(!H){clearTimeout(N);
if(n){H=true;var ea=t;if(t){t.onreadystatechange=new Function;try{t.onload=t.onreadystatechange}catch(s){}t=null}G?b(0,ea.responseText,q):b(1,null,q)}}}function B(){if(t.readyState==4){var G=t.status==200&&t.getResponseHeader("Content-Type")&&t.getResponseHeader("Content-Type").indexOf("text/javascript")==0;x(G)}}function z(){if(!H)if(n){t.onreadystatechange=new Function;t=null;H=true;b(2,null,q)}}var t=e("POST",n),N=null,H=false;this.abort=function(){if(t!=null){t.onreadystatechange=new Function;
H=true;t.abort();t=null}};_$_CLOSE_CONNECTION_$_&&t.setRequestHeader("Connection","close");if(w>0)N=setTimeout(z,w);t.onreadystatechange=B;try{t.onload=function(){x(true)};t.onerror=function(){x(false)}}catch(M){}t.send(o)}var n=a;this.responseReceived=function(){};this.sendUpdate=function(o,q,u,w){if(!n)return null;return new k(o,q,u,w)};this.cancel=function(){n=null};this.setUrl=function(o){n=o}}):new (function(){function k(q,u,w){function x(){b(1,null,u);B.parentNode.removeChild(B)}this.userData=
u;var B=this.script=document.createElement("script");B.id="script"+w;B.setAttribute("src",n+"&"+q);B.onerror=x;document.getElementsByTagName("head")[0].appendChild(B);this.abort=function(){B.parentNode.removeChild(B)}}var n=a,o=null;this.responseReceived=function(){if(o!=null){var q=o;o.script.parentNode.removeChild(o.script);o=null;b(0,"",q.userData)}};this.sendUpdate=function(q,u,w,x){if(!n)return null;return o=new k(q,u,w,x)};this.cancel=function(){n=null};this.setUrl=function(q){n=q}})};this.setHtml=
function(a,b,e){function g(n,o){var q,u,w;switch(n.nodeType){case 1:q=n.namespaceURI===null?document.createElement(n.nodeName):document.createElementNS(n.namespaceURI,n.nodeName);if(n.attributes&&n.attributes.length>0){u=0;for(w=n.attributes.length;u<w;)q.setAttribute(n.attributes[u].nodeName,n.getAttribute(n.attributes[u++].nodeName))}if(o&&n.childNodes.length>0){u=0;for(w=n.childNodes.length;u<w;){var x=g(n.childNodes[u++],o);x&&q.appendChild(x)}}return q;case 3:case 4:case 5:return document.createTextNode(n.nodeValue)}return null}
if(h.isIE||_$_INNER_HTML_$_&&!e)if(e)a.innerHTML+=b;else{h.saveReparented(a);a.innerHTML=b}else{var k;k=new DOMParser;k=k.parseFromString("<div>"+b+"</div>","application/xhtml+xml").documentElement;if(k.nodeType!=1)k=k.nextSibling;if(!e){h.saveReparented(a);a.innerHTML=""}b=0;for(e=k.childNodes.length;b<e;)a.appendChild(g(k.childNodes[b++],true))}};this.hasTag=function(a,b){return a.nodeType==1&&a.tagName&&a.tagName.toUpperCase()===b};this.insertAt=function(a,b,e){if(a.childNodes.length){var g,k,
...
"auto";if(ia!=null){try{ia()}catch(c){}ia=null}}function sa(){document.body.style.cursor="wait";ia=hideLoadingIndicator;showLoadingIndicator()}function ka(){var d=Date.now(),c=-1;for(var f in na)if(na.hasOwnProperty(f)){if(d-na[f].time>=_$_INDICATOR_TIMEOUT_$_){ia==null&&sa();return}var l=parseInt(f,10);if(l>c)c=l}Na=c+1;document.body.style.cursor="auto";if(ia!=null){try{ia()}catch(p){}ia=null}}function W(d){Ta=d}function la(){E._p_.autoJavaScript()}function V(d){if(d){d="(function() {"+d+"})();";
...
function p(){if(!m&&!v){m=true;x(d)}}var m=false,v=false;if(c!="")try{m=!eval("typeof "+c+" === 'undefined'")}catch(C){m=false}if(m)x(d);else{var U=document.createElement("script");U.setAttribute("src",d);U.onload=p;U.onerror=l;U.onreadystatechange=function(){var Z=U.readyState;if(Z=="loaded")r.isOpera||r.isIE?p():l();else Z=="complete"&&p()};document.getElementsByTagName("head")[0].appendChild(U)}}function z(d,c){this.callback=c;this.work=d.length;this.images=[];if(d.length==0)c(this.images);else for(c=
...
0&&this.callback(this.arrayBuffers)};window.onunload=function(){if(!aa){E.emit(E,"Wt-unload");a();n()}};var Wa=true,Y=null,Qa=["keydown","keyup","keypress"];this._p_={ieAlternative:H,loadScript:B,onJsLoad:w,setTitle:Ga,setLocale:M,update:ra,quit:ya,setSessionUrl:Aa,setFormObjects:function(d){Da=d},saveDownPos:P,addTimerEvent:u,load:h,setServerPush:W,touchStart:ca,touchEnded:oa,dragStart:wa,dragDrag:ja,dragEnd:pa,capture:r.capture,enableInternalPaths:N,onHashChange:Q,setHash:J,ImagePreloader:z,ArrayBufferPreloader:t,
