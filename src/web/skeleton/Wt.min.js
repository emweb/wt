/*
 ...
 version: 2.5.2
*/
_$_$if_DYNAMIC_JS_$_();window.JavaScriptFunction=1;window.JavaScriptConstructor=2;window.JavaScriptObject=3;window.JavaScriptPrototype=4;window.WT_DECLARE_WT_MEMBER=function(I,J,D,G){if(J==JavaScriptPrototype){I=D.indexOf(".prototype");_$_WT_CLASS_$_[D.substr(0,I)].prototype[D.substr(I+11)]=G}else _$_WT_CLASS_$_[D]=J==JavaScriptFunction?function(){G.apply(_$_WT_CLASS_$_,arguments)}:G};
window.WT_DECLARE_APP_MEMBER=function(I,J,D,G){var Q=window.currentApp;if(J==JavaScriptPrototype){I=D.indexOf(".prototype");Q[D.substr(0,I)].prototype[D.substr(I+11)]=G}else Q[D]=J==JavaScriptFunction?function(){G.apply(Q,arguments)}:G};_$_$endif_$_();
if(!window._$_WT_CLASS_$_)window._$_WT_CLASS_$_=new (function(){function I(a){return a.split("/")[2]}function J(a,b){if(a.style[b])return a.style[b];else{if(a!==ga){ga=a;W=window.getComputedStyle?window.getComputedStyle(a,null):a.currentStyle?a.currentStyle:null}return W?W[b]:null}}function D(a,b,e){if(a=="auto"||a==null)return e;return(a=(a=b.exec(a))&&a.length==2?a[1]:null)?parseFloat(a):e}function G(a){return D(a,/^\s*(-?\d+(?:\.\d+)?)\s*px\s*$/i,0)}function Q(a,b){return D(a,/^\s*(-?\d+(?:\.\d+)?)\s*\%\s*$/i,
...
0;v(o)}}function B(){u.onreadystatechange=new Function;u=null;F=true;b(2,null,p)}var u=e("POST",a),O=null,F=false;this.abort=function(){u.onreadystatechange=new Function;F=true;u.abort();u=null};_$_CLOSE_CONNECTION_$_&&u.setRequestHeader("Connection","close");if(t>0)O=setTimeout(B,t);u.onreadystatechange=x;try{u.onload=function(){v(true)};u.onerror=function(){v(false)}}catch(H){}u.send(g)}this.responseReceived=function(){};this.sendUpdate=function(g,p,s,t){return new l(g,p,s,t)}}):new (function(){function l(p,
...
function(a){if(document.selection)if(i.hasTag(a,"TEXTAREA")){var b=document.selection.createRange(),e=b.duplicate();e.moveToElementText(a);var j=0;if(b.text.length>1){j-=b.text.length;if(j<0)j=0}a=-1+j;for(e.moveStart("character",j);e.inRange(b);){e.moveStart("character");a++}b=b.text.replace(/\r/g,"");return{start:a,end:b.length+a}}else{e=$(a).val();a=document.selection.createRange().duplicate();a.moveEnd("character",e.length);b=a.text==""?e.length:e.lastIndexOf(a.text);a=document.selection.createRange().duplicate();
...
"stylesheet");b!=""&&b!="all"&&e.setAttribute("media",b);document.getElementsByTagName("head")[0].appendChild(e)}};this.windowSize=function(){var a,b;if(typeof window.innerWidth==="number"){a=window.innerWidth;b=window.innerHeight}else{a=document.documentElement.clientWidth;b=document.documentElement.clientHeight}return{x:a,y:b}};this.fitToWindow=function(a,b,e,j,l){var g=i.windowSize(),p=document.body.scrollLeft+document.documentElement.scrollLeft,s=document.body.scrollTop+document.documentElement.scrollTop;
if(a.offsetParent){var t=i.widgetPageCoordinates(a.offsetParent),v=["left","right"],x=["top","bottom"],B=i.px(a,"maxWidth")||a.offsetWidth,u=i.px(a,"maxHeight")||a.offsetHeight;if(B>g.x){b=p;j=0}else if(b+B>p+g.x){j-=t.x;b=a.offsetParent.offsetWidth-(j+i.px(a,"marginRight"));j=1}else{b-=t.x;b-=i.px(a,"marginLeft");j=0}if(B>g.y){e=s;l=0}else if(e+u>s+g.y){if(l>s+g.y)l=s+g.y;l-=t.y;e=a.offsetParent.offsetHeight-(l+i.px(a,"marginBottom"));l=1}else{e-=t.y;e-=i.px(a,"marginTop");l=0}a.style[v[j]]=b+"px";
a.style[v[1-j]]="";a.style[x[l]]=e+"px";a.style[x[1-l]]=""}};this.positionXY=function(a,b,e){a=i.getElement(a);i.isHidden(a)||i.fitToWindow(a,b,e,b,e)};this.Horizontal=1;this.Vertical=2;this.positionAtWidget=function(a,b,e,j,l){a=i.getElement(a);if((b=i.getElement(b))&&a){var g=i.widgetPageCoordinates(b);if(j){a.parentNode.removeChild(a);$(".Wt-domRoot").get(0).appendChild(a)}a.style.position="absolute";if(l)a.style.display="block";if(e==i.Horizontal){e=g.x+b.offsetWidth;j=g.y;l=g.x;b=g.y+b.offsetHeight}else{e=
g.x;j=g.y+b.offsetHeight;l=g.x+b.offsetWidth;b=g.y}i.fitToWindow(a,e,j,l,b);a.style.visibility=""}};this.hasFocus=function(a){return a==document.activeElement};this.history=!i.isMobileWebKit&&window.history&&window.history.pushState?function(){var a=null,b=null,e=null;return{_initialize:function(){},_initTimeout:function(){},register:function(j,l){function g(s){if((s=s.state)&&s!=a){a=s;l(a)}}function p(){var s=window.location.hash,t=null;if(s=="")t=s;else if(s.substr(0,2)=="#/")t=s.substr(2);if(t!==
a){a=t;l(a)}}a=j;e=l;window.addEventListener("popstate",g,false);window.addEventListener("hashchange",p,false)},initialize:function(j,l,g){if(g&&g[g.length-1]=="/"){_$_$if_UGLY_INTERNAL_PATHS_$_();b=g+"?_=";_$_$endif_$_();_$_$ifnot_UGLY_INTERNAL_PATHS_$_();b=g.substr(0,g.length-1);_$_$endif_$_()}else b=g?g:window.location.pathname},navigate:function(j,l){a=j;var g=b+j;if(b.length<3&&b.substr(b.length-3)!="?_=")g+=window.location.search;try{window.history.pushState(j,document.title,g)}catch(p){console.log(p.toString())}l&&
e(j)},getCurrentState:function(){return a}}}():function(){function a(){var n,q;q=location.href;n=q.indexOf("#");return n>=0?q.substr(n+1):null}function b(){O.value=P+"|"+K;if(t)O.value+="|"+o.join(",")}function e(){var n,q;n=0;for(q=L.length;n<q;++n)L[n](unescape(K))}function j(n){if(n){if(!n||K!==n){K=n||P;e()}}else{K=P;e()}}function l(n){var q;n='<html><body><div id="state">'+n+"</div></body></html>";try{q=u.contentWindow.document;q.open();q.write(n);q.close();return true}catch(z){return false}}
function g(){var n,q,z,w;if(!u.contentWindow||!u.contentWindow.document)setTimeout(g,10);else{n=u.contentWindow.document;z=(q=n.getElementById("state"))?q.innerText:null;w=a();setInterval(function(){var R,C;n=u.contentWindow.document;R=(q=n.getElementById("state"))?q.innerText:null;C=a();if(R!==z){z=R;j(z);C=z?z:P;w=location.hash=C;b()}else if(C!==w){w=C;l(C)}},50);F=true;B!=null&&B()}}function p(){if(!v){var n=a(),q=history.length;H&&clearInterval(H);H=setInterval(function(){var z,w;z=a();w=history.length;
if(z!==n){n=z;q=w;j(n);b()}else if(w!==q&&t){n=z;q=w;z=o[q-1];j(z);b()}},50)}}function s(){var n;n=O.value.split("|");if(n.length>1){P=n[0];K=n[1]}if(n.length>2)o=n[2].split(",");if(v)g();else{p();F=true;B!=null&&B()}}var t=false,v=i.isIElt9,x=false,B=null,u=null,O=null,F=false,H=null,o=[],P,K,L=[];return{_initialize:function(){O!=null&&s()},_initTimeout:function(){p()},register:function(n,q){if(!F)K=P=escape(n);L.push(q)},initialize:function(n,q){if(!F){var z=navigator.vendor||"";if(z!=="KDE")if(typeof window.opera!==
"undefined")x=true;else if(!v&&z.indexOf("Apple Computer, Inc.")>-1)t=true;if(typeof n==="string")n=document.getElementById(n);if(!(!n||n.tagName.toUpperCase()!=="TEXTAREA"&&(n.tagName.toUpperCase()!=="INPUT"||n.type!=="hidden"&&n.type!=="text"))){O=n;if(v){if(typeof q==="string")q=document.getElementById(q);!q||q.tagName.toUpperCase()!=="IFRAME"||(u=q)}}}},navigate:function(n,q){if(F){if(v)l(n);else{location.hash=n;if(t){o[history.length]=n;b()}}q&&e()}},getCurrentState:function(){if(!F)return"";
return K}}}()});if(window._$_APP_CLASS_$_)try{window._$_APP_CLASS_$_._p_.quit()}catch(e$$24){}
window._$_APP_CLASS_$_=new (function(){function I(d){d=o.pageCoordinates(d);P=d.x;K=d.y}function J(){var d=o.history.getCurrentState();if(L!=d){L=d;setTimeout(function(){b(null,"hash",null,true)},1)}}function D(d){if(L!=d){L=d;o.history.navigate(escape(d),false)}}function G(){window.onresize=function(){E()};document.body.ondragstart=function(){return false}}function Q(d,c){var f=n;f.object=o.getElement(d.getAttribute("dwid"));if(f.object==null)return true;f.sourceId=d.getAttribute("dsid");f.objectPrevStyle=
{position:f.object.style.position,display:f.object.style.display,left:f.object.style.left,top:f.object.style.top,className:f.object.className};f.object.parentNode.removeChild(f.object);f.object.style.position="absolute";f.object.className="";document.body.appendChild(f.object);o.capture(null);o.capture(f.object);f.object.onmousemove=ca;f.object.onmouseup=da;f.offsetX=-4;f.offsetY=-4;f.dropTarget=null;f.mimeType=d.getAttribute("dmt");f.xy=o.pageCoordinates(c);o.cancelEvent(c);return false}function ca(d){if(n.object!=
null){var c=n,f=o.pageCoordinates(d);if(c.object.style.display!=""&&c.xy.x!=f.x&&c.xy.y!=f.y)c.object.style.display="";c.object.style.left=f.x-c.offsetX+"px";c.object.style.top=f.y-c.offsetY+"px";f=c.dropTarget;var h=o.target(d),m="{"+c.mimeType+":",k=null;for(c.dropTarget=null;h;){k=h.getAttribute("amts");if(k!=null&&k.indexOf(m)!=-1){c.dropTarget=h;break}h=h.parentNode;if(!h.tagName||o.hasTag(h,"HTML"))break}if(c.dropTarget!=f){if(c.dropTarget){h=k.indexOf(m)+m.length;var r=k.indexOf("}",h);k=k.substring(h,
r);if(k.length!=0){c.dropTarget.setAttribute("dos",c.dropTarget.className);c.dropTarget.className=c.dropTarget.className+" "+k}}else c.object.styleClass="";if(f!=null){f.handleDragDrop&&f.handleDragDrop("end",c.object,d,"",m);k=f.getAttribute("dos");if(k!=null)f.className=k}}if(c.dropTarget)if(c.dropTarget.handleDragDrop)c.dropTarget.handleDragDrop("drag",c.object,d,"",m);else c.object.className="Wt-valid-drop";return false}return true}function da(d){o.capture(null);var c=n;if(c.object){if(c.dropTarget){var f=
c.dropTarget.getAttribute("dos");if(f!=null)c.dropTarget.className=f;c.dropTarget.handleDragDrop?c.dropTarget.handleDragDrop("drop",c.object,d,c.sourceId,c.mimeType):p(c.dropTarget,{name:"_drop",eventObject:c.dropTarget,event:d},c.sourceId,c.mimeType)}c.object.style.position=c.objectPrevStyle.position;c.object.style.display=c.objectPrevStyle.display;c.object.style.left=c.objectPrevStyle.left;c.object.style.top=c.objectPrevStyle.top;c.object.className=c.objectPrevStyle.className;c.object=null}}function S(d,
c,f){var h,m;m=d+"=";d=0;for(h=c.length;d<h;++d){var k=c[d];if(d!=0)m+=";";m+=[k.identifier,k.clientX,k.clientY,k.pageX,k.pageY,k.screenX,k.screenY,k.pageX-f.x,k.pageY-f.y].join(";")}return m}function ha(d,c){var f,h;h=d.event;c=c>0?"&e"+c:"&";f=c+"signal="+d.signal;if(d.id){f+=c+"id="+d.id+c+"name="+encodeURIComponent(d.name)+c+"an="+d.args.length;for(var m=0;m<d.args.length;++m)f+=c+"a"+m+"="+encodeURIComponent(d.args[m])}for(var k=0;k<q.length;++k){var r=o.getElement(q[k]),y=null,na;if(r!=null){if(r.type==
"select-multiple"){m=0;for(na=r.options.length;m<na;m++)if(r.options[m].selected)f+=c+q[k]+"="+encodeURIComponent(r.options[m].value)}else if(r.type=="checkbox"||r.type=="radio")if(r.indeterminate||r.style.opacity=="0.5")y="i";else{if(r.checked)y=r.value}else if(o.hasTag(r,"VIDEO")||o.hasTag(r,"AUDIO"))y=""+r.volume+";"+r.currentTime+";"+r.duration+";"+(r.paused?"1":"0")+";"+(r.ended?" 1":"0")+";"+r.readyState;else if(o.hasTag(r,"DIV")&&r.childNodes.length==1){m=r.childNodes[0];if(o.hasTag(m,"VIDEO")||
...
$("#Wt-timers");d.size()>0&&o.setHtml(d.get(0),"",false)}function N(){o.history._initTimeout();fa==0&&b(null,"none",null,false)}function Y(d){if(!o.isIEMobile)document.title=d}function X(d){if(!oa){if(d){if(!window._$_APP_CLASS_$_LoadWidgetTree)return;o.history.initialize("Wt-history-field","Wt-history-iframe",_$_DEPLOY_PATH_$_)}if(!("activeElement"in document)){function c(h){if(h&&h.target)document.activeElement=h.target==document?null:h.target}function f(){document.activeElement=null}document.addEventListener("focus",
c,true);document.addEventListener("blur",f,true)}o.history._initialize();G();oa=true;d&&window._$_APP_CLASS_$_LoadWidgetTree();if(!C){N();ia=setInterval(N,_$_KEEP_ALIVE_$_000)}}}function U(d){clearTimeout(d);document.body.style.cursor="auto";if(ja!=null){try{ja()}catch(c){}ja=null}}function Z(){document.body.style.cursor="wait";ja=hideLoadingIndicator;showLoadingIndicator()}function ga(d){pa=d}function W(){if(!ka){ka=true;setTimeout(function(){ka=false;H._p_.autoJavaScript()},1)}}function E(d){if(d){d=
"(function() {"+d+"})();";window.execScript?window.execScript(d):window.eval(d)}H==window._$_APP_CLASS_$_&&W()}function ea(d,c,f){if(!C){if(d==0){_$_$if_CATCH_ERROR_$_();try{_$_$endif_$_();E(c);_$_$if_CATCH_ERROR_$_()}catch(h){c=null;_$_$if_SHOW_STACK_$_();c=h.stack||h.stacktrace;_$_$endif_$_();alert("Wt internal error: "+h+", code: "+h.code+", description: "+h.description+(c?", stack:\n"+c:""))}_$_$endif_$_();f&&U(f)}else w=z.concat(w);z=[];if(V){clearTimeout(V);V=null}M=null;if(d>0)++fa;else fa=
0;if(!C)if(pa||w.length>0)if(d==1){d=Math.min(12E4,Math.exp(fa)*500);aa=setTimeout(function(){g()},d)}else g()}}function a(){M.abort();V=M=null;C||g()}function b(d,c,f,h){if(!la){la=true;o.checkReleaseCapture(d,f);_$_$if_STRICTLY_SERIALIZED_EVENTS_$_();if(!M){_$_$endif_$_();var m={},k=w.length;m.object=d;m.signal=c;m.event=window.fakeEvent||f;m.feedback=h;w[k]=ha(m,k);e();E();_$_$if_STRICTLY_SERIALIZED_EVENTS_$_()}_$_$endif_$_();la=false}}function e(){if(!C){_$_$if_WEB_SOCKETS_$_();if(A.state!=2)if(typeof window.WebSocket===
"undefined")A.state=2;else{var d=A.socket;if(d==null||d.readyState>1)if(d!=null&&A.state==0)A.state=2;else{function c(){++A.reconnectTries;var h=Math.min(12E4,Math.exp(A.reconnectTries)*500);setTimeout(function(){e()},h)}var f;if(R.indexOf("://")!=-1)f="ws"+R.substr(4);else{f=R.substr(R.indexOf("?"));f="ws"+location.protocol.substr(4)+"//"+location.hostname+":"+location.port+_$_DEPLOY_PATH_$_+f}A.socket=d=new WebSocket(f);A.keepAlive&&clearInterval(A.keepAlive);A.keepAlive=null;d.onmessage=function(h){A.reconnectTries=
0;A.state=1;ea(0,h.data,null)};d.onerror=function(){c()};d.onclose=function(){c()};d.onopen=function(){A.state=1;A.keepAlive=setInterval(function(){if(d.readyState==1)d.send("&signal=none");else{clearInterval(A.keepAlive);A.keepAlive=null}},_$_SERVER_PUSH_TIMEOUT_$_)}}if(d.readyState==1){g();return}}_$_$endif_$_();if(M!=null&&V!=null){clearTimeout(V);M.abort();M=null}if(M==null)if(aa==null){aa=setTimeout(function(){g()},o.updateDelay);qa=(new Date).getTime()}else if(fa){clearTimeout(aa);g()}else if((new Date).getTime()-
qa>o.updateDelay){clearTimeout(aa);g()}}}function j(d){ma=d;ra.responseReceived(d)}function l(d){sa=d}function g(){if(H!=window._$_APP_CLASS_$_)T();else if(!M){aa=null;if(C){if(!ta){if(confirm("The application was quited, do you want to restart?"))document.location=document.location;ta=true}}else{var d,c,f;if(w.length>0){d=i();c=d.feedback?setTimeout(Z,_$_INDICATOR_TIMEOUT_$_):null;f=false}else{d={result:"&signal=poll"};c=null;f=true}d.result+="&ackId="+ma+"&pageId="+sa;d.result+="&_$_PARAMS_$_";
if(A.socket!=null&&A.socket.readyState==1){M=null;c!=null&&clearTimeout(c);f||A.socket.send(d.result)}else{M=ra.sendUpdate("request=jsupdate"+d.result,c,ma,-1);V=f?setTimeout(a,_$_SERVER_PUSH_TIMEOUT_$_):null}}}}function p(d,c){var f={},h=w.length;f.signal="user";f.id=typeof d==="string"?d:d==H?"app":d.id;if(typeof c==="object"){f.name=c.name;f.object=c.eventObject;f.event=c.event}else{f.name=c;f.object=f.event=null}f.args=[];for(var m=2;m<arguments.length;++m){var k=arguments[m];k=k===false?0:k===
