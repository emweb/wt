#include "EverywidgetApplication.h"
...
EverywidgetApplication::EverywidgetApplication(const WEnvironment& env)
  : WApplication(env)
{
...
void EverywidgetApplication::addToMenu(WMenu *menu, const WString& name,
