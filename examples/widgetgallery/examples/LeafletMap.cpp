...
{
public:
  LeafletMapExample(Wt::WContainerWidget *parent = 0)
...
private:
  ...
  {
    Wt::WImage *emwebLogo = new Wt::WImage(
          Wt::WLink("https://www.emweb.be/css/emweb_small_filled.png"));
    emwebLogo->setInline(false);
    emwebLogo->resize(118, 32);
    Wt::WLeafletMap::WidgetMarker *emwebMarker = new Wt::WLeafletMap::WidgetMarker(EMWEB_COORDS, emwebLogo);
    map_->addMarker(emwebMarker);
  }
