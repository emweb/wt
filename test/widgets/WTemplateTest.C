...
BOOST_AUTO_TEST_CASE(WTemplate_renderTemplateText_bound_widgets)
{
  ...
  resetStream(output);
  t.renderTemplateText(output, t.templateText());
  BOOST_REQUIRE(filterOutIds(output.str()) == "<div><div unselectable=\"on\" class=\"Wt-itemview Wt-treeview unselectable\" style=\"position:relative;overflow-x:hidden;overflow-y:hidden;display:flex;flex-flow:column;-moz-flex-flow:column;\"><div flg=\"0\" class=\"Wt-fill-width\" style=\"display:flex;flex:0 0 auto;-moz-flex:0 0 auto;flex-flow:row;-moz-flex-flow:row;\"><div class=\"Wt-header headerrh cwidth\" style=\"overflow-x:hidden;overflow-y:hidden;flex:1 1 auto;-moz-flex:1 1 auto;\"><div class=\"Wt-headerdiv headerrh\"><div class=\"Wt-tv-row\" style=\"float:right;\"/></div></div></div><div class=\"Wt-fill-width\" style=\"display:flex;flex:1 1 auto;-moz-flex:1 1 auto;flex-flow:row;-moz-flex-flow:row;\"><div class=\"cwidth\" style=\"overflow-x:auto;overflow-y:auto;flex:1 1 auto;-moz-flex:1 1 auto;\"><div style=\"height:0.0px;\"><div><div><div class=\"Wt-item\"></div></div></div></div></div></div></div></div>");
  ...
  resetStream(output);
  t.renderTemplateText(output, t.templateText());
  BOOST_REQUIRE(filterOutIds(output.str()) == "<div><div unselectable=\"on\" class=\"Wt-tree Wt-sentinel unselectable\"><div class=\"Wt-item Wt-end Wt-root\"><span class=\"Wt-ctrl Wt-expand\" style=\"cursor:pointer;display:none;\"><img alt=\"\" src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\" style=\"display:none;\"/><img alt=\"\" src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\"/></span><span class=\"Wt-ctrl Wt-noexpand\"/><div><span class=\"Wt-label\"/></div></div><div style=\"clear: both\"/><ul class=\"Wt-root\"/></div></div>");
  t.bindWidget("widget", std::make_unique<Wt::WTreeNode>(""));
  resetStream(output);
  t.renderTemplateText(output, t.templateText());
  BOOST_REQUIRE(filterOutIds(output.str()) == "<div><div unselectable=\"on\" class=\"Wt-tree Wt-trunk unselectable\"><div class=\"Wt-item  ??selected??\"><span class=\"Wt-ctrl Wt-expand\" style=\"cursor:pointer;display:none;\"><img alt=\"\" src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\"/><img alt=\"\" src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\" style=\"display:none;\"/></span><span class=\"Wt-ctrl Wt-noexpand\"/><div><span class=\"Wt-label\"/></div></div><div style=\"clear: both\"/><ul style=\"display:none;\"/></div></div>");
